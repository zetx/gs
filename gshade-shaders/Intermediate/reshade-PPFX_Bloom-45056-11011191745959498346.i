...
texture texColorHDRA { Width = 1798; Height = 997; Format = RGBA16F; };
texture texColorHDRB < pooled = true; > { Width = 1798; Height = 997; Format = RGBA16F; };
#line 185
texture texBloomA
{
Width = 1798/		4		;
...
#line 262
static const float2 pxSize = float2((1.0 / 1798),(1.0 / 997));
