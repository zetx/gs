...
texture Anisotropy {Width = 1500; Height = 1004; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 1500), (1.0 / 1004), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 1500), (1.0 / 1004)) * Scale;
