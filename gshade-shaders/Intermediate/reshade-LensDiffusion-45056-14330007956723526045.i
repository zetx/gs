...
#line 65
 texture TexCopy { Width  = 3440; Height = 1440; Format = RGBA8; };
#line 70
 texture TexBlur1 { Width  = 3440; Height = 1440; Format = RGBA16; };
 texture TexBlur2 { Width  = 3440; Height = 1440; Format = RGBA16; };
#line 76
...
{
float2 texsize = float2(3440, 1440);
#line 163
float4 uv;
uv.xy = coord * texsize;
#line 167
...
{
#line 44
if (((coord.x + i *  float2((1.0 / 3440), (1.0 / 1440)).x) >  0.675  ||
(coord.x - i *  float2((1.0 / 3440), (1.0 / 1440)).x) <   0.325)) continue;
#line 47
luma += tex2Dlod(Samplerluma, float4(coord + float2(offset[i] *  float2((1.0 / 3440), (1.0 / 1440)).x, 0.0), 0.0, 0.0)).x * kernel[i];
luma += tex2Dlod(Samplerluma, float4(coord - float2(offset[i] *  float2((1.0 / 3440), (1.0 / 1440)).x, 0.0), 0.0, 0.0)).x * kernel[i];
}
#line 51
return luma;
...
{
#line 88
if (((coord.y + i *  float2((1.0 / 3440), (1.0 / 1440)).y) >  0.675   ||
(coord.y - i *  float2((1.0 / 3440), (1.0 / 1440)).y) <  0.325)) continue;
#line 91
luma += tex2Dlod(Samplerluma, float4(coord + float2(0.0, offset[i] *  float2((1.0 / 3440), (1.0 / 1440)).y), 0.0, 0.0)).x * kernel[i];
luma += tex2Dlod(Samplerluma, float4(coord - float2(0.0, offset[i] *  float2((1.0 / 3440), (1.0 / 1440)).y), 0.0, 0.0)).x * kernel[i];
}
#line 95
return luma;
...
(coord.x - i *  float2((1.0 / 3440), (1.0 / 1440)).x) <   0.325)) continue;
#line 135
color += tex2Dlod(SamplerColor, float4(coord + float2(offset[i] *  float2((1.0 / 3440), (1.0 / 1440)).x, 0.0), 0.0, 0.0)).rgb * kernel[i];
color += tex2Dlod(SamplerColor, float4(coord - float2(offset[i] *  float2((1.0 / 3440), (1.0 / 1440)).x, 0.0), 0.0, 0.0)).rgb * kernel[i];
}
#line 139
return color;
...
(coord.y - i *  float2((1.0 / 3440), (1.0 / 1440)).y) <  0.325)) continue;
#line 179
color += tex2Dlod(SamplerColor, float4(coord + float2(0.0, offset[i] *  float2((1.0 / 3440), (1.0 / 1440)).y), 0.0, 0.0)).rgb * kernel[i];
color += tex2Dlod(SamplerColor, float4(coord - float2(0.0, offset[i] *  float2((1.0 / 3440), (1.0 / 1440)).y), 0.0, 0.0)).rgb * kernel[i];
}
#line 183
return color;
...
texture texLod {
Width  =   (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1); Height =   (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1);
MipLevels =
(   (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1) >   (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) *  ( (((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xAAAAAAAA) != 0) | ((((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xFFFF0000) != 0) << 4) | ((((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xFF00FF00) != 0) << 3) | ((((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xF0F0F0F0) != 0) << 2) | ((((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xCCCCCCCC) != 0) << 1)) +
(   (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1) >=   (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) *  ( (((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xAAAAAAAA) != 0) | ((((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xFFFF0000) != 0) << 4) | ((((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xFF00FF00) != 0) << 3) | ((((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xF0F0F0F0) != 0) << 2) | ((((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xCCCCCCCC) != 0) << 1)) - 1 ;
Format = RGB10A2;
};
#line 78
...
float3 get() {
float3 res    = 0;
int2   lvl    = int2( ( (((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xAAAAAAAA) != 0) | ((((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xFFFF0000) != 0) << 4) | ((((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xFF00FF00) != 0) << 3) | ((((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xF0F0F0F0) != 0) << 2) | ((((  (( (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) | (   (   ( (3440) | ( (3440) >> 1) ) | (   ( (3440) | ( (3440) >> 1) ) >> 2) ) >> 4) ) >> 8) ) >>1)+1)) & 0xCCCCCCCC) != 0) << 1)),  ( (((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xAAAAAAAA) != 0) | ((((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xFFFF0000) != 0) << 4) | ((((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xFF00FF00) != 0) << 3) | ((((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xF0F0F0F0) != 0) << 2) | ((((  (( (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) | (   (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) | (   (   ( (1440) | ( (1440) >> 1) ) | (   ( (1440) | ( (1440) >> 1) ) >> 2) ) >> 4) ) >> 8) )>>1)+1)) & 0xCCCCCCCC) != 0) << 1)));
float4 stp    = 0;
