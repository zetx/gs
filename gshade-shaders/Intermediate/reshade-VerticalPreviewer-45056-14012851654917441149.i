...
texture texDraw { Width = 5360; Height = 1440; };
texture texVPreOut { Width = 5360; Height = 1440; };
#line 129
...
float2 pixelsize =  float2((1.0 / 5360), (1.0 / 1440)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(5360, 1440) * cLayerVPre_Scale /  float2(5360, 1440));
