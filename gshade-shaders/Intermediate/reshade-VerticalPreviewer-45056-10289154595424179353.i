...
texture texDraw { Width = 792; Height = 710; };
texture texVPreOut { Width = 792; Height = 710; };
#line 129
...
float2 pixelsize =  float2((1.0 / 792), (1.0 / 710)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(792, 710) * cLayerVPre_Scale /  float2(792, 710));
