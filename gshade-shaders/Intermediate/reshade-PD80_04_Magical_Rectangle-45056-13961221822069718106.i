...
> = 1.0;
#line 217
texture texMagicRectangle { Width = 1281; Height = 721; Format = RGBA16F; };
#line 220
...
uv.y         = ( id == 1 ) ? 2.0 : 0.0;
uv.xy        -= center.xy;
uv.y         /=  float( 1281 * (1.0 / 721) );
float dim    = ceil( sqrt( 1281 * 1281 + 721 * 721 )); 
float maxlen = min( 1281, 721 );
dim          = dim / maxlen; 
uv.xy        /= dim;
