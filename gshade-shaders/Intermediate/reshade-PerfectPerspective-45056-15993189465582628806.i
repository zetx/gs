...
#line 353
if ( (1281 * (1.0 / 721)) > 1.0) 
borderCoord.x = borderCoord.x* (1281 * (1.0 / 721))+(1.0- (1281 * (1.0 / 721)));
else if ( (1281 * (1.0 / 721)) < 1.0) 
borderCoord.y = borderCoord.y* (721*(1.0 / 1281))+(1.0- (721*(1.0 / 1281)));
#line 358
...
#line 410
case 1: FovType = sqrt( (721*(1.0 / 1281))* (721*(1.0 / 1281))+1.0); break;
#line 412
case 2: FovType =  (721*(1.0 / 1281)); break;
#line 414
case 3: FovType = (4.0/3.0) * (721*(1.0 / 1281)); break;
#line 416
case 4: FovType = (16.0/9.0) * (721*(1.0 / 1281)); break;
}
#line 420
float2 sphCoord = texCoord*2.0 -1.0;
#line 422
sphCoord.x -= Offset.y; 
sphCoord.y  = Offset.x+sphCoord.y* (721*(1.0 / 1281));
#line 425
