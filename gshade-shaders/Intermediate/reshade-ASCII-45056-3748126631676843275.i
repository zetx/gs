...
const float2 cursor_position = trunc(( float2(792, 710) / Ascii_block) * tex) * (Ascii_block /  float2(792, 710));
#line 208
const float2 cp15 = cursor_position +  float2((1.0 / 792), (1.0 / 710)) * 1.5;
const float2 cp35 = cursor_position +  float2((1.0 / 792), (1.0 / 710)) * 3.5;
const float2 cp55 = cursor_position +  float2((1.0 / 792), (1.0 / 710)) * 5.5;
#line 212
...
#line 249
const float2 p = trunc(frac(( float2(792, 710) / Ascii_block) * tex) * Ascii_block); 
#line 251
