...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.002069)
    mov x0[2].x, l(0.004827)
    mov x0[3].x, l(0.007586)
    mov x0[4].x, l(0.010345)
    mov x0[5].x, l(0.013103)
    mov x0[6].x, l(0.015862)
    mov x0[7].x, l(0.018621)
    mov x0[8].x, l(0.021381)
    mov x0[9].x, l(0.024140)
    mov x0[10].x, l(0.026900)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.002077)
      mov x3[2].x, l(0.004846)
      mov x3[3].x, l(0.007615)
      mov x3[4].x, l(0.010385)
      mov x3[5].x, l(0.013154)
      mov x3[6].x, l(0.015923)
      mov x3[7].x, l(0.018692)
      mov x3[8].x, l(0.021462)
      mov x3[9].x, l(0.024231)
      mov x3[10].x, l(0.027000)
      mov x3[11].x, l(0.029769)
      mov x3[12].x, l(0.032539)
      mov x3[13].x, l(0.035308)
      mov x3[14].x, l(0.038078)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.002077)
        mov x6[2].x, l(0.004846)
        mov x6[3].x, l(0.007615)
        mov x6[4].x, l(0.010385)
        mov x6[5].x, l(0.013154)
        mov x6[6].x, l(0.015923)
        mov x6[7].x, l(0.018692)
        mov x6[8].x, l(0.021462)
        mov x6[9].x, l(0.024231)
        mov x6[10].x, l(0.027036)
        mov x6[11].x, l(0.029809)
        mov x6[12].x, l(0.032582)
        mov x6[13].x, l(0.035355)
        mov x6[14].x, l(0.038128)
        mov x6[15].x, l(0.040901)
        mov x6[16].x, l(0.043674)
        mov x6[17].x, l(0.046447)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.002026)
          mov x9[2].x, l(0.004728)
          mov x9[3].x, l(0.007433)
          mov x9[4].x, l(0.010143)
          mov x9[5].x, l(0.012859)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001642)
            mov x12[2].x, l(0.004207)
            mov x12[3].x, l(0.006950)
