...
{
x = Map(texcoord.x, float2(overlayPos.x, overlayPos.x + size.x) / 1500, float2(0.0, 1.0));
y = Map(texcoord.y, float2(overlayPos.y, overlayPos.y + size.y) / 1004, float2(0.0, 1.0));
