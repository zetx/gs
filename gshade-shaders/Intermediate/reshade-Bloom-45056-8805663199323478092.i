...
{
#line 290
float axis =  float2((1.0 / 1799), (1.0 / 998)).y * mult;
#line 292
for (int i = -10; i < 11; i++)
{
...
{
#line 301
float axis =  float2((1.0 / 1799), (1.0 / 998)).x * mult;
#line 303
for (int i = -10; i < 11; i++)
{
...
{
#line 360
const float2 bps =  float2((1.0 / 1799), (1.0 / 998)) * 2;
#line 363
...
{
#line 400
const float2 bps =  float2((1.0 / 1799), (1.0 / 998)) * 4;
#line 406
const float2 tcP = texcoord + bps;
const float2 tcN = texcoord - bps;
...
{
#line 438
const float2 bps =  float2((1.0 / 1799), (1.0 / 998)) * 8;
...
float2 lfcoord = 0;
float3 lenstemp = 0;
const float2 distfact = float2((texcoord.x - 0.5) *  (1799 * (1.0 / 998)), texcoord.y - 0.5);
#line 548
...
#line 746
float2 bpsPP =  float2((1.0 / 1799), (1.0 / 998)) * 0.5;
