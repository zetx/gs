...
texture prePassLayer { Width = 1281; Height = 721; Format = RGBA8; };
texture blurLayerHorizontal { Width = 1281 / 2; Height = 721 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 1281 / 2; Height = 721 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 1281 / 16; Height = 721 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 1281 / 16; Height = 721 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 1281 / 64; Height = 721 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 1281 / 64; Height = 721 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 1281 * sampling;
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 721 * sampling;
float divisor = 0.000001;
#line 410
