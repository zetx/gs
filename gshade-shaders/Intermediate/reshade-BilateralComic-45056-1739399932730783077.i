...
texture Luma <Pooled = true;> {Width = 1024; Height = 768; Format = R16f;};
texture Sobel <Pooled = true;> {Width = 1024; Height = 768; Format = R8;};
#line 16
...
{
float2 offset = (float2(i, j) * normals.xy) * 1 / float2(1024, 768);
