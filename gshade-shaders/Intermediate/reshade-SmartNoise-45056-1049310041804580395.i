...
#line 76
return color + ((gold_noise(texcoord *  float2(1280, 720).y * 2.0, ((luminance *  float2(1280, 720).y) + ( float2(1280, 720).x * texcoord.y) + texcoord.x + ReShade::GetLinearizedDepth(texcoord) *  float2(1280, 720).y) * 0.0001) * amount) - sub);
}
#line 79
