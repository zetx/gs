...
RadialCoord.x *=  (1281 * (1.0 / 721));
#line 97
const float Mask = pow(2.0 * length(RadialCoord) * rsqrt( (1281 * (1.0 / 721)) *  (1281 * (1.0 / 721)) + 1.0), Curve);
#line 99
const float OffsetBase = Mask * Aberration * (1.0 / 721) * 2.0;
#line 102
if(abs(OffsetBase) < (1.0 / 721))
