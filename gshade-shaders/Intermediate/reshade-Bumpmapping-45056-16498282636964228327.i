...
> = 0.75;
#line 68
texture SmoothTexture01 { Width = 5360; Height = 1440; Format = RGBA8; };
sampler Texture01S { Texture = SmoothTexture01; };
#line 72
static const float2 g10 = float2( 0.333,-1.0)* float2((1.0 / 5360), (1.0 / 1440));
static const float2 g01 = float2(-1.0,-0.333)* float2((1.0 / 5360), (1.0 / 1440));
static const float2 g12 = float2(-0.333, 1.0)* float2((1.0 / 5360), (1.0 / 1440));
static const float2 g21 = float2( 1.0, 0.333)* float2((1.0 / 5360), (1.0 / 1440));
#line 77
...
#line 101
const float2 inv_size = RANGE *  float2((1.0 / 5360), (1.0 / 1440));
#line 103
