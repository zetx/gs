...
{
#line 44
if (((coord.x + i *  float2((1.0 / 792), (1.0 / 710)).x) >  0.575  ||
(coord.x - i *  float2((1.0 / 792), (1.0 / 710)).x) <   0.425)) continue;
#line 47
...
{
#line 88
if (((coord.y + i *  float2((1.0 / 792), (1.0 / 710)).y) >  0.575   ||
(coord.y - i *  float2((1.0 / 792), (1.0 / 710)).y) <  0.425)) continue;
#line 91
