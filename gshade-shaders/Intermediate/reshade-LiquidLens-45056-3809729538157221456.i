...
{
if (792 > 710)
return float2(1.0, 710 * (1.0 / 792));
else
return float2(792 * (1.0 / 710), 1.0);
}
#line 26
...
{
return Blur(LensA, uv, float2((1.0 / 792), 0));
}
#line 221
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return Blur(LensB, uv, float2(0, (1.0 / 710)));
}
#line 226
