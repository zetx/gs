...
{
return GaussianBlur1D(AtlasA, uv, PixelScale * float2((1.0 / 1500), 0.0) *  2, uSigma, BlurSamples);
}
#line 949
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return GaussianBlur1D(AtlasB, uv, PixelScale * float2(0.0, (1.0 / 1004)) *  2, uSigma, BlurSamples);
}
#line 956
...
#line 1055
float ar = 1500 * (1.0 / 1004);
float ar_inv = 1004 * (1.0 / 1500);
