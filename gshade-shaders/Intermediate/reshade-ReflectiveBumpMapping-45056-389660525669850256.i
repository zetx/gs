...
const float2 offs =  float2((1.0 / 1799), (1.0 / 995))*1.0;
...
const float3 TextureNormals 		= GetNormalFromColor(texcoord.xy, 0.01 *  float2((1.0 / 1799), (1.0 / 995)) / scenedepth, 0.0002 / scenedepth + 0.1, 1000.0);
...
{
const float2 currentOffset 	= texcoord.xy + SceneNormals.xy *  float2((1.0 / 1799), (1.0 / 995)) * i/(float)iRBM_SampleCount * fRBM_BlurWidthPixels;
