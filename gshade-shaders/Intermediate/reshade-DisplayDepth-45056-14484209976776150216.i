...
texcoord.y += iUIOffset.y * (1.0 / 998); 
#line 178
...
{
float3 offset = float3( float2((1.0 / 1799), (1.0 / 998)), 0.0);
...
#line 217
float grid_position = frac(dot(texcoord, ( float2(1799, 998) * float2(1.0 / 16.0, 10.0 / 36.0)) + 0.25));
#line 219
