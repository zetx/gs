...
texture prePassLayer { Width = 1024; Height = 768; Format = RGBA8; };
texture blurLayerHorizontal { Width = 1024 / 2; Height = 768 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 1024 / 2; Height = 768 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 1024 / 16; Height = 768 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 1024 / 16; Height = 768 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 1024 / 64; Height = 768 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 1024 / 64; Height = 768 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 1024 * sampling;
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 768 * sampling;
float divisor = 0.000001;
#line 410
