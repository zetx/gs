...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001164)
    mov x0[2].x, l(0.002715)
    mov x0[3].x, l(0.004267)
    mov x0[4].x, l(0.005819)
    mov x0[5].x, l(0.007371)
    mov x0[6].x, l(0.008923)
    mov x0[7].x, l(0.010474)
    mov x0[8].x, l(0.012027)
    mov x0[9].x, l(0.013579)
    mov x0[10].x, l(0.015131)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001168)
      mov x3[2].x, l(0.002726)
      mov x3[3].x, l(0.004284)
      mov x3[4].x, l(0.005841)
      mov x3[5].x, l(0.007399)
      mov x3[6].x, l(0.008957)
      mov x3[7].x, l(0.010514)
      mov x3[8].x, l(0.012072)
      mov x3[9].x, l(0.013630)
      mov x3[10].x, l(0.015188)
      mov x3[11].x, l(0.016745)
      mov x3[12].x, l(0.018303)
      mov x3[13].x, l(0.019861)
      mov x3[14].x, l(0.021419)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001168)
        mov x6[2].x, l(0.002726)
        mov x6[3].x, l(0.004284)
        mov x6[4].x, l(0.005841)
        mov x6[5].x, l(0.007399)
        mov x6[6].x, l(0.008957)
        mov x6[7].x, l(0.010514)
        mov x6[8].x, l(0.012072)
        mov x6[9].x, l(0.013630)
        mov x6[10].x, l(0.015208)
        mov x6[11].x, l(0.016768)
        mov x6[12].x, l(0.018328)
        mov x6[13].x, l(0.019887)
        mov x6[14].x, l(0.021447)
        mov x6[15].x, l(0.023007)
        mov x6[16].x, l(0.024567)
        mov x6[17].x, l(0.026127)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001139)
          mov x9[2].x, l(0.002659)
          mov x9[3].x, l(0.004181)
          mov x9[4].x, l(0.005705)
          mov x9[5].x, l(0.007233)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.000924)
            mov x12[2].x, l(0.002367)
            mov x12[3].x, l(0.003909)
