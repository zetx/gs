...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001138)
    mov x0[2].x, l(0.002655)
    mov x0[3].x, l(0.004173)
    mov x0[4].x, l(0.005690)
    mov x0[5].x, l(0.007207)
    mov x0[6].x, l(0.008725)
    mov x0[7].x, l(0.010242)
    mov x0[8].x, l(0.011760)
    mov x0[9].x, l(0.013278)
    mov x0[10].x, l(0.014796)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001142)
      mov x3[2].x, l(0.002666)
      mov x3[3].x, l(0.004189)
      mov x3[4].x, l(0.005712)
      mov x3[5].x, l(0.007235)
      mov x3[6].x, l(0.008758)
      mov x3[7].x, l(0.010281)
      mov x3[8].x, l(0.011805)
      mov x3[9].x, l(0.013328)
      mov x3[10].x, l(0.014851)
      mov x3[11].x, l(0.016374)
      mov x3[12].x, l(0.017898)
      mov x3[13].x, l(0.019421)
      mov x3[14].x, l(0.020944)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001142)
        mov x6[2].x, l(0.002666)
        mov x6[3].x, l(0.004189)
        mov x6[4].x, l(0.005712)
        mov x6[5].x, l(0.007235)
        mov x6[6].x, l(0.008758)
        mov x6[7].x, l(0.010281)
        mov x6[8].x, l(0.011805)
        mov x6[9].x, l(0.013328)
        mov x6[10].x, l(0.014871)
        mov x6[11].x, l(0.016396)
        mov x6[12].x, l(0.017922)
        mov x6[13].x, l(0.019447)
        mov x6[14].x, l(0.020972)
        mov x6[15].x, l(0.022497)
        mov x6[16].x, l(0.024023)
        mov x6[17].x, l(0.025548)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001114)
          mov x9[2].x, l(0.002600)
          mov x9[3].x, l(0.004088)
          mov x9[4].x, l(0.005579)
          mov x9[5].x, l(0.007073)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.000903)
            mov x12[2].x, l(0.002314)
            mov x12[3].x, l(0.003823)
