...
#line 171
texture2D MXAO_ColorTex 	{ Width = 5360;   Height = 1440;   Format = RGBA8; MipLevels = 3+		2	;};
texture2D MXAO_DepthTex 	{ Width = 5360;   Height = 1440;   Format = R16F;  MipLevels = 3+		0	;};
texture2D MXAO_NormalTex	{ Width = 5360;   Height = 1440;   Format = RGBA8; MipLevels = 3+		2	;};
texture2D MXAO_CullingTex	{ Width = 5360/8; Height = 1440/8; Format = R8; };
#line 176
...
{
const float2 sampleCoord = MXAO.texcoord.xy + blurOffsets[iStep] *  float2((1.0 / 5360), (1.0 / 1440)) * radius / inputscale;
#line 303
...
{
const float2 searchRadiusScaled = 0.018 / P.z * float2(1.0, (5360 * (1.0 / 1440)));
...
{
const float4 cOffsets = float4( float2((1.0 / 5360), (1.0 / 1440)),- float2((1.0 / 5360), (1.0 / 1440))) * 8;
...
{
const float3 offs = float3( float2((1.0 / 5360), (1.0 / 1440)),0);
#line 405
...
{
sampleUV = MXAO.scaledcoord.xy + Dir.xy * float2(1.0,  (5360 * (1.0 / 1440))) * (iSample + randStep);
