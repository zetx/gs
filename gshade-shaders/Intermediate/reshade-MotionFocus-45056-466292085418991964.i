...
#line 47
texture2D Ganossa_MF_NormTex { Width =  5360/2; Height =  1440/2; Format = RGBA8; };
texture2D Ganossa_MF_PrevTex { Width =  5360/2; Height =  1440/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullTex { Width =  5360/2; Height =  1440/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullPrevTex { Width =  5360/2; Height =  1440/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadTex { Width =  5360/2; Height =  1440/2; Format = RGBA16F; };
#line 53
...
#line 97
if (!(texcoord.x <= (1.0 / 5360)*2 && texcoord.y <= (1.0 / 1440)*2))
discard;
#line 100
float2 coord = float2(0.0,0.0);
#line 102
for (float i = 2.0f; i <  5360/2; i=i+ 5360/192f)
{
coord.x = (1.0 / 5360)*i*2;
#line 106
[unroll]
...
#line 113
if(i <   5360/2/2 && j <   1440/2/2)
quadR.x += quadFullPow;
else if(i >   5360/2/2 && j <   1440/2/2)
quadR.y += quadFullPow;
else if(i <   5360/2/2 && j >   1440/2/2)
quadR.z += quadFullPow;
else
...
{
float4 Ganossa_MF_Quad = saturate(tex2D(Ganossa_MF_QuadColor, float2((1.0 / 5360), (1.0 / 1440)))-0.1f);
#line 130
if (mfDebug)
{
#line 133
