...
> = 0.50;
#line 48
static const float2 g10 = float2( 0.3333,-1.0)* float2((1.0 / 1500), (1.0 / 1004));
static const float2 g01 = float2(-1.0,-0.3333)* float2((1.0 / 1500), (1.0 / 1004));
static const float2 g12 = float2(-0.3333, 1.0)* float2((1.0 / 1500), (1.0 / 1004));
static const float2 g21 = float2( 1.0, 0.3333)* float2((1.0 / 1500), (1.0 / 1004));
#line 53
