...
#line 780
texture texDMN { Width = 3440 ; Height = 1440; Format = RGBA16F; };
#line 782
sampler SamplerDMN
{
Texture = texDMN;
...
#line 787
texture texzBufferN_P { Width = 3440 ; Height = 1440 ; Format = RG16F; };
#line 789
...
#line 797
texture texzBufferN_L { Width = 3440 ; Height = 1440 ; Format = R16F; MipLevels = 2; };
#line 799
...
#line 813
texture texLumN {Width = 3440 *  160 / 3440; Height = 1440 *  160 / 3440; Format = RGBA16F; MipLevels = 8;};
#line 815
sampler SamplerLumN
{
Texture = texLumN;
...
{   float MS = Diverge *  float2((1.0 / 3440), (1.0 / 1440)).x, GetDepth = smoothstep(0,1,tex2Dlod(SamplerzBufferN_P, float4(Coordinates,0, 0) ).y),
Details = 0.5,
...
ParallaxCoord.y += IO *  float2((1.0 / 3440), (1.0 / 1440)).y; 
else if(Stereoscopic_Mode == 3)
ParallaxCoord.x += IO *  float2((1.0 / 3440), (1.0 / 1440)).x; 
#line 1498
...
#line 1591
TCL +=  float2( (Perspective *  float2((1.0 / 3440), (1.0 / 1440)).x) * 0.5, 0) ;
TCR -=  float2( (Perspective *  float2((1.0 / 3440), (1.0 / 1440)).x) * 0.5, 0) ;
#line 1594
...
#line 1650
TC += float2( ( FP_IO_Pos().x * 1.225 + lerp(0,4,IAC) ) *  float2((1.0 / 3440), (1.0 / 1440)).x, 0.0);
#line 1652
TC = Stereoscopic_Mode == 5 ? LensePitch(TC) * LPI : TC;
#line 1654
float2 gridxy, GXYArray[9] = {
float2(TC.x * 3440, TC.y * 1440), 
