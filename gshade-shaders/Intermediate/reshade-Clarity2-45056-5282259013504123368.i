...
#line 244
texture Clarity2Tex{ Width = 1280*0.5; Height = 720*0.5; Format =  R8; };
texture Clarity2Tex2{ Width = 1280*0.5; Height = 720*0.5; Format =  R8; };
#line 247
...
{
static const float offset[11] = { 0.0,  1.4895848401* float2((1.0 / 1280), (1.0 / 720)).y,  3.4757135714* float2((1.0 / 1280), (1.0 / 720)).y,  5.4618796741* float2((1.0 / 1280), (1.0 / 720)).y,  7.4481042327* float2((1.0 / 1280), (1.0 / 720)).y,  9.4344079746* float2((1.0 / 1280), (1.0 / 720)).y,  11.420811147* float2((1.0 / 1280), (1.0 / 720)).y,  13.4073334* float2((1.0 / 1280), (1.0 / 720)).y,  15.3939936778* float2((1.0 / 1280), (1.0 / 720)).y,  17.3808101174* float2((1.0 / 1280), (1.0 / 720)).y,  19.3677999584* float2((1.0 / 1280), (1.0 / 720)).y };
...
{
static const float offset[15] = { 0.0,   float2((1.0 / 1280), (1.0 / 720)).y*1.4953705027,   float2((1.0 / 1280), (1.0 / 720)).y*3.4891992113,   float2((1.0 / 1280), (1.0 / 720)).y*5.4830312105,   float2((1.0 / 1280), (1.0 / 720)).y*7.4768683759,   float2((1.0 / 1280), (1.0 / 720)).y*9.4707125766,   float2((1.0 / 1280), (1.0 / 720)).y*11.4645656736,   float2((1.0 / 1280), (1.0 / 720)).y*13.4584295168,   float2((1.0 / 1280), (1.0 / 720)).y*15.4523059431,   float2((1.0 / 1280), (1.0 / 720)).y*17.4461967743,   float2((1.0 / 1280), (1.0 / 720)).y*19.4401038149,   float2((1.0 / 1280), (1.0 / 720)).y*21.43402885,   float2((1.0 / 1280), (1.0 / 720)).y*23.4279736431,   float2((1.0 / 1280), (1.0 / 720)).y*25.4219399344,   float2((1.0 / 1280), (1.0 / 720)).y*27.4159294386 };
...
{
static const float offset[18] = { 0.0,   float2((1.0 / 1280), (1.0 / 720)).y*1.4953705027,   float2((1.0 / 1280), (1.0 / 720)).y*3.4891992113,   float2((1.0 / 1280), (1.0 / 720)).y*5.4830312105,   float2((1.0 / 1280), (1.0 / 720)).y*7.4768683759,   float2((1.0 / 1280), (1.0 / 720)).y*9.4707125766,   float2((1.0 / 1280), (1.0 / 720)).y*11.4645656736,   float2((1.0 / 1280), (1.0 / 720)).y*13.4584295168,   float2((1.0 / 1280), (1.0 / 720)).y*15.4523059431,   float2((1.0 / 1280), (1.0 / 720)).y*17.4461967743,   float2((1.0 / 1280), (1.0 / 720)).y*19.4661974725,   float2((1.0 / 1280), (1.0 / 720)).y*21.4627427973,   float2((1.0 / 1280), (1.0 / 720)).y*23.4592916956,   float2((1.0 / 1280), (1.0 / 720)).y*25.455844494,   float2((1.0 / 1280), (1.0 / 720)).y*27.4524015179,   float2((1.0 / 1280), (1.0 / 720)).y*29.4489630909,   float2((1.0 / 1280), (1.0 / 720)).y*31.445529535,   float2((1.0 / 1280), (1.0 / 720)).y*33.4421011704 };
...
{
static const float offset[6] = { 0.0,   float2((1.0 / 1280), (1.0 / 720)).y*1.4584295168,   float2((1.0 / 1280), (1.0 / 720)).y*3.40398480678,   float2((1.0 / 1280), (1.0 / 720)).y*5.3518057801,   float2((1.0 / 1280), (1.0 / 720)).y*7.302940716,   float2((1.0 / 1280), (1.0 / 720)).y*9.2581597095 };
...
{
static const float offset[4] = { 0.0,   float2((1.0 / 1280), (1.0 / 720)).y*1.1824255238,   float2((1.0 / 1280), (1.0 / 720)).y*3.0293122308,   float2((1.0 / 1280), (1.0 / 720)).y*5.0040701377 };
...
if(ClarityRadiusTwo == 2)
{
static const float offset[11] = { 0.0,  1.4895848401* float2((1.0 / 1280), (1.0 / 720)).x,  3.4757135714* float2((1.0 / 1280), (1.0 / 720)).x,  5.4618796741* float2((1.0 / 1280), (1.0 / 720)).x,  7.4481042327* float2((1.0 / 1280), (1.0 / 720)).x,  9.4344079746* float2((1.0 / 1280), (1.0 / 720)).x,  11.420811147* float2((1.0 / 1280), (1.0 / 720)).x,  13.4073334* float2((1.0 / 1280), (1.0 / 720)).x,  15.3939936778* float2((1.0 / 1280), (1.0 / 720)).x,  17.3808101174* float2((1.0 / 1280), (1.0 / 720)).x,  19.3677999584* float2((1.0 / 1280), (1.0 / 720)).x };
static const float weight[11] = { 0.06649, 0.1284697563, 0.111918249, 0.0873132676, 0.0610011113, 0.0381655709, 0.0213835661, 0.0107290241, 0.0048206869, 0.0019396469, 0.0006988718 };
#line 628
blur *= weight[0];
#line 630
...
if(ClarityRadiusTwo == 3)
{
static const float offset[15] = { 0.0,   float2((1.0 / 1280), (1.0 / 720)).x*1.4953705027,   float2((1.0 / 1280), (1.0 / 720)).x*3.4891992113,   float2((1.0 / 1280), (1.0 / 720)).x*5.4830312105,   float2((1.0 / 1280), (1.0 / 720)).x*7.4768683759,   float2((1.0 / 1280), (1.0 / 720)).x*9.4707125766,   float2((1.0 / 1280), (1.0 / 720)).x*11.4645656736,   float2((1.0 / 1280), (1.0 / 720)).x*13.4584295168,   float2((1.0 / 1280), (1.0 / 720)).x*15.4523059431,   float2((1.0 / 1280), (1.0 / 720)).x*17.4461967743,   float2((1.0 / 1280), (1.0 / 720)).x*19.4401038149,   float2((1.0 / 1280), (1.0 / 720)).x*21.43402885,   float2((1.0 / 1280), (1.0 / 720)).x*23.4279736431,   float2((1.0 / 1280), (1.0 / 720)).x*25.4219399344,   float2((1.0 / 1280), (1.0 / 720)).x*27.4159294386 };
static const float weight[15] = { 0.0443266667, 0.0872994708, 0.0820892038, 0.0734818355, 0.0626171681, 0.0507956191, 0.0392263968, 0.0288369812, 0.0201808877, 0.0134446557, 0.0085266392, 0.0051478359, 0.0029586248, 0.0016187257, 0.0008430913 };
#line 647
blur *= weight[0];
#line 649
...
if(ClarityRadiusTwo == 4)
{
static const float offset[18] = { 0.0,   float2((1.0 / 1280), (1.0 / 720)).x*1.4953705027,   float2((1.0 / 1280), (1.0 / 720)).x*3.4891992113,   float2((1.0 / 1280), (1.0 / 720)).x*5.4830312105,   float2((1.0 / 1280), (1.0 / 720)).x*7.4768683759,   float2((1.0 / 1280), (1.0 / 720)).x*9.4707125766,   float2((1.0 / 1280), (1.0 / 720)).x*11.4645656736,   float2((1.0 / 1280), (1.0 / 720)).x*13.4584295168,   float2((1.0 / 1280), (1.0 / 720)).x*15.4523059431,   float2((1.0 / 1280), (1.0 / 720)).x*17.4461967743,   float2((1.0 / 1280), (1.0 / 720)).x*19.4661974725,   float2((1.0 / 1280), (1.0 / 720)).x*21.4627427973,   float2((1.0 / 1280), (1.0 / 720)).x*23.4592916956,   float2((1.0 / 1280), (1.0 / 720)).x*25.455844494,   float2((1.0 / 1280), (1.0 / 720)).x*27.4524015179,   float2((1.0 / 1280), (1.0 / 720)).x*29.4489630909,   float2((1.0 / 1280), (1.0 / 720)).x*31.445529535,   float2((1.0 / 1280), (1.0 / 720)).x*33.4421011704 };
static const float weight[18] = { 0.033245, 0.0659162217, 0.0636705814, 0.0598194658, 0.0546642566, 0.0485871646, 0.0420045997, 0.0353207015, 0.0288880982, 0.0229808311, 0.0177815511, 0.013382297, 0.0097960001, 0.0069746748, 0.0048301008, 0.0032534598, 0.0021315311, 0.0013582974 };
#line 665
blur *= weight[0];
#line 667
...
if(ClarityRadiusTwo == 1)
{
static const float offset[6] = { 0.0,   float2((1.0 / 1280), (1.0 / 720)).x*1.4584295168,   float2((1.0 / 1280), (1.0 / 720)).x*3.40398480678,   float2((1.0 / 1280), (1.0 / 720)).x*5.3518057801,   float2((1.0 / 1280), (1.0 / 720)).x*7.302940716,   float2((1.0 / 1280), (1.0 / 720)).x*9.2581597095 };
static const float weight[6] = { 0.13298, 0.23227575, 0.1353261595, 0.0511557427, 0.01253922, 0.0019913644 };
#line 683
blur *= weight[0];
#line 685
...
if(ClarityRadiusTwo == 0)
{
static const float offset[4] = { 0.0,   float2((1.0 / 1280), (1.0 / 720)).x*1.1824255238,   float2((1.0 / 1280), (1.0 / 720)).x*3.0293122308,   float2((1.0 / 1280), (1.0 / 720)).x*5.0040701377 };
static const float weight[4] = { 0.39894, 0.2959599993, 0.0045656525, 0.00000149278686458842 };
#line 701
blur *= weight[0];
#line 703
