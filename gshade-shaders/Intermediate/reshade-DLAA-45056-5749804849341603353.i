...
texture SLPtex {Width = 1309; Height = 762; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 1309), (1.0 / 762)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 1309), (1.0 / 762)).xy);
}
#line 86
