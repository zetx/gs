...
RadialCoord.x *=  (792 * (1.0 / 710));
#line 97
const float Mask = pow(2.0 * length(RadialCoord) * rsqrt( (792 * (1.0 / 710)) *  (792 * (1.0 / 710)) + 1.0), Curve);
#line 99
const float OffsetBase = Mask * Aberration * (1.0 / 710) * 2.0;
#line 102
if(abs(OffsetBase) < (1.0 / 710))
