...
{
#line 255
const float Up = LI(BB(texcoord, float2( 0,- float2((1.0 / 1798), (1.0 / 997)).y)));
const float Left = LI(BB(texcoord, float2(- float2((1.0 / 1798), (1.0 / 997)).x, 0)));
const float Center = LI(BB(texcoord, 0));
const float Right = LI(BB(texcoord, float2(  float2((1.0 / 1798), (1.0 / 997)).x, 0)));
const float Down = LI(BB(texcoord, float2( 0,  float2((1.0 / 1798), (1.0 / 997)).y)));
#line 261
