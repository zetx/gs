...
texture Anisotropy {Width = 1309; Height = 762; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 1309), (1.0 / 762), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 1309), (1.0 / 762)) * Scale;
