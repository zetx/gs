...
#line 200
texture texDownsampledBackBuffer { Width = 792; Height = 710; Format = RGBA16F; };
texture texBlurDestination { Width = 792; Height = 710; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 792), (1.0 / 710));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 792), (1.0 / 710)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 792), (1.0 / 710)));
pixelInfo.blurLengthInPixels = length( float2(792, 710)) * BlurLength;
