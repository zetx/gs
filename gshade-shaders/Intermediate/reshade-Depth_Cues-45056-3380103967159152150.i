...
#line 141
texture texHB { Width = 5360  * 0.5 ; Height = 1440 * 0.5 ; Format = R8; MipLevels = 1;};
#line 143
sampler SamplerHB
{
Texture = texHB;
...
#line 148
texture texDC { Width = 5360; Height = 1440; Format = R8; MipLevels = 3;};
#line 150
sampler SamplerDC
{
Texture = texDC;
...
float W =  12 ;
#line 199
sum += BB(texcoord , + float2( float2((1.0 / 5360), (1.0 / 1440)).x * S,0) * j ) * W;
#line 201
total += W;
}
...
{
float2 S =  Spread *  1.5 * 0.75f *  float2((1.0 / 5360), (1.0 / 1440));
#line 211
