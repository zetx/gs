...
#line 64
if(aspectRatio <  (1798 * (1.0 / 997)))
{
borderSize = (1798 - 997 * aspectRatio) / 2.0;
fractionWidth = (1798 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (1798 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (997 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (997 - 1798 / aspectRatio) / 2.0;
fractionWidth = (997 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (997 - borderSize))
retVal = gridColor;
#line 86
if((vpos.x % (1798 / fraction)) < 1)
retVal = gridColor;
#line 89
...
#line 94
if(vpos.x <= 1 || vpos.x >= 1798-1 || vpos.y <= 1 || vpos.y >= 997-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(1798, 997, 0, 0) - vpos);
}
#line 125
