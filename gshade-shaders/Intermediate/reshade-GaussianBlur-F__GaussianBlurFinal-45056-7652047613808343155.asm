...
if_z cb0[0].x
  ...
  loop 
    ...
    mul r3.y, r2.w, cb0[0].y
    mad r4.xy, r3.xyxx, l(0.000000, 0.000694, 0.000000, 0.000000), v1.xyxx
    ...
    mul r3.w, r2.w, cb0[0].y
    mad r3.yw, -r3.zzzw, l(0.000000, 0.000000, 0.000000, 0.000694), v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r3.ywyy, t4.xyzw, s0, l(0.000000)
...
if_nz r1.y
  ...
  loop 
    ...
    mul r2.y, r3.y, cb0[0].y
    mad r3.yz, r2.xxyx, l(0.000000, 0.000000, 0.000694, 0.000000), v1.xxyx
