...
add r1.xyzw, v1.xyxy, l(-0.000187, -0.000000, 0.000187, 0.000000)
...
if_nz r0.w
  ...
  add r4.xyzw, v1.xyxy, l(-0.000373, -0.000000, -0.000187, -0.000694)
  ...
  add r4.xyzw, v1.xyxy, l(-0.000187, 0.000694, 0.000373, 0.000000)
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  ...
  add r5.xyzw, v1.xyxy, l(0.000187, -0.000694, 0.000187, 0.000694)
  ...
  mad r5.y, r1.w, l(2.000000), -r2.z
  mad r2.xy, r5.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000), r2.xyxx
  add r5.xyzw, v1.xyxy, l(-0.000000, -0.001389, 0.000000, 0.001389)
  ...
  mad r2.xy, r5.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000), r2.xyxx
  add r4.xyzw, v1.xyxy, l(-0.000373, -0.000694, 0.000000, -0.000694)
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  dp3 r1.w, r5.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.zwzz, t0.xyzw, s0
  dp3 r2.z, r4.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
  add r2.z, r2.z, r2.z
  add r4.xyzw, v1.xyxy, l(-0.000187, -0.001389, -0.000187, 0.000000)
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  ...
  add r4.xyzw, v1.xyxy, l(-0.000373, 0.000694, -0.000187, 0.001389)
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  dp3 r1.w, r5.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.zwzz, t0.xyzw, s0
  dp3 r2.w, r4.xyzx, l(0.333000, 0.333000, 0.333000, 0.000000)
  ...
  mad r2.xyzw, r1.xzxz, l(0.000093, -0.000347, 0.000047, -0.000174), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, r2.xyxx, t0.xyzw, s0
  mul r4.xyz, r1.wwww, r4.xyzx
  mad r4.xyz, r0.xyzx, r0.wwww, r4.xyzx
  mad r5.xyzw, -r1.xzxz, l(0.000093, -0.000347, 0.000047, -0.000174), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r6.xyz, r5.xyxx, t0.xyzw, s0
  ...
  mad r4.xy, r1.xzxx, l(0.000187, -0.000694, 0.000000, 0.000000), v1.xyxx
  sample_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t0.xyzw, s0
  mad r2.xyz, r4.xyzx, r1.wwww, r2.xyzx
  mad r1.xz, -r1.xxzx, l(0.000187, 0.000000, -0.000694, 0.000000), v1.xxyx
