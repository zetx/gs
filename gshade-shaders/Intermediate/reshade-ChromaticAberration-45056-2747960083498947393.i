...
#line 21 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\ChromaticAberration.fx"
#line 24
...
#line 28
color.r = tex2D(ReShade::BackBuffer, texcoord + ( float2((1.0 / 1500), (1.0 / 1004)) * Shift)).r;
color.g = colorInput.g;
color.b = tex2D(ReShade::BackBuffer, texcoord - ( float2((1.0 / 1500), (1.0 / 1004)) * Shift)).b;
#line 34
