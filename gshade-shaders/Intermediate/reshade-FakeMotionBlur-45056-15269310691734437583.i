...
#line 48
texture2D currTex { Width = 5360; Height = 1440; Format = RGBA8; };
texture2D prevSingleTex { Width = 5360; Height = 1440; Format = RGBA8; };
texture2D prevTex { Width = 5360; Height = 1440; Format = RGBA8; };
#line 52
...
prev *= weight[0];
#line 68
const float pixelBlur = (mbSoftness * 13 * (diff)) * ((1.0 / 5360));
