...
#line 200
texture texDownsampledBackBuffer { Width = 1024; Height = 768; Format = RGBA16F; };
texture texBlurDestination { Width = 1024; Height = 768; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 1024), (1.0 / 768));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 1024), (1.0 / 768)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 1024), (1.0 / 768)));
pixelInfo.blurLengthInPixels = length( float2(1024, 768)) * BlurLength;
