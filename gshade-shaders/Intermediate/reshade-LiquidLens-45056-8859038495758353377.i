...
{
if (1024 > 768)
return float2(1.0, 768 * (1.0 / 1024));
else
return float2(1024 * (1.0 / 768), 1.0);
}
#line 26
...
texture LensATex
{
Width = 1024 / Downscale;
Height = 768 / Downscale;
Format = RGBA16F;
};
#line 175
sampler LensA
...
{
return Blur(LensA, uv, float2((1.0 / 1024), 0));
}
#line 221
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return Blur(LensB, uv, float2(0, (1.0 / 768)));
}
#line 226
