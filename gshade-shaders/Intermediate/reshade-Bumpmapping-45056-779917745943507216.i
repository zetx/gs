...
> = 0.75;
#line 68
texture SmoothTexture01 { Width = 1500; Height = 1004; Format = RGBA8; };
sampler Texture01S { Texture = SmoothTexture01; };
#line 72
static const float2 g10 = float2( 0.333,-1.0)* float2((1.0 / 1500), (1.0 / 1004));
static const float2 g01 = float2(-1.0,-0.333)* float2((1.0 / 1500), (1.0 / 1004));
static const float2 g12 = float2(-0.333, 1.0)* float2((1.0 / 1500), (1.0 / 1004));
static const float2 g21 = float2( 1.0, 0.333)* float2((1.0 / 1500), (1.0 / 1004));
#line 77
...
#line 101
const float2 inv_size = RANGE *  float2((1.0 / 1500), (1.0 / 1004));
#line 103
