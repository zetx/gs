...
texture texColorHDRA { Width = 792; Height = 710; Format = RGBA16F; };
texture texColorHDRB < pooled = true; > { Width = 792; Height = 710; Format = RGBA16F; };
#line 185
texture texBloomA
{
Width = 792/		4		;
...
#line 262
static const float2 pxSize = float2((1.0 / 792),(1.0 / 710));
