...
#line 61
const float2 overlayPos = fUIOverlayPos * (1.0 - fUIOverlayScale) *  float2(1799, 995);
#line 63
if(all(vpos.xy >= overlayPos) && all(vpos.xy < overlayPos +  float2(1799, 995) * fUIOverlayScale))
{
texcoord = frac((texcoord - overlayPos /  float2(1799, 995)) / fUIOverlayScale);
}
#line 68
