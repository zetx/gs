...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001484)
    mov x0[2].x, l(0.003462)
    mov x0[3].x, l(0.005440)
    mov x0[4].x, l(0.007418)
    mov x0[5].x, l(0.009397)
    mov x0[6].x, l(0.011375)
    mov x0[7].x, l(0.013354)
    mov x0[8].x, l(0.015333)
    mov x0[9].x, l(0.017312)
    mov x0[10].x, l(0.019291)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001489)
      mov x3[2].x, l(0.003475)
      mov x3[3].x, l(0.005461)
      mov x3[4].x, l(0.007447)
      mov x3[5].x, l(0.009433)
      mov x3[6].x, l(0.011419)
      mov x3[7].x, l(0.013405)
      mov x3[8].x, l(0.015391)
      mov x3[9].x, l(0.017377)
      mov x3[10].x, l(0.019363)
      mov x3[11].x, l(0.021349)
      mov x3[12].x, l(0.023335)
      mov x3[13].x, l(0.025321)
      mov x3[14].x, l(0.027307)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001489)
        mov x6[2].x, l(0.003475)
        mov x6[3].x, l(0.005461)
        mov x6[4].x, l(0.007447)
        mov x6[5].x, l(0.009433)
        mov x6[6].x, l(0.011419)
        mov x6[7].x, l(0.013405)
        mov x6[8].x, l(0.015391)
        mov x6[9].x, l(0.017377)
        mov x6[10].x, l(0.019389)
        mov x6[11].x, l(0.021377)
        mov x6[12].x, l(0.023366)
        mov x6[13].x, l(0.025354)
        mov x6[14].x, l(0.027343)
        mov x6[15].x, l(0.029332)
        mov x6[16].x, l(0.031320)
        mov x6[17].x, l(0.033309)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001453)
          mov x9[2].x, l(0.003390)
          mov x9[3].x, l(0.005330)
          mov x9[4].x, l(0.007274)
          mov x9[5].x, l(0.009221)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001178)
            mov x12[2].x, l(0.003017)
            mov x12[3].x, l(0.004984)
