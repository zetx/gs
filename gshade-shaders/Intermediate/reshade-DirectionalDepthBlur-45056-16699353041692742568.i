...
#line 200
texture texDownsampledBackBuffer { Width = 1280; Height = 720; Format = RGBA16F; };
texture texBlurDestination { Width = 1280; Height = 720; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 1280), (1.0 / 720));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 1280), (1.0 / 720)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 1280), (1.0 / 720)));
pixelInfo.blurLengthInPixels = length( float2(1280, 720)) * BlurLength;
