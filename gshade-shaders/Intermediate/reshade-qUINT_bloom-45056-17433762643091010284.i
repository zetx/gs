...
#line 124
static const float2 ASPECT_RATIO 	= float2(1.0, 5360 * (1.0 / 1440));
static const float2 PIXEL_SIZE 		= float2((1.0 / 5360), (1.0 / 1440));
static const float2 SCREEN_SIZE 	= float2(5360, 1440);
#line 130
...
#line 135
static const int BloomTex7_LowestMip =    (((1440/128 >> 1) != 0) + ((1440/128 >> 2) != 0) + ((1440/128 >> 3) != 0) + ((1440/128 >> 4) != 0) + ((1440/128 >> 5) != 0) + ((1440/128 >> 6) != 0) + ((1440/128 >> 7) != 0) + ((1440/128 >> 8) != 0) + ((1440/128 >> 9) != 0) + ((1440/128 >> 10) != 0) + ((1440/128 >> 11) != 0) + ((1440/128 >> 12) != 0) + ((1440/128 >> 13) != 0) + ((1440/128 >> 14) != 0) + ((1440/128 >> 15) != 0) + ((1440/128 >> 16) != 0));
#line 137
texture2D MXBLOOM_BloomTexSource 	{ Width = 5360/2; 	Height = 1440/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 5360/2; 	Height = 1440/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 5360/4;  	Height = 1440/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 5360/8;  	Height = 1440/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 5360/16;  Height = 1440/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 5360/32;  Height = 1440/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 5360/64;  Height = 1440/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 5360/128; Height = 1440/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
