...
#line 48
texture2D currTex { Width = 1799; Height = 998; Format = RGBA8; };
texture2D prevSingleTex { Width = 1799; Height = 998; Format = RGBA8; };
texture2D prevTex { Width = 1799; Height = 998; Format = RGBA8; };
#line 52
...
prev *= weight[0];
#line 68
const float pixelBlur = (mbSoftness * 13 * (diff)) * ((1.0 / 1799));
const float pixelBlur2 = (mbSoftness * 11 * (diff)) * ((1.0 / 998));
#line 71
[unroll]
for (int z = 1; z < 11; z++)
{
