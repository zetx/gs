...
{
if (1799 > 998)
return float2(1.0, 998 * (1.0 / 1799));
else
return float2(1799 * (1.0 / 998), 1.0);
}
#line 26
...
texture LensATex
{
Width = 1799 / Downscale;
Height = 998 / Downscale;
Format = RGBA16F;
};
#line 175
sampler LensA
...
{
return Blur(LensA, uv, float2((1.0 / 1799), 0));
}
#line 221
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return Blur(LensB, uv, float2(0, (1.0 / 998)));
}
#line 226
