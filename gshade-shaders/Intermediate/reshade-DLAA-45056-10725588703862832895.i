...
texture SLPtex {Width = 5360; Height = 1440; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 5360), (1.0 / 1440)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 5360), (1.0 / 1440)).xy);
}
#line 86
