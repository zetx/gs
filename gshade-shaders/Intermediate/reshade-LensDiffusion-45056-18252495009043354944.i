...
{
#line 44
if (((coord.x + i *  float2((1.0 / 1024), (1.0 / 768)).x) >  0.675  ||
(coord.x - i *  float2((1.0 / 1024), (1.0 / 768)).x) <   0.325)) continue;
#line 47
...
{
#line 88
if (((coord.y + i *  float2((1.0 / 1024), (1.0 / 768)).y) >  0.675   ||
(coord.y - i *  float2((1.0 / 1024), (1.0 / 768)).y) <  0.325)) continue;
#line 91
