...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.000828)
    mov x0[2].x, l(0.001932)
    mov x0[3].x, l(0.003036)
    mov x0[4].x, l(0.004140)
    mov x0[5].x, l(0.005244)
    mov x0[6].x, l(0.006348)
    mov x0[7].x, l(0.007453)
    mov x0[8].x, l(0.008557)
    mov x0[9].x, l(0.009661)
    mov x0[10].x, l(0.010766)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.000831)
      mov x3[2].x, l(0.001940)
      mov x3[3].x, l(0.003048)
      mov x3[4].x, l(0.004156)
      mov x3[5].x, l(0.005264)
      mov x3[6].x, l(0.006373)
      mov x3[7].x, l(0.007481)
      mov x3[8].x, l(0.008589)
      mov x3[9].x, l(0.009698)
      mov x3[10].x, l(0.010806)
      mov x3[11].x, l(0.011914)
      mov x3[12].x, l(0.013023)
      mov x3[13].x, l(0.014131)
      mov x3[14].x, l(0.015240)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.000831)
        mov x6[2].x, l(0.001940)
        mov x6[3].x, l(0.003048)
        mov x6[4].x, l(0.004156)
        mov x6[5].x, l(0.005264)
        mov x6[6].x, l(0.006373)
        mov x6[7].x, l(0.007481)
        mov x6[8].x, l(0.008589)
        mov x6[9].x, l(0.009698)
        mov x6[10].x, l(0.010821)
        mov x6[11].x, l(0.011930)
        mov x6[12].x, l(0.013040)
        mov x6[13].x, l(0.014150)
        mov x6[14].x, l(0.015260)
        mov x6[15].x, l(0.016370)
        mov x6[16].x, l(0.017479)
        mov x6[17].x, l(0.018589)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.000811)
          mov x9[2].x, l(0.001892)
          mov x9[3].x, l(0.002975)
          mov x9[4].x, l(0.004059)
          mov x9[5].x, l(0.005146)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.000657)
            mov x12[2].x, l(0.001684)
            mov x12[3].x, l(0.002782)
