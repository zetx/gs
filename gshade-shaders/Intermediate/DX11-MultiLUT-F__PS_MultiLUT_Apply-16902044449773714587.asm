...
//   float DitherTimer;                 // Offset:   16 Size:     4
//
// }
//
//
...
dcl_output o0.xyz
dcl_temps 5
mad r0.xy, cb0[1].xxxx, l(0.001000, 0.001000, 0.000000, 0.000000), v1.xyxx
...
mad r3.xyz, cb0[0].yyyy, r3.xyzx, r2.xyzx
...
mad r2.xyz, cb0[0].zzzz, r3.xyzx, r2.xyzx
add r0.w, r0.w, -r2.w
mad r0.w, cb0[0].w, r0.w, r2.w
