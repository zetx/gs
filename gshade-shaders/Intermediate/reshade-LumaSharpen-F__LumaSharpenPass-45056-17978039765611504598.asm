...
if_nz r1.x
  mad r4.xyzw, cb0[0].wwww, l(0.000278, -0.000501, 0.000278, 0.000501), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000278, 0.000501, 0.000278, -0.000501), v1.xyxy
...
if_nz r1.y
  mad r4.xyzw, cb0[0].wwww, l(0.000222, -0.001202, 0.000667, 0.000401), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r1.xyw, r4.xyxx, t0.xywz, s0
  mad r5.xyzw, -cb0[0].wwww, l(0.000667, 0.000401, 0.000222, -0.001202), v1.xyxy
...
if_nz r1.z
  mov r1.xw, l(0.000278,0,0,-0.000501)
  mul r1.yz, cb0[0].wwww, l(0.000000, -0.001002, -0.000556, 0.000000)
  ...
  mul r4.xw, cb0[0].wwww, l(0.000556, 0.000000, 0.000000, 0.001002)
  mov r4.yz, l(0,0.000501,-0.000278,0)
