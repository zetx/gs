...
#line 76
return color + ((gold_noise(texcoord *  float2(1500, 1004).y * 2.0, ((luminance *  float2(1500, 1004).y) + ( float2(1500, 1004).x * texcoord.y) + texcoord.x + ReShade::GetLinearizedDepth(texcoord) *  float2(1500, 1004).y) * 0.0001) * amount) - sub);
}
#line 79
