...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001034)
    mov x0[2].x, l(0.002414)
    mov x0[3].x, l(0.003793)
    mov x0[4].x, l(0.005172)
    mov x0[5].x, l(0.006552)
    mov x0[6].x, l(0.007931)
    mov x0[7].x, l(0.009311)
    mov x0[8].x, l(0.010690)
    mov x0[9].x, l(0.012070)
    mov x0[10].x, l(0.013450)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001038)
      mov x3[2].x, l(0.002423)
      mov x3[3].x, l(0.003808)
      mov x3[4].x, l(0.005192)
      mov x3[5].x, l(0.006577)
      mov x3[6].x, l(0.007962)
      mov x3[7].x, l(0.009346)
      mov x3[8].x, l(0.010731)
      mov x3[9].x, l(0.012115)
      mov x3[10].x, l(0.013500)
      mov x3[11].x, l(0.014885)
      mov x3[12].x, l(0.016269)
      mov x3[13].x, l(0.017654)
      mov x3[14].x, l(0.019039)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001038)
        mov x6[2].x, l(0.002423)
        mov x6[3].x, l(0.003808)
        mov x6[4].x, l(0.005192)
        mov x6[5].x, l(0.006577)
        mov x6[6].x, l(0.007962)
        mov x6[7].x, l(0.009346)
        mov x6[8].x, l(0.010731)
        mov x6[9].x, l(0.012115)
        mov x6[10].x, l(0.013518)
        mov x6[11].x, l(0.014905)
        mov x6[12].x, l(0.016291)
        mov x6[13].x, l(0.017678)
        mov x6[14].x, l(0.019064)
        mov x6[15].x, l(0.020451)
        mov x6[16].x, l(0.021837)
        mov x6[17].x, l(0.023224)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001013)
          mov x9[2].x, l(0.002364)
          mov x9[3].x, l(0.003717)
          mov x9[4].x, l(0.005071)
          mov x9[5].x, l(0.006429)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.000821)
            mov x12[2].x, l(0.002104)
            mov x12[3].x, l(0.003475)
