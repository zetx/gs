...
if ( (1799 * (1.0 / 995)) < border_ratio)
border_width_variable = float2(0.0, (995 - (1799 / border_ratio)) * 0.5);
else
border_width_variable = float2((1799 - (995 * border_ratio)) * 0.5, 0.0);
#line 56
const float2 border = ( float2((1.0 / 1799), (1.0 / 995)) * border_width_variable); 
#line 58
