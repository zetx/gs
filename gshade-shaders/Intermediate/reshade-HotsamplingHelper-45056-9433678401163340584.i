...
#line 61
const float2 overlayPos = fUIOverlayPos * (1.0 - fUIOverlayScale) *  float2(1798, 997);
#line 63
if(all(vpos.xy >= overlayPos) && all(vpos.xy < overlayPos +  float2(1798, 997) * fUIOverlayScale))
{
texcoord = frac((texcoord - overlayPos /  float2(1798, 997)) / fUIOverlayScale);
}
#line 68
