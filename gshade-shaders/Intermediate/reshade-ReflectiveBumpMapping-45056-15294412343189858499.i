...
const float2 offs =  float2((1.0 / 5360), (1.0 / 1440))*1.0;
...
const float3 TextureNormals 		= GetNormalFromColor(texcoord.xy, 0.01 *  float2((1.0 / 5360), (1.0 / 1440)) / scenedepth, 0.0002 / scenedepth + 0.1, 1000.0);
...
{
const float2 currentOffset 	= texcoord.xy + SceneNormals.xy *  float2((1.0 / 5360), (1.0 / 1440)) * i/(float)iRBM_SampleCount * fRBM_BlurWidthPixels;
