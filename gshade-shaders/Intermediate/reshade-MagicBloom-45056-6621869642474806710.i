...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 1280 / 2; Height = 720 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 1280 / 4; Height = 720 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 1280 / 8; Height = 720 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 1280 / 16; Height = 720 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 1280 / 32; Height = 720 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 1280 / 64; Height = 720 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 1280 / 128; Height = 720 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 1280 / 256; Height = 720 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 1280; Height = 720; };
#line 269
...
float2 ps =  float2((1.0 / 1280), (1.0 / 720)) * scale;
#line 303
