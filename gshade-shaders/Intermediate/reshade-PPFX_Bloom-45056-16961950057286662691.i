...
texture texColorHDRA { Width = 1024; Height = 768; Format = RGBA16F; };
texture texColorHDRB < pooled = true; > { Width = 1024; Height = 768; Format = RGBA16F; };
#line 185
texture texBloomA
{
Width = 1024/		4		;
...
#line 262
static const float2 pxSize = float2((1.0 / 1024),(1.0 / 768));
