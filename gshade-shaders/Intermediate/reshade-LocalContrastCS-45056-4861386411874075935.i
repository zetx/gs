...
texture LocalTiles {Width =  1024; Height =  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).y; Format = R32f;};
texture Histogram {Width =  1024; Height = 1; Format = R32f;};
texture HistogramLUT {Width =  1024; Height =  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).y; Format = R32f;};
texture RegionVariancesH {Width =  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).y; Height = 1; Format = RGBA32f;};
texture RegionVariances {Width =  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).y; Height = 1; Format = RGBA32f;};
#line 60
...
uint groupIndex = gid.x + gid.y *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x;
#line 163
[unroll]
...
if(any(coord >= uint2(1280, 720)) || any(coord < 0))
{
...
uint group = groupCoord.x + groupCoord.y *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x;
int2 groupCoordW;
float samples[4];
...
{
groupCoordTemp.x -= 1;
groupCoordTemp = clamp(groupCoordTemp, 0,  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))));
groupCoordW = groupCoordTemp;
group = groupCoord.x + groupCoord.y *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x;
...
groupCoordTemp = clamp(groupCoordTemp, 0,  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))));
groupCoordW = groupCoordTemp;
group = groupCoordTemp.x + groupCoordTemp.y *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x;
samples[1] = tex2Dfetch(sHistogramLUT, float2(yOld *  1024, group)).x;
varianceSamples[1] = tex2Dfetch(sRegionVariances, float2(group, 0)).xyz;
}
#line 394
...
#line 413
group = groupCoordW.x + groupCoordW.y *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x;
...
{
GaussianVariance = 0;
uint textureHeight =  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).y;
...
uint2 group = uint2(coord.x / ( uint2(32, 32).x *  uint2(3, 3).x), (coord.y / ( uint2(32, 32).y *  uint2(3, 3).y)));
int2 clampingValues;
clampingValues.x = coord.y %  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x;
clampingValues.y = textureHeight - ( uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x - clampingValues.x) - 1;
[unroll]
for(int i = -4; i <= 4; i++)
{
int2 sampleCoord = uint2(coord.x, coord.y + i *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x);
...
uint2 coord = texcoord * float2(1280, 720);
float yOld = dot(color, float3(0.299, 0.587, 0.114));
uint group = coord.x / ( uint2(32, 32).x *  uint2(3, 3).x) + (coord.y / ( uint2(32, 32).y *  uint2(3, 3).y)) *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x;
float3 variances;
float yNew;
...
DispatchSizeX =  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x;
DispatchSizeY =  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).y;
}
#line 510
pass
{
...
DispatchSizeX = 1;
DispatchSizeY =  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).x *  uint2( (int(1280 +  uint2(3, 3).x *  uint2(32, 32).x *  1 - 1) / int( uint2(3, 3).x *  uint2(32, 32).x *  1)),  (int(720 +  uint2(3, 3).y *  uint2(32, 32).y *  1 - 1) / int( uint2(3, 3).y *  uint2(32, 32).y *  1))).y;
}
#line 517
pass
{
