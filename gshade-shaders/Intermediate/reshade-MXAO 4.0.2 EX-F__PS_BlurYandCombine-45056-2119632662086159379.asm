...
loop 
  ...
  mad r3.xy, r3.xyxx, l(0.000667, 0.000996, 0.000000, 0.000000), v1.xyxx
...
if_nz r1.x
  ...
  if_nz r0.x
    add r0.xyzw, v1.zwzw, l(0.005333, 0.007968, -0.005333, 0.007968)
    ...
    add r0.x, r0.y, r0.x
    add r1.xyzw, v1.zwzw, l(0.005333, -0.007968, -0.005333, -0.007968)
