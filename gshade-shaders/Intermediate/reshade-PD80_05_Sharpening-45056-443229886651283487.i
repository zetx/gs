...
> = 1.0;
#line 112
texture texGaussianH { Width = 5360; Height = 1440; };
texture texGaussian { Width = 5360; Height = 1440; };
#line 116
...
float loops      = max( 5360, 1440 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 5360, 1440 ) / 1920.0f ); 
