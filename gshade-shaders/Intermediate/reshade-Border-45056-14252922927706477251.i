...
if ( (1281 * (1.0 / 721)) < border_ratio)
border_width_variable = float2(0.0, (721 - (1281 / border_ratio)) * 0.5);
else
border_width_variable = float2((1281 - (721 * border_ratio)) * 0.5, 0.0);
#line 56
const float2 border = ( float2((1.0 / 1281), (1.0 / 721)) * border_width_variable); 
#line 58
