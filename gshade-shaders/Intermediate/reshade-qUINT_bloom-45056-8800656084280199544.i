...
#line 135
static const int BloomTex7_LowestMip =    (((710/128 >> 1) != 0) + ((710/128 >> 2) != 0) + ((710/128 >> 3) != 0) + ((710/128 >> 4) != 0) + ((710/128 >> 5) != 0) + ((710/128 >> 6) != 0) + ((710/128 >> 7) != 0) + ((710/128 >> 8) != 0) + ((710/128 >> 9) != 0) + ((710/128 >> 10) != 0) + ((710/128 >> 11) != 0) + ((710/128 >> 12) != 0) + ((710/128 >> 13) != 0) + ((710/128 >> 14) != 0) + ((710/128 >> 15) != 0) + ((710/128 >> 16) != 0));
#line 137
texture2D MXBLOOM_BloomTexSource 	{ Width = 792/2; 	Height = 710/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 792/2; 	Height = 710/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 792/4;  	Height = 710/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 792/8;  	Height = 710/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 792/16;  Height = 710/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 792/32;  Height = 710/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 792/64;  Height = 710/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 792/128; Height = 710/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
