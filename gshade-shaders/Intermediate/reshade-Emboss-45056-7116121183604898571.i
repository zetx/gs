...
const float3 col1 = tex2D(ReShade::BackBuffer, texcoord -  float2((1.0 / 1280), (1.0 / 720))*fEmbossOffset*offset).rgb;
const float3 col3 = tex2D(ReShade::BackBuffer, texcoord +  float2((1.0 / 1280), (1.0 / 720))*fEmbossOffset*offset).rgb;
#line 37
