...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001455)
    mov x0[2].x, l(0.003394)
    mov x0[3].x, l(0.005334)
    mov x0[4].x, l(0.007274)
    mov x0[5].x, l(0.009213)
    mov x0[6].x, l(0.011153)
    mov x0[7].x, l(0.013093)
    mov x0[8].x, l(0.015033)
    mov x0[9].x, l(0.016973)
    mov x0[10].x, l(0.018914)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001460)
      mov x3[2].x, l(0.003407)
      mov x3[3].x, l(0.005355)
      mov x3[4].x, l(0.007302)
      mov x3[5].x, l(0.009249)
      mov x3[6].x, l(0.011196)
      mov x3[7].x, l(0.013143)
      mov x3[8].x, l(0.015090)
      mov x3[9].x, l(0.017037)
      mov x3[10].x, l(0.018984)
      mov x3[11].x, l(0.020932)
      mov x3[12].x, l(0.022879)
      mov x3[13].x, l(0.024826)
      mov x3[14].x, l(0.026773)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001460)
        mov x6[2].x, l(0.003407)
        mov x6[3].x, l(0.005355)
        mov x6[4].x, l(0.007302)
        mov x6[5].x, l(0.009249)
        mov x6[6].x, l(0.011196)
        mov x6[7].x, l(0.013143)
        mov x6[8].x, l(0.015090)
        mov x6[9].x, l(0.017037)
        mov x6[10].x, l(0.019010)
        mov x6[11].x, l(0.020960)
        mov x6[12].x, l(0.022909)
        mov x6[13].x, l(0.024859)
        mov x6[14].x, l(0.026809)
        mov x6[15].x, l(0.028759)
        mov x6[16].x, l(0.030709)
        mov x6[17].x, l(0.032658)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001424)
          mov x9[2].x, l(0.003324)
          mov x9[3].x, l(0.005226)
          mov x9[4].x, l(0.007132)
          mov x9[5].x, l(0.009041)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001155)
            mov x12[2].x, l(0.002958)
            mov x12[3].x, l(0.004887)
