...
> = 1.0;
#line 112
texture texGaussianH { Width = 1280; Height = 720; };
texture texGaussian { Width = 1280; Height = 720; };
#line 116
...
float loops      = max( 1280, 720 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 1280, 720 ) / 1920.0f ); 
