...
RadialCoord.x *=  (1500 * (1.0 / 1004));
#line 97
const float Mask = pow(2.0 * length(RadialCoord) * rsqrt( (1500 * (1.0 / 1004)) *  (1500 * (1.0 / 1004)) + 1.0), Curve);
#line 99
const float OffsetBase = Mask * Aberration * (1.0 / 1004) * 2.0;
#line 102
if(abs(OffsetBase) < (1.0 / 1004))
