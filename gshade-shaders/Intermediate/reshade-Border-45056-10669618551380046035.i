...
if ( (792 * (1.0 / 710)) < border_ratio)
border_width_variable = float2(0.0, (710 - (792 / border_ratio)) * 0.5);
else
border_width_variable = float2((792 - (710 * border_ratio)) * 0.5, 0.0);
#line 56
const float2 border = ( float2((1.0 / 792), (1.0 / 710)) * border_width_variable); 
#line 58
