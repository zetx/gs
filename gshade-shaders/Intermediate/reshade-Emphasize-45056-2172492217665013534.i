...
if(Spherical == true)
{
texcoord.x = (texcoord.x-Sphere_FocusHorizontal)*1500;
texcoord.y = (texcoord.y-Sphere_FocusVertical)*1004;
const float degreePerPixel = Sphere_FieldOfView*(1.0 / 1500);
