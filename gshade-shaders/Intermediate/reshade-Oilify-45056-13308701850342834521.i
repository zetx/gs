...
texture Anisotropy {Width = 1799; Height = 998; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 1799), (1.0 / 998), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 1799), (1.0 / 998)) * Scale;
