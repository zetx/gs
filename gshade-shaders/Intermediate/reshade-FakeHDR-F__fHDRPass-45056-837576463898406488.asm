...
dcl_output o0.xyz
dcl_temps 4
mad r0.xyzw, cb0[0].yyyy, l(0.000436, -0.001042, -0.000436, -0.001042), v1.xyxy
...
mad r1.xyzw, cb0[0].yyyy, l(0.000436, 0.001042, -0.000436, 0.001042), v1.xyxy
...
mad r1.xyzw, cb0[0].yyyy, l(0.000000, -0.001736, 0.000000, 0.001736), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
add r0.xyz, r0.xyzx, r2.xyzx
add r0.xyz, r1.xyzx, r0.xyzx
mad r1.xyzw, cb0[0].yyyy, l(-0.000727, 0.000000, 0.000727, 0.000000), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
add r0.xyz, r0.xyzx, r2.xyzx
add r0.xyz, r1.xyzx, r0.xyzx
mul r0.xyz, r0.xyzx, l(0.005000, 0.005000, 0.005000, 0.000000)
mad r1.xyzw, cb0[0].zzzz, l(0.000436, -0.001042, -0.000436, -0.001042), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t0.xyzw, s0
add r1.xyz, r1.xyzx, r2.xyzx
mad r2.xyzw, cb0[0].zzzz, l(0.000436, 0.001042, -0.000436, 0.001042), v1.xyxy
...
mad r2.xyzw, cb0[0].zzzz, l(0.000000, -0.001736, 0.000000, 0.001736), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.zwzz, t0.xyzw, s0
add r1.xyz, r1.xyzx, r3.xyzx
add r1.xyz, r2.xyzx, r1.xyzx
mad r2.xyzw, cb0[0].zzzz, l(-0.000727, 0.000000, 0.000727, 0.000000), v1.xyxy
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r2.xyxx, t0.xyzw, s0
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.zwzz, t0.xyzw, s0
add r1.xyz, r1.xyzx, r3.xyzx
add r1.xyz, r2.xyzx, r1.xyzx
