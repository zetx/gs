...
texture texDraw { Width = 1024; Height = 768; };
texture texVPreOut { Width = 1024; Height = 768; };
#line 129
...
float2 pixelsize =  float2((1.0 / 1024), (1.0 / 768)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(1024, 768) * cLayerVPre_Scale /  float2(1024, 768));
