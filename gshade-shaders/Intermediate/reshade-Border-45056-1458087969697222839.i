...
if ( (1798 * (1.0 / 997)) < border_ratio)
border_width_variable = float2(0.0, (997 - (1798 / border_ratio)) * 0.5);
else
border_width_variable = float2((1798 - (997 * border_ratio)) * 0.5, 0.0);
#line 56
const float2 border = ( float2((1.0 / 1798), (1.0 / 997)) * border_width_variable); 
#line 58
