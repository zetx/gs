...
#line 200
texture texDownsampledBackBuffer { Width = 1798; Height = 997; Format = RGBA16F; };
texture texBlurDestination { Width = 1798; Height = 997; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 1798), (1.0 / 997));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 1798), (1.0 / 997)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 1798), (1.0 / 997)));
pixelInfo.blurLengthInPixels = length( float2(1798, 997)) * BlurLength;
