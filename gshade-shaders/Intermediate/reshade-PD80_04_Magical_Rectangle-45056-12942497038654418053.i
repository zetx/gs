...
> = 1.0;
#line 217
texture texMagicRectangle { Width = 1500; Height = 1004; Format = RGBA16F; };
#line 220
...
uv.y         = ( id == 1 ) ? 2.0 : 0.0;
uv.xy        -= center.xy;
uv.y         /=  float( 1500 * (1.0 / 1004) );
float dim    = ceil( sqrt( 1500 * 1500 + 1004 * 1004 )); 
float maxlen = min( 1500, 1004 );
dim          = dim / maxlen; 
uv.xy        /= dim;
