...
> = 1.0;
#line 112
texture texGaussianH { Width = 792; Height = 710; };
texture texGaussian { Width = 792; Height = 710; };
#line 116
...
float loops      = max( 792, 710 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 792, 710 ) / 1920.0f ); 
