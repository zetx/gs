...
#line 64
if(aspectRatio <  (1799 * (1.0 / 995)))
{
borderSize = (1799 - 995 * aspectRatio) / 2.0;
fractionWidth = (1799 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (1799 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (995 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (995 - 1799 / aspectRatio) / 2.0;
fractionWidth = (995 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (995 - borderSize))
retVal = gridColor;
#line 86
if((vpos.x % (1799 / fraction)) < 1)
retVal = gridColor;
#line 89
...
#line 94
if(vpos.x <= 1 || vpos.x >= 1799-1 || vpos.y <= 1 || vpos.y >= 995-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(1799, 995, 0, 0) - vpos);
}
#line 125
