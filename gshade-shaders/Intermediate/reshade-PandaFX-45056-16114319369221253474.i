...
texture prePassLayer { Width = 3440; Height = 1440; Format = RGBA8; };
texture blurLayerHorizontal { Width = 3440 / 2; Height = 1440 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 3440 / 2; Height = 1440 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 3440 / 16; Height = 1440 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 3440 / 16; Height = 1440 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 3440 / 64; Height = 1440 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 3440 / 64; Height = 1440 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 3440 * sampling;
