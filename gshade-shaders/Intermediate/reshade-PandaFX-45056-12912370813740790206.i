...
texture prePassLayer { Width = 1799; Height = 995; Format = RGBA8; };
texture blurLayerHorizontal { Width = 1799 / 2; Height = 995 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 1799 / 2; Height = 995 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 1799 / 16; Height = 995 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 1799 / 16; Height = 995 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 1799 / 64; Height = 995 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 1799 / 64; Height = 995 / 64; Format = RGBA8; };
#line 324
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 995 * sampling;
float divisor = 0.000001;
#line 410
