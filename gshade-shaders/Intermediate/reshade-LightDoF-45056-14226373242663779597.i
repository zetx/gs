...
#line 180
if (bLightDoF_UseCA) {
float2 rCoord = uv + offset *  float2((1.0 / 5360), (1.0 / 1440)) * fLightDoF_Width * (1.0 + CA);
float2 gCoord = uv + offset *  float2((1.0 / 5360), (1.0 / 1440)) * fLightDoF_Width * (1.0 + CA * 0.5);
float2 bCoord = uv + offset *  float2((1.0 / 5360), (1.0 / 1440)) * fLightDoF_Width;
#line 185
...
float2 coord = uv + offset *  float2((1.0 / 5360), (1.0 / 1440)) * fLightDoF_Width;
...
const float2 linearMouse = f2LightDoF_MouseCoord *  float2((1.0 / 5360), (1.0 / 1440)); 
float2 focus;
