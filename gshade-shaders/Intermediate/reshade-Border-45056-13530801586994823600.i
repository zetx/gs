...
if ( (1024 * (1.0 / 768)) < border_ratio)
border_width_variable = float2(0.0, (768 - (1024 / border_ratio)) * 0.5);
else
border_width_variable = float2((1024 - (768 * border_ratio)) * 0.5, 0.0);
#line 56
const float2 border = ( float2((1.0 / 1024), (1.0 / 768)) * border_width_variable); 
#line 58
