...
#line 76
return color + ((gold_noise(texcoord *  float2(1309, 762).y * 2.0, ((luminance *  float2(1309, 762).y) + ( float2(1309, 762).x * texcoord.y) + texcoord.x + ReShade::GetLinearizedDepth(texcoord) *  float2(1309, 762).y) * 0.0001) * amount) - sub);
}
#line 79
