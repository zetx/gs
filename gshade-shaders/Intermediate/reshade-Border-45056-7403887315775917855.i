...
if ( (1309 * (1.0 / 762)) < border_ratio)
border_width_variable = float2(0.0, (762 - (1309 / border_ratio)) * 0.5);
else
border_width_variable = float2((1309 - (762 * border_ratio)) * 0.5, 0.0);
#line 56
const float2 border = ( float2((1.0 / 1309), (1.0 / 762)) * border_width_variable); 
#line 58
