...
texture prePassLayer { Width = 1500; Height = 1004; Format = RGBA8; };
texture blurLayerHorizontal { Width = 1500 / 2; Height = 1004 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 1500 / 2; Height = 1004 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 1500 / 16; Height = 1004 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 1500 / 16; Height = 1004 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 1500 / 64; Height = 1004 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 1500 / 64; Height = 1004 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 1500 * sampling;
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 1004 * sampling;
float divisor = 0.000001;
#line 410
