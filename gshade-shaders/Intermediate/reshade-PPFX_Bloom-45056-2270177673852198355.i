...
#line 14 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\PPFX_Bloom.fx"
#line 26
...
texture texColorHDRA { Width = 1500; Height = 1004; Format = RGBA16F; };
texture texColorHDRB < pooled = true; > { Width = 1500; Height = 1004; Format = RGBA16F; };
#line 185
texture texBloomA
{
Width = 1500/		4		;
...
#line 262
static const float2 pxSize = float2((1.0 / 1500),(1.0 / 1004));
