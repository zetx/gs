...
texture SLPtex {Width = 1500; Height = 1004; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 1500), (1.0 / 1004)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 1500), (1.0 / 1004)).xy);
}
#line 86
