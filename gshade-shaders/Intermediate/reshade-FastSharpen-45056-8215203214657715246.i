...
> = 0.50;
#line 48
static const float2 g10 = float2( 0.3333,-1.0)* float2((1.0 / 1280), (1.0 / 720));
static const float2 g01 = float2(-1.0,-0.3333)* float2((1.0 / 1280), (1.0 / 720));
static const float2 g12 = float2(-0.3333, 1.0)* float2((1.0 / 1280), (1.0 / 720));
static const float2 g21 = float2( 1.0, 0.3333)* float2((1.0 / 1280), (1.0 / 720));
#line 53
