...
> = 1.0;
#line 112
texture texGaussianH { Width = 1798; Height = 997; };
texture texGaussian { Width = 1798; Height = 997; };
#line 116
...
float loops      = max( 1798, 997 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 1798, 997 ) / 1920.0f ); 
