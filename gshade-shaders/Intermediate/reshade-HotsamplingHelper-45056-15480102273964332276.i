...
#line 61
const float2 overlayPos = fUIOverlayPos * (1.0 - fUIOverlayScale) *  float2(1799, 998);
#line 63
if(all(vpos.xy >= overlayPos) && all(vpos.xy < overlayPos +  float2(1799, 998) * fUIOverlayScale))
{
texcoord = frac((texcoord - overlayPos /  float2(1799, 998)) / fUIOverlayScale);
}
#line 68
