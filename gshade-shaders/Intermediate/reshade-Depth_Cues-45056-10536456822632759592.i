...
#line 141
texture texHB { Width = 1024  * 0.5 ; Height = 768 * 0.5 ; Format = R8; MipLevels = 1;};
#line 143
sampler SamplerHB
{
Texture = texHB;
...
#line 148
texture texDC { Width = 1024; Height = 768; Format = R8; MipLevels = 3;};
#line 150
sampler SamplerDC
{
Texture = texDC;
...
float W =  12 ;
#line 199
sum += BB(texcoord , + float2( float2((1.0 / 1024), (1.0 / 768)).x * S,0) * j ) * W;
#line 201
total += W;
}
...
{
float2 S =  Spread *  1.0 * 0.75f *  float2((1.0 / 1024), (1.0 / 768));
#line 211
