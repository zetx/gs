...
texture Luma <Pooled = true;> {Width = 5360; Height = 1440; Format = R16f;};
texture Sobel <Pooled = true;> {Width = 5360; Height = 1440; Format = R8;};
#line 16
...
{
float3 offset = float3( float2((1.0 / 5360), (1.0 / 1440)), 0.0);
float c;
float4 h;
float4 v;
if(Anisotropy == 1)
...
{
float2 offset = (float2(i, j) * normals.xy) * 1 / float2(5360, 1440);
