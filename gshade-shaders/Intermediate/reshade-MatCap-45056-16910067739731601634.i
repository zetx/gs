...
#line 5 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\MatCap.fx"
#line 14
...
static const float2 offset = float2((1.0 / 1500), 0.0); 
return (get_depth(uv + offset) - get_depth(uv - offset)) * 1500 * 0.5;
}
#line 37
float get_depth_ddy(float2 uv) {
static const float2 offset = float2(0.0, (1.0 / 1004)); 
return (get_depth(uv - offset) - get_depth(uv + offset)) * 1004 * 0.5;
}
#line 42
