...
//   float DitherTimer;                 // Offset:   48 Size:     4
//
// }
//
//
...
mad r2.xy, cb0[3].xxxx, l(0.001000, 0.001000, 0.000000, 0.000000), v1.xyxx
dp2 r1.w, r2.xyxx, l(25.979601, 156.466003, 0.000000, 0.000000)
sincos r1.w, null, r1.w
mul r1.w, r1.w, l(43758.542969)
frc r2.z, r1.w
mov r2.xy, v1.xyxx
add r2.xyz, r2.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
mad r1.w, r2.x, l(34.000000), l(1.000000)
mul r1.w, r2.x, r1.w
mul r2.x, r1.w, l(289.000000)
ge r2.x, r2.x, -r2.x
movc r2.xw, r2.xxxx, l(289.000000,0,0,0.003460), l(-289.000000,0,0,-0.003460)
mul r1.w, r1.w, r2.w
frc r1.w, r1.w
mad r1.w, r2.x, r1.w, r2.y
mad r2.x, r1.w, l(34.000000), l(1.000000)
mul r1.w, r1.w, r2.x
mul r2.x, r1.w, l(289.000000)
ge r2.x, r2.x, -r2.x
...
frc r1.w, r1.w
mul r1.w, r1.w, r2.x
mul r2.x, r1.w, l(0.024390)
mad r2.w, r1.w, l(34.000000), l(1.000000)
mul r1.w, r1.w, r2.w
mul r2.w, r1.w, l(289.000000)
ge r2.w, r2.w, -r2.w
movc r3.xy, r2.wwww, l(289.000000,0.003460,0,0), l(-289.000000,-0.003460,0,0)
mul r1.w, r1.w, r3.y
frc r1.w, r1.w
mul r1.w, r1.w, r3.x
mul r2.w, r1.w, l(0.024390)
frc r3.x, r2.w
mad r2.w, r1.w, l(34.000000), l(1.000000)
mul r1.w, r1.w, r2.w
mul r2.w, r1.w, l(289.000000)
ge r2.w, r2.w, -r2.w
movc r4.xy, r2.wwww, l(289.000000,0.003460,0,0), l(-289.000000,-0.003460,0,0)
mul r1.w, r1.w, r4.y
frc r1.w, r1.w
mul r1.w, r1.w, r4.x
mul r2.w, r1.w, l(0.024390)
...
mul_sat r3.xyz, r1.xyzx, l(509.999969, 509.999969, 509.999969, 0.000000)
mad r0.xyz, r0.xxxx, r0.yzwy, l(-1.000000, -1.000000, -1.000000, 0.000000)
mul_sat r0.xyz, r0.xyzx, l(-509.992279, -509.992279, -509.992279, 0.000000)
min r0.xyz, r0.xyzx, r3.xyzx
add r2.xyz, -r4.xyzx, r2.xyzx
mad r0.xyz, r0.xyzx, r2.xyzx, r4.xyzx
mad o0.xyz, r0.xyzx, l(0.003922, 0.003922, 0.003922, 0.000000), r1.xyzx
mov o0.w, l(0)
ret 
