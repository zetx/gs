...
{
if (1309 > 762)
return float2(1.0, 762 * (1.0 / 1309));
else
return float2(1309 * (1.0 / 762), 1.0);
}
#line 26
...
texture LensATex
{
Width = 1309 / Downscale;
Height = 762 / Downscale;
Format = RGBA16F;
};
#line 175
sampler LensA
...
{
return Blur(LensA, uv, float2((1.0 / 1309), 0));
}
#line 221
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return Blur(LensB, uv, float2(0, (1.0 / 762)));
}
#line 226
