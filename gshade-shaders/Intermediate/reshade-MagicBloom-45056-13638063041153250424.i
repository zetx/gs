...
#line 69 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\MagicBloom.fx"
#line 98
...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 5360 / 2; Height = 1440 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 5360 / 4; Height = 1440 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 5360 / 8; Height = 1440 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 5360 / 16; Height = 1440 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 5360 / 32; Height = 1440 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 5360 / 64; Height = 1440 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 5360 / 128; Height = 1440 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 5360 / 256; Height = 1440 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 5360; Height = 1440; };
#line 269
...
float2 ps =  float2((1.0 / 5360), (1.0 / 1440)) * scale;
#line 303
...
col = bloom;
#line 452
return float4(col + TriDither(col, uv, 8), 1.0);
#line 456
}
#line 467
