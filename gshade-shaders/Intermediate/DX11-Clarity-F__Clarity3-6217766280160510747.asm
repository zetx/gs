...
if_z cb0[0].x
  ...
  loop 
    ...
    mov r2.z, x3[r1.y + 0].x
    mad r0.x, r2.x, r2.z, r1.w
    iadd r1.y, r1.y, l(1)
    ilt r1.z, r1.y, l(4)
  endloop 
endif 
if_nz r0.y
  ...
  loop 
    ...
    mul r2.z, r2.z, cb0[0].y
    mul r1.x, r2.z, l(0.000291)
    add r2.zw, r1.xxxy, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r1.x, r2.zwzz, t6.xyzw, s0, l(0.000000)
    ...
    mul r2.z, r2.z, cb0[0].y
    mul r1.z, r2.z, l(0.000291)
    add r2.zw, -r1.zzzw, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r1.z, r2.zwzz, t6.yzxw, s0, l(0.000000)
...
if_nz r0.z
  ...
  loop 
    ...
    mul r2.y, r2.y, cb0[0].y
    mul r1.z, r2.y, l(0.000291)
    add r2.yz, -r1.zzwz, v1.xxyx
    sample_l_indexable(texture2d)(float,float,float,float) r1.z, r2.yzyy, t6.yzxw, s0, l(0.000000)
...
if_nz r0.w
  ...
  loop 
    ...
    mul r2.x, r2.x, cb0[0].y
    mul r1.z, r2.x, l(0.000291)
    add r2.xy, -r1.zwzz, v1.xyxx
    sample_l_indexable(texture2d)(float,float,float,float) r1.z, r2.xyxx, t6.yzxw, s0, l(0.000000)
