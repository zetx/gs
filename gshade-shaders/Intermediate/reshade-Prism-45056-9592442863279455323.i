...
RadialCoord.x *=  (1024 * (1.0 / 768));
#line 97
const float Mask = pow(2.0 * length(RadialCoord) * rsqrt( (1024 * (1.0 / 768)) *  (1024 * (1.0 / 768)) + 1.0), Curve);
#line 99
const float OffsetBase = Mask * Aberration * (1.0 / 768) * 2.0;
#line 102
if(abs(OffsetBase) < (1.0 / 768))
