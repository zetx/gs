...
const float2 cursor_position = trunc(( float2(1024, 768) / Ascii_block) * tex) * (Ascii_block /  float2(1024, 768));
#line 208
const float2 cp15 = cursor_position +  float2((1.0 / 1024), (1.0 / 768)) * 1.5;
const float2 cp35 = cursor_position +  float2((1.0 / 1024), (1.0 / 768)) * 3.5;
const float2 cp55 = cursor_position +  float2((1.0 / 1024), (1.0 / 768)) * 5.5;
#line 212
...
#line 249
const float2 p = trunc(frac(( float2(1024, 768) / Ascii_block) * tex) * Ascii_block); 
#line 251
