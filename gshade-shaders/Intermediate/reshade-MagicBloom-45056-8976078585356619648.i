...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 1798 / 2; Height = 997 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 1798 / 4; Height = 997 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 1798 / 8; Height = 997 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 1798 / 16; Height = 997 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 1798 / 32; Height = 997 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 1798 / 64; Height = 997 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 1798 / 128; Height = 997 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 1798 / 256; Height = 997 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 1798; Height = 997; };
#line 269
...
float2 ps =  float2((1.0 / 1798), (1.0 / 997)) * scale;
#line 303
