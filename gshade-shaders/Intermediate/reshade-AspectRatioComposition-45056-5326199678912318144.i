...
#line 64
if(aspectRatio <  (1500 * (1.0 / 1004)))
{
borderSize = (1500 - 1004 * aspectRatio) / 2.0;
fractionWidth = (1500 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (1500 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (1004 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (1004 - 1500 / aspectRatio) / 2.0;
fractionWidth = (1004 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (1004 - borderSize))
retVal = gridColor;
#line 86
if((vpos.x % (1500 / fraction)) < 1)
retVal = gridColor;
#line 89
...
#line 94
if(vpos.x <= 1 || vpos.x >= 1500-1 || vpos.y <= 1 || vpos.y >= 1004-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(1500, 1004, 0, 0) - vpos);
}
#line 125
