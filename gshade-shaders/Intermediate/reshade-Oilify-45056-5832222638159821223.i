...
texture Anisotropy {Width = 1024; Height = 768; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 1024), (1.0 / 768), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 1024), (1.0 / 768)) * Scale;
