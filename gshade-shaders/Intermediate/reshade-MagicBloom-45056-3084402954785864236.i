...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 792 / 2; Height = 710 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 792 / 4; Height = 710 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 792 / 8; Height = 710 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 792 / 16; Height = 710 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 792 / 32; Height = 710 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 792 / 64; Height = 710 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 792 / 128; Height = 710 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 792 / 256; Height = 710 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 792; Height = 710; };
#line 269
...
float2 ps =  float2((1.0 / 792), (1.0 / 710)) * scale;
#line 303
