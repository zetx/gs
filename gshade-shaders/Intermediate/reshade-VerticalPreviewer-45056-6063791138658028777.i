...
texture texDraw { Width = 1281; Height = 721; };
texture texVPreOut { Width = 1281; Height = 721; };
#line 129
...
float2 pixelsize =  float2((1.0 / 1281), (1.0 / 721)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(1281, 721) * cLayerVPre_Scale /  float2(1281, 721));
