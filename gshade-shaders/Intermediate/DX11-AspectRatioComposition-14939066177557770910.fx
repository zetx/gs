...
#line 64
if(aspectRatio <  (3440 * (1.0 / 1440)))
{
borderSize = (3440 - 1440 * aspectRatio) / 2.0;
fractionWidth = (3440 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (3440 - borderSize))
retVal = gridColor;
#line 72
...
#line 94
if(vpos.x <= 1 || vpos.x >= 3440-1 || vpos.y <= 1 || vpos.y >= 1440-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(3440, 1440, 0, 0) - vpos);
}
#line 125
