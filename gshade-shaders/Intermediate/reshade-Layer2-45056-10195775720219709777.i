...
#line 1 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Layer2.fx"
...
#line 40 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Layer2.fx"
...
#line 43 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Layer2.fx"
#line 62
...
> = 0;
#line 160
texture Layer2_Tex <source =  "LayerStage.png" ;> { Width = 5360; Height = 1440; Format=RGBA8; };
...
#line 1 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\ReShade.fxh"
#line 171 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Layer2.fx"
...
#line 172 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Layer2.fx"
#line 174
void PS_Layer2(in float4 pos : SV_Position, float2 texCoord : TEXCOORD, out float4 passColor : SV_Target) {
const float3 pivot = float3(0.5, 0.5, 0.0);
const float AspectX = (1.0 - 5360 * (1.0 / 1440));
const float AspectY = (1.0 - 1440 * (1.0 / 5360));
const float3 mulUV = float3(texCoord.x, texCoord.y, 1);
const float2 ScaleSize = (float2( 5360,  1440) * Layer2_Scale /  float2(5360, 1440));
