...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001163)
    mov x0[2].x, l(0.002713)
    mov x0[3].x, l(0.004264)
    mov x0[4].x, l(0.005814)
    mov x0[5].x, l(0.007365)
    mov x0[6].x, l(0.008916)
    mov x0[7].x, l(0.010466)
    mov x0[8].x, l(0.012017)
    mov x0[9].x, l(0.013568)
    mov x0[10].x, l(0.015119)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001167)
      mov x3[2].x, l(0.002724)
      mov x3[3].x, l(0.004280)
      mov x3[4].x, l(0.005837)
      mov x3[5].x, l(0.007393)
      mov x3[6].x, l(0.008950)
      mov x3[7].x, l(0.010506)
      mov x3[8].x, l(0.012063)
      mov x3[9].x, l(0.013619)
      mov x3[10].x, l(0.015176)
      mov x3[11].x, l(0.016732)
      mov x3[12].x, l(0.018289)
      mov x3[13].x, l(0.019845)
      mov x3[14].x, l(0.021402)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001167)
        mov x6[2].x, l(0.002724)
        mov x6[3].x, l(0.004280)
        mov x6[4].x, l(0.005837)
        mov x6[5].x, l(0.007393)
        mov x6[6].x, l(0.008950)
        mov x6[7].x, l(0.010506)
        mov x6[8].x, l(0.012063)
        mov x6[9].x, l(0.013619)
        mov x6[10].x, l(0.015196)
        mov x6[11].x, l(0.016755)
        mov x6[12].x, l(0.018313)
        mov x6[13].x, l(0.019872)
        mov x6[14].x, l(0.021430)
        mov x6[15].x, l(0.022989)
        mov x6[16].x, l(0.024548)
        mov x6[17].x, l(0.026106)
      ...
      if_nz r0.y
        ...
        loop 
          ...
          mov x9[2].x, l(0.002657)
          mov x9[3].x, l(0.004178)
          mov x9[4].x, l(0.005701)
          mov x9[5].x, l(0.007227)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.000923)
            mov x12[2].x, l(0.002365)
            mov x12[3].x, l(0.003906)
