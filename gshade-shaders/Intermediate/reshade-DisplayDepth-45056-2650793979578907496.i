...
texcoord.x -= iUIOffset.x * (1.0 / 1281); 
texcoord.y += iUIOffset.y * (1.0 / 721); 
#line 178
...
{
float3 offset = float3( float2((1.0 / 1281), (1.0 / 721)), 0.0);
...
#line 217
float grid_position = frac(dot(texcoord, ( float2(1281, 721) * float2(1.0 / 16.0, 10.0 / 36.0)) + 0.25));
#line 219
...
color = normal;
if (iUIPresentType == 2)
color = lerp(normal, depth, step(1281 * 0.5, position.x));
#line 233
if (bUIShowOffset)
{
