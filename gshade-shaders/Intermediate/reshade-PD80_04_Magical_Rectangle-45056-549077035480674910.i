...
> = 1.0;
#line 217
texture texMagicRectangle { Width = 5360; Height = 1440; Format = RGBA16F; };
#line 220
...
uv.y         = ( id == 1 ) ? 2.0 : 0.0;
uv.xy        -= center.xy;
uv.y         /=  float( 5360 * (1.0 / 1440) );
float dim    = ceil( sqrt( 5360 * 5360 + 1440 * 1440 )); 
float maxlen = min( 5360, 1440 );
dim          = dim / maxlen; 
uv.xy        /= dim;
