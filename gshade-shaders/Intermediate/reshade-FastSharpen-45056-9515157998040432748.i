...
> = 0.50;
#line 48
static const float2 g10 = float2( 0.3333,-1.0)* float2((1.0 / 1281), (1.0 / 721));
static const float2 g01 = float2(-1.0,-0.3333)* float2((1.0 / 1281), (1.0 / 721));
static const float2 g12 = float2(-0.3333, 1.0)* float2((1.0 / 1281), (1.0 / 721));
static const float2 g21 = float2( 1.0, 0.3333)* float2((1.0 / 1281), (1.0 / 721));
#line 53
