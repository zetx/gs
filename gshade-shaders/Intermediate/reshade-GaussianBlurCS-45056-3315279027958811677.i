...
texture PlaceHolder {Width = 3440; Height = 1440; Format = RGB10A2;};
texture Convolution {Width = 3440; Height = 1440; Format = RGB10A2;};
#line 57
...
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(3440, 1440));
...
int2 sampleCoord = sampleOffset + groupCoord;
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1440, 3440));
...
DispatchSizeX =  (int(3440 +  32 *  4 - 1) / int( 32 *  4));
...
DispatchSizeY =  (int(3440 +  2 - 1) / int( 2));
}
pass
{
