...
texture Luma <Pooled = true;> {Width = 3440; Height = 1440; Format = R16f;};
texture Sobel <Pooled = true;> {Width = 3440; Height = 1440; Format = R8;};
#line 16
...
{
float2 offset = (float2(i, j) * normals.xy) * 1 / float2(3440, 1440);
