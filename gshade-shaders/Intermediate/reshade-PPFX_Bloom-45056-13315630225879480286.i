...
texture texColorHDRA { Width = 1281; Height = 721; Format = RGBA16F; };
texture texColorHDRB < pooled = true; > { Width = 1281; Height = 721; Format = RGBA16F; };
#line 185
texture texBloomA
{
Width = 1281/		4		;
...
#line 262
static const float2 pxSize = float2((1.0 / 1281),(1.0 / 721));
