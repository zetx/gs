...
texture texDraw { Width = 1798; Height = 997; };
texture texVPreOut { Width = 1798; Height = 997; };
#line 129
...
float2 pixelsize =  float2((1.0 / 1798), (1.0 / 997)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(1798, 997) * cLayerVPre_Scale /  float2(1798, 997));
