...
texture Anisotropy {Width = 1280; Height = 720; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 1280), (1.0 / 720), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 1280), (1.0 / 720)) * Scale;
