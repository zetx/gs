...
#line 200
texture texDownsampledBackBuffer { Width = 1309; Height = 762; Format = RGBA16F; };
texture texBlurDestination { Width = 1309; Height = 762; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 1309), (1.0 / 762));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 1309), (1.0 / 762)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 1309), (1.0 / 762)));
pixelInfo.blurLengthInPixels = length( float2(1309, 762)) * BlurLength;
