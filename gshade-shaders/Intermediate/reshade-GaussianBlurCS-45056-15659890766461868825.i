...
texture PlaceHolder {Width = 1500; Height = 1004; Format = RGB10A2;};
texture Convolution {Width = 1500; Height = 1004; Format = RGB10A2;};
#line 57
...
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1500, 1004));
...
int2 sampleCoord = sampleOffset + groupCoord;
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1004, 1500));
...
DispatchSizeX =  (int(1500 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(1004 +  2 - 1) / int( 2));
}
pass
{
ComputeShader = VerticalPassCS< 32,  2>;
DispatchSizeX =  (int(1004 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(1500 +  2 - 1) / int( 2));
}
pass
{
