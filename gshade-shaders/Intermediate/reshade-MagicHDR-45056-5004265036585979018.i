...
#line 380
 texture TempTex <pooled = true;> { Width = 1280 / DownsampleAmount.x / 1; Height = 720 / DownsampleAmount.y / 1; Format = RGBA16F; MipLevels = 1; }; sampler Temp { Texture = TempTex; };
#line 383
 texture Bloom0Tex <pooled = true;> { Width = 1280 / DownsampleAmount.x / 1; Height = 720 / DownsampleAmount.y / 1; Format = RGBA16F; MipLevels = 1; }; sampler Bloom0 { Texture = Bloom0Tex; };
 texture Bloom1Tex <pooled = true;> { Width = 1280 / DownsampleAmount.x / 2; Height = 720 / DownsampleAmount.y / 2; Format = RGBA16F; MipLevels = 1; }; sampler Bloom1 { Texture = Bloom1Tex; };
 texture Bloom2Tex <pooled = true;> { Width = 1280 / DownsampleAmount.x / 4; Height = 720 / DownsampleAmount.y / 4; Format = RGBA16F; MipLevels = 1; }; sampler Bloom2 { Texture = Bloom2Tex; };
 texture Bloom3Tex <pooled = true;> { Width = 1280 / DownsampleAmount.x / 8; Height = 720 / DownsampleAmount.y / 8; Format = RGBA16F; MipLevels = 1; }; sampler Bloom3 { Texture = Bloom3Tex; };
 texture Bloom4Tex <pooled = true;> { Width = 1280 / DownsampleAmount.x / 16; Height = 720 / DownsampleAmount.y / 16; Format = RGBA16F; MipLevels = 1; }; sampler Bloom4 { Texture = Bloom4Tex; };
 texture Bloom5Tex <pooled = true;> { Width = 1280 / DownsampleAmount.x / 32; Height = 720 / DownsampleAmount.y / 32; Format = RGBA16F; MipLevels = 1; }; sampler Bloom5 { Texture = Bloom5Tex; };
#line 416
 texture Bloom6Tex <pooled = true;> { Width = 1280 / DownsampleAmount.x / 64; Height = 720 / DownsampleAmount.y / 64; Format = RGBA16F; MipLevels = 1; }; sampler Bloom6 { Texture = Bloom6Tex; };
#line 448
