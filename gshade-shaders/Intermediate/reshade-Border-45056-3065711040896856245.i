...
if ( (1280 * (1.0 / 720)) < border_ratio)
border_width_variable = float2(0.0, (720 - (1280 / border_ratio)) * 0.5);
else
border_width_variable = float2((1280 - (720 * border_ratio)) * 0.5, 0.0);
#line 56
const float2 border = ( float2((1.0 / 1280), (1.0 / 720)) * border_width_variable); 
#line 58
