...
#line 353
if ( (1280 * (1.0 / 720)) > 1.0) 
borderCoord.x = borderCoord.x* (1280 * (1.0 / 720))+(1.0- (1280 * (1.0 / 720)));
else if ( (1280 * (1.0 / 720)) < 1.0) 
borderCoord.y = borderCoord.y* (720*(1.0 / 1280))+(1.0- (720*(1.0 / 1280)));
#line 358
...
#line 410
case 1: FovType = sqrt( (720*(1.0 / 1280))* (720*(1.0 / 1280))+1.0); break;
#line 412
case 2: FovType =  (720*(1.0 / 1280)); break;
#line 414
case 3: FovType = (4.0/3.0) * (720*(1.0 / 1280)); break;
#line 416
case 4: FovType = (16.0/9.0) * (720*(1.0 / 1280)); break;
}
#line 420
float2 sphCoord = texCoord*2.0 -1.0;
#line 422
sphCoord.x -= Offset.y; 
sphCoord.y  = Offset.x+sphCoord.y* (720*(1.0 / 1280));
#line 425
