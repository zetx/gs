...
texture PlaceHolder {Width = 1309; Height = 762; Format = RGB10A2;};
texture Convolution {Width = 1309; Height = 762; Format = RGB10A2;};
#line 57
...
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1309, 762));
...
int2 sampleCoord = sampleOffset + groupCoord;
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(762, 1309));
...
DispatchSizeX =  (int(1309 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(762 +  2 - 1) / int( 2));
}
pass
{
ComputeShader = VerticalPassCS< 32,  2>;
DispatchSizeX =  (int(762 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(1309 +  2 - 1) / int( 2));
}
pass
{
