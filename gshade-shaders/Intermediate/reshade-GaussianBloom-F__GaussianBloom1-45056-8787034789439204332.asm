...
if_nz r1.x
  ...
  loop 
    ...
    sample_l_indexable(texture2d)(float,float,float,float) r4.xyz, r4.xyxx, t4.xyzw, s1, l(0.000000)
    mov x3[1].x, l(0.232276)
    mov x3[2].x, l(0.135326)
    mov x3[3].x, l(0.051156)
    mov x3[4].x, l(0.012539)
    mov x3[5].x, l(0.001991)
    mov r1.w, x3[r0.w + 0].x
    ...
    mul r3.w, r1.w, l(0.000694)
    add r3.yw, -r3.zzzw, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r3.ywyy, t4.xyzw, s1, l(0.000000)
...
if_nz r1.y
  ...
  loop 
    ...
    mov r3.y, x6[r0.w + 0].x
    mul r2.y, r3.y, l(0.000694)
    ...
    mov r2.y, x7[r0.w + 0].x
    mad r3.yzw, r3.yyzw, r2.yyyy, r0.xxyz
    ...
    mov r2.y, x8[r0.w + 0].x
    mul r2.w, r2.y, l(0.000694)
    ...
    mov r2.y, x9[r0.w + 0].x
    mad r0.xyz, r4.xyzx, r2.yyyy, r3.yzwy
    iadd r0.w, r0.w, l(1)
    ilt r3.x, r0.w, l(11)
  endloop 
endif 
if_nz r1.z
  ...
  loop 
    ...
    mov r3.x, x10[r0.w + 0].x
    mul r2.y, r3.x, l(0.000694)
    ...
    mov r2.y, x11[r0.w + 0].x
    mad r3.xyz, r3.xyzx, r2.yyyy, r0.xyzx
    ...
    mov r2.y, x13[r0.w + 0].x
    mad r0.xyz, r4.xyzx, r2.yyyy, r3.xyzx
    iadd r0.w, r0.w, l(1)
    ilt r1.w, r0.w, l(15)
  endloop 
endif 
...
if_nz r0.w
  ...
  loop 
    ...
    mov r3.w, x14[r0.w + 0].x
    mul r2.y, r3.w, l(0.000694)
    ...
    mov r2.y, x15[r0.w + 0].x
    mad r4.xyz, r4.xyzx, r2.yyyy, r3.xyzx
    ...
    mul r2.w, r2.y, l(0.000694)
    add r2.yw, -r2.zzzw, v1.xxxy
    sample_l_indexable(texture2d)(float,float,float,float) r5.xyz, r2.ywyy, t4.xyzw, s1, l(0.000000)
    ...
    mad r3.xyz, r5.xyzx, r2.yyyy, r4.xyzx
    iadd r0.w, r0.w, l(1)
    ilt r1.w, r0.w, l(18)
  endloop 
  mov o0.xyz, r3.xyzx
