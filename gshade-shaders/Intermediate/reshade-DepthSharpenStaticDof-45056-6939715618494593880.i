...
return ori;
#line 120
const float depthTL = ReShade::GetLinearizedDepth( tex + float2(- float2((1.0 / 792), (1.0 / 710)).x, - float2((1.0 / 792), (1.0 / 710)).y) ).r;
const float depthTR = ReShade::GetLinearizedDepth( tex + float2( float2((1.0 / 792), (1.0 / 710)).x, - float2((1.0 / 792), (1.0 / 710)).y) ).r;
