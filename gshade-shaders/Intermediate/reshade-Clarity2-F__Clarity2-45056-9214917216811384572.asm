...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.002066)
    mov x0[2].x, l(0.004821)
    mov x0[3].x, l(0.007575)
    mov x0[4].x, l(0.010330)
    mov x0[5].x, l(0.013085)
    mov x0[6].x, l(0.015840)
    mov x0[7].x, l(0.018595)
    mov x0[8].x, l(0.021351)
    mov x0[9].x, l(0.024107)
    mov x0[10].x, l(0.026862)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.002074)
      mov x3[2].x, l(0.004839)
      mov x3[3].x, l(0.007605)
      mov x3[4].x, l(0.010370)
      mov x3[5].x, l(0.013136)
      mov x3[6].x, l(0.015901)
      mov x3[7].x, l(0.018666)
      mov x3[8].x, l(0.021432)
      mov x3[9].x, l(0.024197)
      mov x3[10].x, l(0.026963)
      mov x3[11].x, l(0.029728)
      mov x3[12].x, l(0.032494)
      mov x3[13].x, l(0.035259)
      mov x3[14].x, l(0.038025)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.002074)
        mov x6[2].x, l(0.004839)
        mov x6[3].x, l(0.007605)
        mov x6[4].x, l(0.010370)
        mov x6[5].x, l(0.013136)
        mov x6[6].x, l(0.015901)
        mov x6[7].x, l(0.018666)
        mov x6[8].x, l(0.021432)
        mov x6[9].x, l(0.024197)
        mov x6[10].x, l(0.026999)
        mov x6[11].x, l(0.029768)
        mov x6[12].x, l(0.032537)
        mov x6[13].x, l(0.035306)
        mov x6[14].x, l(0.038075)
        mov x6[15].x, l(0.040845)
        mov x6[16].x, l(0.043614)
        mov x6[17].x, l(0.046383)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.002023)
          mov x9[2].x, l(0.004721)
          mov x9[3].x, l(0.007423)
          mov x9[4].x, l(0.010129)
          mov x9[5].x, l(0.012841)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001640)
            mov x12[2].x, l(0.004202)
            mov x12[3].x, l(0.006940)
