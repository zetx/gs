...
texture Anisotropy {Width = 1798; Height = 997; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 1798), (1.0 / 997), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 1798), (1.0 / 997)) * Scale;
