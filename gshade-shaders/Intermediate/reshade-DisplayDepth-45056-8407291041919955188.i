...
texcoord.x -= iUIOffset.x * (1.0 / 5360); 
...
#line 217
float grid_position = frac(dot(texcoord, ( float2(5360, 1440) * float2(1.0 / 16.0, 10.0 / 36.0)) + 0.25));
#line 219
...
color = normal;
if (iUIPresentType == 2)
color = lerp(normal, depth, step(5360 * 0.5, position.x));
#line 233
if (bUIShowOffset)
{
