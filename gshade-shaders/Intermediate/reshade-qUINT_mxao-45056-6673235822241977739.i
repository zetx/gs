...
#line 178
texture2D qMXAO_ColorTex 	{ Width = 1799;   Height = 998;   Format = RGBA8; MipLevels = 3+		2	;};
texture2D qMXAO_DepthTex 	{ Width = 1799;   Height = 998;   Format = R16F;  MipLevels = 3+		0	;};
texture2D qMXAO_NormalTex	{ Width = 1799;   Height = 998;   Format = RGBA8; MipLevels = 3+		2	;};
#line 182
...
#line 186
texture2D CommonTex0 	{ Width = 1799;   Height = 998;   Format = RGBA8; };
sampler2D sCommonTex0	{ Texture = CommonTex0;	};
#line 189
texture2D CommonTex1 	{ Width = 1799;   Height = 998;   Format = RGBA8; };
...
|| 0.25 * 0.5 * qMXAO_SAMPLE_RADIUS / (tex2D(sMXAO_DepthTex, MXAO.uv.zw).x + 2.0) * 998 < 1.0
|| MXAO.uv.z > 1.0
|| MXAO.uv.w > 1.0
) discard;
#line 385
