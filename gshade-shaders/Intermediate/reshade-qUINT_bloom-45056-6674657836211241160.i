...
#line 135
static const int BloomTex7_LowestMip =    (((721/128 >> 1) != 0) + ((721/128 >> 2) != 0) + ((721/128 >> 3) != 0) + ((721/128 >> 4) != 0) + ((721/128 >> 5) != 0) + ((721/128 >> 6) != 0) + ((721/128 >> 7) != 0) + ((721/128 >> 8) != 0) + ((721/128 >> 9) != 0) + ((721/128 >> 10) != 0) + ((721/128 >> 11) != 0) + ((721/128 >> 12) != 0) + ((721/128 >> 13) != 0) + ((721/128 >> 14) != 0) + ((721/128 >> 15) != 0) + ((721/128 >> 16) != 0));
#line 137
texture2D MXBLOOM_BloomTexSource 	{ Width = 1281/2; 	Height = 721/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 1281/2; 	Height = 721/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 1281/4;  	Height = 721/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 1281/8;  	Height = 721/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 1281/16;  Height = 721/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 1281/32;  Height = 721/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 1281/64;  Height = 721/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 1281/128; Height = 721/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
