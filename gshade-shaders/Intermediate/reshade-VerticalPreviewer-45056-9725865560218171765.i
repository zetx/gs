...
texture texDraw { Width = 1309; Height = 762; };
texture texVPreOut { Width = 1309; Height = 762; };
#line 129
...
float2 pixelsize =  float2((1.0 / 1309), (1.0 / 762)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(1309, 762) * cLayerVPre_Scale /  float2(1309, 762));
