...
{
x = MapTwo(texcoord.x, float2(overlayPos.x, overlayPos.x + size.x) / 1281, float2(0.0, 1.0));
y = MapTwo(texcoord.y, float2(overlayPos.y, overlayPos.y + size.y) / 721, float2(0.0, 1.0));
