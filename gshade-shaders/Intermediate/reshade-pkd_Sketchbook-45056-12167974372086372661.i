...
> = 0;
#line 84
texture tSketchMask_Backup { Width = 1281; Height = 721; };
#line 86
texture tSketchMask_Mask <source="SketchMask.png";> { Width = 1281; Height = 721; Format= R8; };
texture tSketchMask_Mask2 <source="SketchMask2.png";> { Width = 1281; Height = 721; Format= R8; };
#line 89
...
> = 0.5;
#line 180
texture Layer_PencilHatch_texture <source="SketchPencil.png";> { Width = 1281; Height = 721; Format=RGBA8; };
...
const float2 scale = 1.0 / (float2(1281, 721) /  float2(1281, 721) * Layer_PencilHatch_Scale);
...
> = 0.5;
#line 230
texture Layer_PaperBase_texture <source="SketchPaperBase.png";> { Width = 1281; Height = 721; Format=RGBA8; };
...
const float2 scale = 1.0 / (float2(1281, 721) /  float2(1281, 721) * Layer_PaperBase_Scale);
...
> = 0.5;
#line 280
texture Layer_PaperOverlay_texture <source="SketchPaperOverlay.png";> { Width = 1281; Height = 721; Format=RGBA8; };
...
const float2 scale = 1.0 / (float2(1281, 721) /  float2(1281, 721) * Layer_PaperOverlay_Scale);
