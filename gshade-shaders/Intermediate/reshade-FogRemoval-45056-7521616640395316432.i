...
> = 0;
#line 324
texture ColorCorrected {Width = 1799; Height = 995; Format = RGBA16F;};
sampler sColorCorrected {Texture = ColorCorrected;};
texture fTransmission {Width = 1799; Height = 995; Format = R8;};
...
texture FogRemoved {Width = 1799; Height = 995; Format = RGBA16F;};
sampler sFogRemoved {Texture = FogRemoved;};
texture TruncatedPrecision {Width = 1799; Height = 995; Format = RGBA16F;};
...
{
const int fifty = abs(0.5 *  ( (995 /  15) *  (1799 /  15)));
const int usedMax = abs( 0.95 *  ( (995 /  15) *  (1799 /  15)));
int4 sum =  ( (995 /  15) *  (1799 /  15));
output = 255.0;
int i = 255;
while((sum.r <=  ( (995 /  15) *  (1799 /  15)) || sum.g <=  ( (995 /  15) *  (1799 /  15)) || sum.b <=  ( (995 /  15) *  (1799 /  15)) || sum.a <=  ( (995 /  15) *  (1799 /  15))) && i >= 0)
{
#line 387
...
if (sum.r < usedMax)
{
sum.r = 2 *  ( (995 /  15) *  (1799 /  15));
output.r = i;
}
if (sum.g < usedMax)
{
sum.g = 2 *  ( (995 /  15) *  (1799 /  15));
output.g = i;
}
if (sum.b < usedMax)
{
sum.b = 2 *  ( (995 /  15) *  (1799 /  15));
output.b = i;
}
#line 408
