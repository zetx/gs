...
if_z cb0[0].z
  mad r2.xyzw, cb0[0].wwww, l(0.000255, 0.000437, -0.000255, -0.000437), v1.xyxy
...
if_nz r1.x
  mad r4.xyzw, cb0[0].wwww, l(0.000382, -0.000656, 0.000382, 0.000656), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000382, 0.000656, 0.000382, -0.000656), v1.xyxy
...
if_nz r1.y
  mad r4.xyzw, cb0[0].wwww, l(0.000306, -0.001575, 0.000917, 0.000525), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r1.xyw, r4.xyxx, t0.xywz, s0
  mad r5.xyzw, -cb0[0].wwww, l(0.000917, 0.000525, 0.000306, -0.001575), v1.xyxy
...
if_nz r1.z
  mov r1.xw, l(0.000382,0,0,-0.000656)
  mul r1.yz, cb0[0].wwww, l(0.000000, -0.001312, -0.000764, 0.000000)
  ...
  mul r4.xw, cb0[0].wwww, l(0.000764, 0.000000, 0.000000, 0.001312)
  mov r4.yz, l(0,0.000656,-0.000382,0)
