...
#line 151
texture texGravitySeedMap{ Width =  3440/ 1; Height =  768; Format = R16F; };
texture texGravitySeedMapCopy{ Width =  3440/ 1; Height =  768; Format = R16F; };
...
texture texGravityMain{ Width =  3440/ 1; Height =  768; Format = RGBA8; };
texture texGravityDepth{ Width =  3440/ 1; Height =  768; Format = R32F; };
#line 162
...
#line 286
finalist[y] = y;
depthlist[y] = depthlistU[y] = ReShade::GetLinearizedDepth(float2((id.x* 1 + 0.5) / 3440, (y *  1440/ 768 + 0.5) / 1440));
}
...
strength = strength * GravityIntensity * inFocus(rgbval, scenedepth, float2((id.x* 1 + 0.5) / 3440, (yi *  1440/ 768 + 0.5) / 1440)); 
...
pass GravityMain { ComputeShader = gravityMain<1, 1>; DispatchSizeX =  3440/ 1; DispatchSizeY = 1; }
