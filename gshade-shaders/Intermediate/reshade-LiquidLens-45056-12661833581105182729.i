...
{
if (1500 > 1004)
return float2(1.0, 1004 * (1.0 / 1500));
else
return float2(1500 * (1.0 / 1004), 1.0);
}
#line 26
...
texture LensATex
{
Width = 1500 / Downscale;
Height = 1004 / Downscale;
Format = RGBA16F;
};
#line 175
sampler LensA
...
{
return Blur(LensA, uv, float2((1.0 / 1500), 0));
}
#line 221
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return Blur(LensB, uv, float2(0, (1.0 / 1004)));
}
#line 226
