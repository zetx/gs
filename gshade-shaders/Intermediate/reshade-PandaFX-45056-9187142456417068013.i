...
texture prePassLayer { Width = 1798; Height = 997; Format = RGBA8; };
texture blurLayerHorizontal { Width = 1798 / 2; Height = 997 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 1798 / 2; Height = 997 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 1798 / 16; Height = 997 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 1798 / 16; Height = 997 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 1798 / 64; Height = 997 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 1798 / 64; Height = 997 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 1798 * sampling;
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 997 * sampling;
float divisor = 0.000001;
#line 410
