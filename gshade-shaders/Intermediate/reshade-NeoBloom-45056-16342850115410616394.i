...
{
return GaussianBlur1D(AtlasA, uv, PixelScale * float2((1.0 / 1309), 0.0) *  2, uSigma, BlurSamples);
}
#line 949
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return GaussianBlur1D(AtlasB, uv, PixelScale * float2(0.0, (1.0 / 762)) *  2, uSigma, BlurSamples);
}
#line 956
...
#line 1055
float ar = 1309 * (1.0 / 762);
float ar_inv = 762 * (1.0 / 1309);
