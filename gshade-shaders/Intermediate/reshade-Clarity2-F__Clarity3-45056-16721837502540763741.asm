...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.000278)
    mov x0[2].x, l(0.000648)
    mov x0[3].x, l(0.001019)
    mov x0[4].x, l(0.001390)
    mov x0[5].x, l(0.001760)
    mov x0[6].x, l(0.002131)
    mov x0[7].x, l(0.002501)
    mov x0[8].x, l(0.002872)
    mov x0[9].x, l(0.003243)
    mov x0[10].x, l(0.003613)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.000279)
      mov x3[2].x, l(0.000651)
      mov x3[3].x, l(0.001023)
      mov x3[4].x, l(0.001395)
      mov x3[5].x, l(0.001767)
      mov x3[6].x, l(0.002139)
      mov x3[7].x, l(0.002511)
      mov x3[8].x, l(0.002883)
      mov x3[9].x, l(0.003255)
      mov x3[10].x, l(0.003627)
      mov x3[11].x, l(0.003999)
      mov x3[12].x, l(0.004371)
      mov x3[13].x, l(0.004743)
      mov x3[14].x, l(0.005115)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.000279)
        mov x6[2].x, l(0.000651)
        mov x6[3].x, l(0.001023)
        mov x6[4].x, l(0.001395)
        mov x6[5].x, l(0.001767)
        mov x6[6].x, l(0.002139)
        mov x6[7].x, l(0.002511)
        mov x6[8].x, l(0.002883)
        mov x6[9].x, l(0.003255)
        mov x6[10].x, l(0.003632)
        mov x6[11].x, l(0.004004)
        mov x6[12].x, l(0.004377)
        mov x6[13].x, l(0.004749)
        mov x6[14].x, l(0.005122)
        mov x6[15].x, l(0.005494)
        mov x6[16].x, l(0.005867)
        mov x6[17].x, l(0.006239)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.000272)
          mov x9[2].x, l(0.000635)
          mov x9[3].x, l(0.000998)
          mov x9[4].x, l(0.001362)
          mov x9[5].x, l(0.001727)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.000221)
            mov x12[2].x, l(0.000565)
            mov x12[3].x, l(0.000934)
