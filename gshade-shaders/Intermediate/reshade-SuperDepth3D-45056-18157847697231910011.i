...
#line 780
texture texDMN { Width = 1024 ; Height = 768; Format = RGBA16F; };
#line 782
sampler SamplerDMN
{
Texture = texDMN;
...
#line 787
texture texzBufferN_P { Width = 1024 ; Height = 768 ; Format = RG16F; };
#line 789
...
#line 797
texture texzBufferN_L { Width = 1024 ; Height = 768 ; Format = R16F; MipLevels = 2; };
#line 799
...
#line 813
texture texLumN {Width = 1024 *  160 / 1024; Height = 768 *  160 / 1024; Format = RGBA16F; MipLevels = 8;};
#line 815
sampler SamplerLumN
{
Texture = texLumN;
...
{   float MS = Diverge *  float2((1.0 / 1024), (1.0 / 768)).x, GetDepth = smoothstep(0,1,tex2Dlod(SamplerzBufferN_P, float4(Coordinates,0, 0) ).y),
Details = 0.5,
...
ParallaxCoord.y += IO *  float2((1.0 / 1024), (1.0 / 768)).y; 
else if(Stereoscopic_Mode == 3)
ParallaxCoord.x += IO *  float2((1.0 / 1024), (1.0 / 768)).x; 
#line 1498
...
#line 1591
TCL +=  float2( (Perspective *  float2((1.0 / 1024), (1.0 / 768)).x) * 0.5, 0) ;
TCR -=  float2( (Perspective *  float2((1.0 / 1024), (1.0 / 768)).x) * 0.5, 0) ;
#line 1594
...
#line 1650
TC += float2( ( FP_IO_Pos().x * 1.225 + lerp(0,4,IAC) ) *  float2((1.0 / 1024), (1.0 / 768)).x, 0.0);
#line 1652
TC = Stereoscopic_Mode == 5 ? LensePitch(TC) * LPI : TC;
#line 1654
float2 gridxy, GXYArray[9] = {
float2(TC.x * 1024, TC.y * 768), 
