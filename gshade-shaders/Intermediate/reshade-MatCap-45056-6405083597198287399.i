...
static const float2 offset = float2((1.0 / 1281), 0.0); 
return (get_depth(uv + offset) - get_depth(uv - offset)) * 1281 * 0.5;
}
#line 37
float get_depth_ddy(float2 uv) {
static const float2 offset = float2(0.0, (1.0 / 721)); 
return (get_depth(uv - offset) - get_depth(uv + offset)) * 721 * 0.5;
}
#line 42
