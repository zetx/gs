...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.002098)
    mov x0[2].x, l(0.004895)
    mov x0[3].x, l(0.007693)
    mov x0[4].x, l(0.010490)
    mov x0[5].x, l(0.013288)
    mov x0[6].x, l(0.016086)
    mov x0[7].x, l(0.018884)
    mov x0[8].x, l(0.021682)
    mov x0[9].x, l(0.024480)
    mov x0[10].x, l(0.027279)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.002106)
      mov x3[2].x, l(0.004914)
      mov x3[3].x, l(0.007723)
      mov x3[4].x, l(0.010531)
      mov x3[5].x, l(0.013339)
      mov x3[6].x, l(0.016147)
      mov x3[7].x, l(0.018956)
      mov x3[8].x, l(0.021764)
      mov x3[9].x, l(0.024572)
      mov x3[10].x, l(0.027380)
      mov x3[11].x, l(0.030189)
      mov x3[12].x, l(0.032997)
      mov x3[13].x, l(0.035806)
      mov x3[14].x, l(0.038614)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.002106)
        mov x6[2].x, l(0.004914)
        mov x6[3].x, l(0.007723)
        mov x6[4].x, l(0.010531)
        mov x6[5].x, l(0.013339)
        mov x6[6].x, l(0.016147)
        mov x6[7].x, l(0.018956)
        mov x6[8].x, l(0.021764)
        mov x6[9].x, l(0.024572)
        mov x6[10].x, l(0.027417)
        mov x6[11].x, l(0.030229)
        mov x6[12].x, l(0.033041)
        mov x6[13].x, l(0.035853)
        mov x6[14].x, l(0.038665)
        mov x6[15].x, l(0.041477)
        mov x6[16].x, l(0.044289)
        mov x6[17].x, l(0.047102)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.002054)
          mov x9[2].x, l(0.004794)
          mov x9[3].x, l(0.007538)
          mov x9[4].x, l(0.010286)
          mov x9[5].x, l(0.013040)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001665)
            mov x12[2].x, l(0.004267)
            mov x12[3].x, l(0.007048)
