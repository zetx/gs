...
> = 0;
#line 160
texture Layer3_Tex <source =  "LayerStage.png" ;> { Width = 1309; Height = 762; Format=RGBA8; };
...
const float AspectX = (1.0 - 1309 * (1.0 / 762));
const float AspectY = (1.0 - 762 * (1.0 / 1309));
const float3 mulUV = float3(texCoord.x, texCoord.y, 1);
const float2 ScaleSize = (float2( 1309,  762) * Layer3_Scale /  float2(1309, 762));
