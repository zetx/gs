...
> = 0;
#line 160
texture Layer2_Tex <source =  "LayerStage.png" ;> { Width = 1798; Height = 997; Format=RGBA8; };
...
const float AspectX = (1.0 - 1798 * (1.0 / 997));
const float AspectY = (1.0 - 997 * (1.0 / 1798));
const float3 mulUV = float3(texCoord.x, texCoord.y, 1);
const float2 ScaleSize = (float2( 1798,  997) * Layer2_Scale /  float2(1798, 997));
