...
#line 47
texture2D Ganossa_MF_NormTex { Width =  1799/2; Height =  998/2; Format = RGBA8; };
texture2D Ganossa_MF_PrevTex { Width =  1799/2; Height =  998/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullTex { Width =  1799/2; Height =  998/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadFullPrevTex { Width =  1799/2; Height =  998/2; Format = RGBA8; };
texture2D Ganossa_MF_QuadTex { Width =  1799/2; Height =  998/2; Format = RGBA16F; };
#line 53
...
#line 97
if (!(texcoord.x <= (1.0 / 1799)*2 && texcoord.y <= (1.0 / 998)*2))
discard;
#line 100
...
{
float4 Ganossa_MF_Quad = saturate(tex2D(Ganossa_MF_QuadColor, float2((1.0 / 1799), (1.0 / 998)))-0.1f);
#line 130
if (mfDebug)
{
#line 133
