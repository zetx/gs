...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001497)
    mov x0[2].x, l(0.003493)
    mov x0[3].x, l(0.005489)
    mov x0[4].x, l(0.007486)
    mov x0[5].x, l(0.009482)
    mov x0[6].x, l(0.011478)
    mov x0[7].x, l(0.013475)
    mov x0[8].x, l(0.015471)
    mov x0[9].x, l(0.017468)
    mov x0[10].x, l(0.019465)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001503)
      mov x3[2].x, l(0.003507)
      mov x3[3].x, l(0.005511)
      mov x3[4].x, l(0.007514)
      mov x3[5].x, l(0.009518)
      mov x3[6].x, l(0.011522)
      mov x3[7].x, l(0.013526)
      mov x3[8].x, l(0.015530)
      mov x3[9].x, l(0.017534)
      mov x3[10].x, l(0.019538)
      mov x3[11].x, l(0.021542)
      mov x3[12].x, l(0.023546)
      mov x3[13].x, l(0.025550)
      mov x3[14].x, l(0.027554)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001503)
        mov x6[2].x, l(0.003507)
        mov x6[3].x, l(0.005511)
        mov x6[4].x, l(0.007514)
        mov x6[5].x, l(0.009518)
        mov x6[6].x, l(0.011522)
        mov x6[7].x, l(0.013526)
        mov x6[8].x, l(0.015530)
        mov x6[9].x, l(0.017534)
        mov x6[10].x, l(0.019564)
        mov x6[11].x, l(0.021571)
        mov x6[12].x, l(0.023577)
        mov x6[13].x, l(0.025584)
        mov x6[14].x, l(0.027590)
        mov x6[15].x, l(0.029597)
        mov x6[16].x, l(0.031604)
        mov x6[17].x, l(0.033610)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001466)
          mov x9[2].x, l(0.003421)
          mov x9[3].x, l(0.005379)
          mov x9[4].x, l(0.007340)
          mov x9[5].x, l(0.009305)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001188)
            mov x12[2].x, l(0.003045)
            mov x12[3].x, l(0.005029)
