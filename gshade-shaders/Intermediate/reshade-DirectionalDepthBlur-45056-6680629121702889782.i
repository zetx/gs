...
#line 200
texture texDownsampledBackBuffer { Width = 1799; Height = 998; Format = RGBA16F; };
texture texBlurDestination { Width = 1799; Height = 998; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 1799), (1.0 / 998));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 1799), (1.0 / 998)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 1799), (1.0 / 998)));
pixelInfo.blurLengthInPixels = length( float2(1799, 998)) * BlurLength;
