...
texture PlaceHolder {Width = 5360; Height = 1440; Format = RGB10A2;};
texture Convolution {Width = 5360; Height = 1440; Format = RGB10A2;};
#line 57
...
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(5360, 1440));
...
int2 sampleCoord = sampleOffset + groupCoord;
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1440, 5360));
...
DispatchSizeX =  (int(5360 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(1440 +  2 - 1) / int( 2));
}
pass
{
ComputeShader = VerticalPassCS< 32,  2>;
DispatchSizeX =  (int(1440 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(5360 +  2 - 1) / int( 2));
}
pass
{
