...
#line 353
if ( (3440 * (1.0 / 1440)) > 1.0) 
borderCoord.x = borderCoord.x* (3440 * (1.0 / 1440))+(1.0- (3440 * (1.0 / 1440)));
else if ( (3440 * (1.0 / 1440)) < 1.0) 
borderCoord.y = borderCoord.y* (1440*(1.0 / 3440))+(1.0- (1440*(1.0 / 3440)));
#line 358
...
#line 410
case 1: FovType = sqrt( (1440*(1.0 / 3440))* (1440*(1.0 / 3440))+1.0); break;
#line 412
case 2: FovType =  (1440*(1.0 / 3440)); break;
#line 414
case 3: FovType = (4.0/3.0) * (1440*(1.0 / 3440)); break;
#line 416
case 4: FovType = (16.0/9.0) * (1440*(1.0 / 3440)); break;
}
#line 420
float2 sphCoord = texCoord*2.0 -1.0;
#line 422
sphCoord.x -= Offset.y; 
sphCoord.y  = Offset.x+sphCoord.y* (1440*(1.0 / 3440));
#line 425
