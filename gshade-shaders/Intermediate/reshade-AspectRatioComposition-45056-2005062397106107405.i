...
#line 64
if(aspectRatio <  (1281 * (1.0 / 721)))
{
borderSize = (1281 - 721 * aspectRatio) / 2.0;
fractionWidth = (1281 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (1281 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (721 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (721 - 1281 / aspectRatio) / 2.0;
fractionWidth = (721 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (721 - borderSize))
retVal = gridColor;
#line 86
if((vpos.x % (1281 / fraction)) < 1)
retVal = gridColor;
#line 89
...
#line 94
if(vpos.x <= 1 || vpos.x >= 1281-1 || vpos.y <= 1 || vpos.y >= 721-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(1281, 721, 0, 0) - vpos);
}
#line 125
