...
> = 1.0;
#line 112
texture texGaussianH { Width = 1281; Height = 721; };
texture texGaussian { Width = 1281; Height = 721; };
#line 116
...
float loops      = max( 1281, 721 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 1281, 721 ) / 1920.0f ); 
