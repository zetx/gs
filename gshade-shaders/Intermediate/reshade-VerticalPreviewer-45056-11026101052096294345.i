...
texture texDraw { Width = 1799; Height = 998; };
texture texVPreOut { Width = 1799; Height = 998; };
#line 129
...
float2 pixelsize =  float2((1.0 / 1799), (1.0 / 998)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(1799, 998) * cLayerVPre_Scale /  float2(1799, 998));
