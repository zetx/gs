...
dcl_output o0.xyzw
dcl_temps 4
add r0.xyzw, v1.xyxy, l(0.018605, 0.044444, -0.018605, -0.044444)
...
add r1.xyzw, v1.xyxy, l(0.037209, 0.088889, -0.037209, -0.088889)
...
add r1.xyzw, v1.xyxy, l(0.037209, 0.000000, -0.037209, 0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r2.xyzw, r1.xyxx, t12.xyzw, s0, l(0.000000)
sample_l_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.zwzz, t12.xyzw, s0, l(0.000000)
add r1.xyzw, r1.xyzw, r2.xyzw
add r2.xyzw, v1.xyxy, l(0.000000, 0.088889, 0.000000, -0.088889)
