...
texture SLPtex {Width = 1799; Height = 995; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 1799), (1.0 / 995)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 1799), (1.0 / 995)).xy);
}
#line 86
