...
#line 64
if(aspectRatio <  (792 * (1.0 / 710)))
{
borderSize = (792 - 710 * aspectRatio) / 2.0;
fractionWidth = (792 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (792 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (710 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (710 - 792 / aspectRatio) / 2.0;
fractionWidth = (710 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (710 - borderSize))
retVal = gridColor;
#line 86
if((vpos.x % (792 / fraction)) < 1)
retVal = gridColor;
#line 89
...
#line 94
if(vpos.x <= 1 || vpos.x >= 792-1 || vpos.y <= 1 || vpos.y >= 710-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(792, 710, 0, 0) - vpos);
}
#line 125
