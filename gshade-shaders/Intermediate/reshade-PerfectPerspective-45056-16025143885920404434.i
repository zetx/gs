...
#line 353
if ( (1309 * (1.0 / 762)) > 1.0) 
borderCoord.x = borderCoord.x* (1309 * (1.0 / 762))+(1.0- (1309 * (1.0 / 762)));
else if ( (1309 * (1.0 / 762)) < 1.0) 
borderCoord.y = borderCoord.y* (762*(1.0 / 1309))+(1.0- (762*(1.0 / 1309)));
#line 358
...
#line 410
case 1: FovType = sqrt( (762*(1.0 / 1309))* (762*(1.0 / 1309))+1.0); break;
#line 412
case 2: FovType =  (762*(1.0 / 1309)); break;
#line 414
case 3: FovType = (4.0/3.0) * (762*(1.0 / 1309)); break;
#line 416
case 4: FovType = (16.0/9.0) * (762*(1.0 / 1309)); break;
}
#line 420
float2 sphCoord = texCoord*2.0 -1.0;
#line 422
sphCoord.x -= Offset.y; 
sphCoord.y  = Offset.x+sphCoord.y* (762*(1.0 / 1309));
#line 425
