...
> = 0.75;
#line 68
texture SmoothTexture01 { Width = 1280; Height = 720; Format = RGBA8; };
sampler Texture01S { Texture = SmoothTexture01; };
#line 72
static const float2 g10 = float2( 0.333,-1.0)* float2((1.0 / 1280), (1.0 / 720));
static const float2 g01 = float2(-1.0,-0.333)* float2((1.0 / 1280), (1.0 / 720));
static const float2 g12 = float2(-0.333, 1.0)* float2((1.0 / 1280), (1.0 / 720));
static const float2 g21 = float2( 1.0, 0.333)* float2((1.0 / 1280), (1.0 / 720));
#line 77
...
#line 101
const float2 inv_size = RANGE *  float2((1.0 / 1280), (1.0 / 720));
#line 103
