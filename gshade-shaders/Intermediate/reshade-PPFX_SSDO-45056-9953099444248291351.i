...
> = 0;
#line 156
texture texColorLOD { Width = 1500; Height = 1004; Format = RGBA8; MipLevels = 4; };
...
float3	ssdo = 0.0;
#line 299
const float	randomDir = tex2Dlod(SamplerSSDONoise,float4(frac(txCoords* float2((1500*					1.0		)/4.0,(1004*					1.0		)/4.0)), 0.0, 0.0)).x;
