...
texture Anisotropy {Width = 1281; Height = 721; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 1281), (1.0 / 721), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 1281), (1.0 / 721)) * Scale;
