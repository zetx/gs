...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.000993)
    mov x0[2].x, l(0.002317)
    mov x0[3].x, l(0.003641)
    mov x0[4].x, l(0.004965)
    mov x0[5].x, l(0.006290)
    mov x0[6].x, l(0.007614)
    mov x0[7].x, l(0.008938)
    mov x0[8].x, l(0.010263)
    mov x0[9].x, l(0.011587)
    mov x0[10].x, l(0.012912)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.000997)
      mov x3[2].x, l(0.002326)
      mov x3[3].x, l(0.003655)
      mov x3[4].x, l(0.004985)
      mov x3[5].x, l(0.006314)
      mov x3[6].x, l(0.007643)
      mov x3[7].x, l(0.008972)
      mov x3[8].x, l(0.010302)
      mov x3[9].x, l(0.011631)
      mov x3[10].x, l(0.012960)
      mov x3[11].x, l(0.014289)
      mov x3[12].x, l(0.015619)
      mov x3[13].x, l(0.016948)
      mov x3[14].x, l(0.018277)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.000997)
        mov x6[2].x, l(0.002326)
        mov x6[3].x, l(0.003655)
        mov x6[4].x, l(0.004985)
        mov x6[5].x, l(0.006314)
        mov x6[6].x, l(0.007643)
        mov x6[7].x, l(0.008972)
        mov x6[8].x, l(0.010302)
        mov x6[9].x, l(0.011631)
        mov x6[10].x, l(0.012977)
        mov x6[11].x, l(0.014308)
        mov x6[12].x, l(0.015640)
        mov x6[13].x, l(0.016971)
        mov x6[14].x, l(0.018302)
        mov x6[15].x, l(0.019633)
        mov x6[16].x, l(0.020964)
        mov x6[17].x, l(0.022295)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.000972)
          mov x9[2].x, l(0.002269)
          mov x9[3].x, l(0.003568)
          mov x9[4].x, l(0.004869)
          mov x9[5].x, l(0.006172)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.000788)
            mov x12[2].x, l(0.002020)
            mov x12[3].x, l(0.003336)
