...
texture texColorHDRA { Width = 1280; Height = 720; Format = RGBA16F; };
texture texColorHDRB < pooled = true; > { Width = 1280; Height = 720; Format = RGBA16F; };
#line 185
texture texBloomA
{
Width = 1280/		4		;
...
#line 262
static const float2 pxSize = float2((1.0 / 1280),(1.0 / 720));
