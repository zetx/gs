...
texture SLPtex {Width = 1799; Height = 998; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 1799), (1.0 / 998)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 1799), (1.0 / 998)).xy);
}
#line 86
