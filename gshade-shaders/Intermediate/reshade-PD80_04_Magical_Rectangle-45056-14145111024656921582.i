...
> = 1.0;
#line 217
texture texMagicRectangle { Width = 1798; Height = 997; Format = RGBA16F; };
#line 220
...
uv.y         = ( id == 1 ) ? 2.0 : 0.0;
uv.xy        -= center.xy;
uv.y         /=  float( 1798 * (1.0 / 997) );
float dim    = ceil( sqrt( 1798 * 1798 + 997 * 997 )); 
float maxlen = min( 1798, 997 );
dim          = dim / maxlen; 
uv.xy        /= dim;
