...
#line 36
texture PastBackBuffer  { Width = 1309; Height = 762; Format = RGBA8;};
#line 38
sampler PBackBuffer
{
...
#line 43
texture TAABackBuffer  { Width = 1309; Height = 762; Format = RGBA8;};
#line 45
...
XY = XY * ( float2((1.0 / 1309), (1.0 / 762)) * Jitter_Ammount);
#line 95
...
#line 106
float3 in1 = tex2D(BackBuffer, texcoord + float2(+ float2((1.0 / 1309), (1.0 / 762)).x, 0.0)).xyz;
float3 in2 = tex2D(BackBuffer, texcoord + float2(- float2((1.0 / 1309), (1.0 / 762)).x, 0.0)).xyz;
float3 in3 = tex2D(BackBuffer, texcoord + float2(0.0, + float2((1.0 / 1309), (1.0 / 762)).y)).xyz;
float3 in4 = tex2D(BackBuffer, texcoord + float2(0.0, - float2((1.0 / 1309), (1.0 / 762)).y)).xyz;
float3 in5 = tex2D(BackBuffer, texcoord + float2(+ float2((1.0 / 1309), (1.0 / 762)).x, + float2((1.0 / 1309), (1.0 / 762)).y)).xyz;
float3 in6 = tex2D(BackBuffer, texcoord + float2(- float2((1.0 / 1309), (1.0 / 762)).x, + float2((1.0 / 1309), (1.0 / 762)).y)).xyz;
float3 in7 = tex2D(BackBuffer, texcoord + float2(+ float2((1.0 / 1309), (1.0 / 762)).x, - float2((1.0 / 1309), (1.0 / 762)).y)).xyz;
float3 in8 = tex2D(BackBuffer, texcoord + float2(- float2((1.0 / 1309), (1.0 / 762)).x, - float2((1.0 / 1309), (1.0 / 762)).y)).xyz;
#line 115
...
for (int i = 0; i < 6; i++)
{
float4 neighbor = tex2D(BackBuffer, texcoord + XYoffset[i] *  float2((1.0 / 1309), (1.0 / 762)) );
#line 150
