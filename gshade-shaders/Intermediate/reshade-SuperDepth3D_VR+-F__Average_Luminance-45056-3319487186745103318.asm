...
// __V__texPBVR                      texture  float4          2d            t10      1 
...
movc r0.z, cb0[4].w, r0.w, r0.y
mad r0.xy, -cb0[3].xxxx, l(0.000291, 0.000694, 0.000000, 0.000000), r0.xzxx
sample_l_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s0, l(0.000000)
div r0.y, l(0.125000), cb0[3].z
div r0.y, l(1.000000, 1.000000, 1.000000, 1.000000), r0.y
add r0.z, -r0.y, l(1.000000)
lt r0.w, cb0[3].w, l(0.000000)
add r1.x, |cb0[3].w|, l(1.000000)
mul r1.y, r0.x, r1.x
...
lt r1.y, l(0.000000), cb0[3].w
or r1.y, r0.w, r1.y
add r1.w, cb0[3].w, l(1.000000)
mul r4.x, r1.w, r3.x
...
movc r4.yw, r5.xxxx, l(0,1.125000,0,0.425000), cb0[6].zzzx
...
movc r2.y, cb0[4].w, r1.z, v1.y
mov r2.x, v1.x
mad r2.xy, -cb0[3].xxxx, l(0.000291, 0.000694, 0.000000, 0.000000), r2.xyxx
...
movc_sat r3.y, cb0[3].y, r0.z, r0.y
mul r1.x, r5.x, r1.z
div r1.y, r2.x, r5.y
...
sample_indexable(texture2d)(float,float,float,float) r0.x, l(0.000000, 0.000000, 0.000000, 0.000000), t4.xyzw, s2
sample_indexable(texture2d)(float,float,float,float) r0.y, l(1.000000, 1.000000, 0.000000, 0.000000), t4.yxzw, s2
sample_indexable(texture2d)(float,float,float,float) r0.z, l(0.000000, 1.000000, 0.000000, 0.000000), t4.yzxw, s2
sample_indexable(texture2d)(float,float,float,float) r0.w, l(1.000000, 0.000000, 0.000000, 0.000000), t4.yzwx, s2
sample_indexable(texture2d)(float,float,float,float) r1.x, l(1.000000, 1.000000, 0.000000, 0.000000), t6.yxzw, s3
sample_indexable(texture2d)(float,float,float,float) r1.y, l(0.000000, 1.000000, 0.000000, 0.000000), t6.xyzw, s3
mov x1[0].x, r0.x
mov x1[1].x, r0.y
mov x1[2].x, r0.z
mov x1[3].x, r0.w
...
sample_l_indexable(texture2d)(float,float,float,float) r3.w, v1.xyxx, t4.xzwy, s2, l(0.000000)
ftoi r0.x, r0.x
mov r3.z, x1[r0.x + 0].x
sample_indexable(texture2d)(float,float,float,float) r0.x, v1.xyxx, t4.wxyz, s2
sample_indexable(texture2d)(float,float,float,float) r0.y, v1.xyxx, t10.yxzw, s1
add r0.x, -r0.y, r0.x
mov o1.x, |r0.x|
mov o0.xyzw, r3.xyzw
ret 
