...
texture prePassLayer { Width = 1309; Height = 762; Format = RGBA8; };
texture blurLayerHorizontal { Width = 1309 / 2; Height = 762 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 1309 / 2; Height = 762 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 1309 / 16; Height = 762 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 1309 / 16; Height = 762 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 1309 / 64; Height = 762 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 1309 / 64; Height = 762 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 1309 * sampling;
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 762 * sampling;
float divisor = 0.000001;
#line 410
