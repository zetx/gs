...
{
#line 255
const float Up = LI(BB(texcoord, float2( 0,- float2((1.0 / 1280), (1.0 / 720)).y)));
const float Left = LI(BB(texcoord, float2(- float2((1.0 / 1280), (1.0 / 720)).x, 0)));
const float Center = LI(BB(texcoord, 0));
const float Right = LI(BB(texcoord, float2(  float2((1.0 / 1280), (1.0 / 720)).x, 0)));
const float Down = LI(BB(texcoord, float2( 0,  float2((1.0 / 1280), (1.0 / 720)).y)));
#line 261
