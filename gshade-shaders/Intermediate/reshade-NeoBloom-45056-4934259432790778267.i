...
{
return GaussianBlur1D(AtlasA, uv, PixelScale * float2((1.0 / 1024), 0.0) *  2, uSigma, BlurSamples);
}
#line 949
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return GaussianBlur1D(AtlasB, uv, PixelScale * float2(0.0, (1.0 / 768)) *  2, uSigma, BlurSamples);
}
#line 956
...
#line 1055
float ar = 1024 * (1.0 / 768);
float ar_inv = 768 * (1.0 / 1024);
