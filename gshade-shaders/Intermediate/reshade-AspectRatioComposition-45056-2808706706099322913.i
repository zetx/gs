...
#line 64
if(aspectRatio <  (1309 * (1.0 / 762)))
{
borderSize = (1309 - 762 * aspectRatio) / 2.0;
fractionWidth = (1309 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (1309 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (762 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (762 - 1309 / aspectRatio) / 2.0;
fractionWidth = (762 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (762 - borderSize))
retVal = gridColor;
#line 86
if((vpos.x % (1309 / fraction)) < 1)
retVal = gridColor;
#line 89
...
#line 94
if(vpos.x <= 1 || vpos.x >= 1309-1 || vpos.y <= 1 || vpos.y >= 762-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(1309, 762, 0, 0) - vpos);
}
#line 125
