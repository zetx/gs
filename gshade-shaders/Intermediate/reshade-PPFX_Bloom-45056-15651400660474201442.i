...
texture texColorHDRA { Width = 1309; Height = 762; Format = RGBA16F; };
texture texColorHDRB < pooled = true; > { Width = 1309; Height = 762; Format = RGBA16F; };
#line 185
texture texBloomA
{
Width = 1309/		4		;
...
#line 262
static const float2 pxSize = float2((1.0 / 1309),(1.0 / 762));
