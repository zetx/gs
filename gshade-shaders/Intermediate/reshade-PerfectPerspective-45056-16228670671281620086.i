...
#line 353
if ( (792 * (1.0 / 710)) > 1.0) 
borderCoord.x = borderCoord.x* (792 * (1.0 / 710))+(1.0- (792 * (1.0 / 710)));
else if ( (792 * (1.0 / 710)) < 1.0) 
borderCoord.y = borderCoord.y* (710*(1.0 / 792))+(1.0- (710*(1.0 / 792)));
#line 358
...
#line 410
case 1: FovType = sqrt( (710*(1.0 / 792))* (710*(1.0 / 792))+1.0); break;
#line 412
case 2: FovType =  (710*(1.0 / 792)); break;
#line 414
case 3: FovType = (4.0/3.0) * (710*(1.0 / 792)); break;
#line 416
case 4: FovType = (16.0/9.0) * (710*(1.0 / 792)); break;
}
#line 420
float2 sphCoord = texCoord*2.0 -1.0;
#line 422
sphCoord.x -= Offset.y; 
sphCoord.y  = Offset.x+sphCoord.y* (710*(1.0 / 792));
#line 425
