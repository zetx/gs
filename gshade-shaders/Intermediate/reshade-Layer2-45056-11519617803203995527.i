...
> = 0;
#line 160
texture Layer2_Tex <source =  "LayerStage.png" ;> { Width = 1799; Height = 998; Format=RGBA8; };
...
const float AspectX = (1.0 - 1799 * (1.0 / 998));
const float AspectY = (1.0 - 998 * (1.0 / 1799));
const float3 mulUV = float3(texCoord.x, texCoord.y, 1);
const float2 ScaleSize = (float2( 1799,  998) * Layer2_Scale /  float2(1799, 998));
