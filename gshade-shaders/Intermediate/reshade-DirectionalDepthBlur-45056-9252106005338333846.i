...
#line 200
texture texDownsampledBackBuffer { Width = 1281; Height = 721; Format = RGBA16F; };
texture texBlurDestination { Width = 1281; Height = 721; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 1281), (1.0 / 721));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 1281), (1.0 / 721)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 1281), (1.0 / 721)));
pixelInfo.blurLengthInPixels = length( float2(1281, 721)) * BlurLength;
