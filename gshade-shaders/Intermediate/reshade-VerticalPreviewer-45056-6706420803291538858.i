...
texture texDraw { Width = 1799; Height = 995; };
texture texVPreOut { Width = 1799; Height = 995; };
#line 129
...
float2 pixelsize =  float2((1.0 / 1799), (1.0 / 995)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(1799, 995) * cLayerVPre_Scale /  float2(1799, 995));
