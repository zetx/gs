...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 1500 / 2; Height = 1004 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 1500 / 4; Height = 1004 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 1500 / 8; Height = 1004 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 1500 / 16; Height = 1004 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 1500 / 32; Height = 1004 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 1500 / 64; Height = 1004 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 1500 / 128; Height = 1004 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 1500 / 256; Height = 1004 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 1500; Height = 1004; };
#line 269
...
float2 ps =  float2((1.0 / 1500), (1.0 / 1004)) * scale;
#line 303
