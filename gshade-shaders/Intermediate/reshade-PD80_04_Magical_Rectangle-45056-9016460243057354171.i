...
> = 1.0;
#line 217
texture texMagicRectangle { Width = 3440; Height = 1440; Format = RGBA16F; };
#line 220
...
uv.y         = ( id == 1 ) ? 2.0 : 0.0;
uv.xy        -= center.xy;
uv.y         /=  float( 3440 * (1.0 / 1440) );
float dim    = ceil( sqrt( 3440 * 3440 + 1440 * 1440 )); 
float maxlen = min( 3440, 1440 );
dim          = dim / maxlen; 
uv.xy        /= dim;
