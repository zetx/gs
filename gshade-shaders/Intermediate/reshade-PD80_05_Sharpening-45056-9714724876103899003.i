...
> = 1.0;
#line 112
texture texGaussianH { Width = 1799; Height = 998; };
texture texGaussian { Width = 1799; Height = 998; };
#line 116
...
float loops      = max( 1799, 998 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 1799, 998 ) / 1920.0f ); 
