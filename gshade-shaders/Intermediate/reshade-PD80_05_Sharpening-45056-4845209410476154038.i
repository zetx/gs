...
> = 1.0;
#line 112
texture texGaussianH { Width = 1500; Height = 1004; };
texture texGaussian { Width = 1500; Height = 1004; };
#line 116
...
float loops      = max( 1500, 1004 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 1500, 1004 ) / 1920.0f ); 
