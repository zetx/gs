...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 1799 / 2; Height = 995 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 1799 / 4; Height = 995 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 1799 / 8; Height = 995 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 1799 / 16; Height = 995 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 1799 / 32; Height = 995 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 1799 / 64; Height = 995 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 1799 / 128; Height = 995 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 1799 / 256; Height = 995 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 1799; Height = 995; };
#line 269
...
float2 ps =  float2((1.0 / 1799), (1.0 / 995)) * scale;
#line 303
