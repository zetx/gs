...
#line 124
static const float2 ASPECT_RATIO 	= float2(1.0, 1799 * (1.0 / 998));
static const float2 PIXEL_SIZE 		= float2((1.0 / 1799), (1.0 / 998));
static const float2 SCREEN_SIZE 	= float2(1799, 998);
#line 130
...
#line 135
static const int BloomTex7_LowestMip =    (((998/128 >> 1) != 0) + ((998/128 >> 2) != 0) + ((998/128 >> 3) != 0) + ((998/128 >> 4) != 0) + ((998/128 >> 5) != 0) + ((998/128 >> 6) != 0) + ((998/128 >> 7) != 0) + ((998/128 >> 8) != 0) + ((998/128 >> 9) != 0) + ((998/128 >> 10) != 0) + ((998/128 >> 11) != 0) + ((998/128 >> 12) != 0) + ((998/128 >> 13) != 0) + ((998/128 >> 14) != 0) + ((998/128 >> 15) != 0) + ((998/128 >> 16) != 0));
#line 137
texture2D MXBLOOM_BloomTexSource 	{ Width = 1799/2; 	Height = 998/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 1799/2; 	Height = 998/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 1799/4;  	Height = 998/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 1799/8;  	Height = 998/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 1799/16;  Height = 998/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 1799/32;  Height = 998/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 1799/64;  Height = 998/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 1799/128; Height = 998/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
