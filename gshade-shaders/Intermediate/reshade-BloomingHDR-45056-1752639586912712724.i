...
texture texBC { Width = 1799 * 0.5; Height = 995 * 0.5; Format = RGBA8; MipLevels = 4;};
#line 115
sampler SamplerBC
{
Texture = texBC;
...
#line 124
texture texBlur { Width = 1799 * 0.5; Height = 995 * 0.5; Format = RGBA8; MipLevels = 3;};
#line 126
sampler SamplerBlur
{
Texture = texBlur;
...
#line 134
texture PastSingle_BackBuffer { Width = 1799; Height = 995; Format = RGBA8;};
#line 136
...
#line 186
texture PStexLumAvg {Width = 1799; Height = 995; Format = RGBA8; };
#line 188
...
{
const float2 tex_offset = 50 *  float2((1.0 / 1799), (1.0 / 995)); 
...
{
float2 tex_offset = (Spread * 0.5f) *  float2((1.0 / 1799), (1.0 / 995)); 
...
{
float2 tex_offset = (Spread * 0.25f) *  float2((1.0 / 1799), (1.0 / 995)); 
