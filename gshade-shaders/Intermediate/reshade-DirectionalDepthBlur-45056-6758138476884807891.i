...
#line 200
texture texDownsampledBackBuffer { Width = 1500; Height = 1004; Format = RGBA16F; };
texture texBlurDestination { Width = 1500; Height = 1004; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 1500), (1.0 / 1004));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 1500), (1.0 / 1004)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 1500), (1.0 / 1004)));
pixelInfo.blurLengthInPixels = length( float2(1500, 1004)) * BlurLength;
