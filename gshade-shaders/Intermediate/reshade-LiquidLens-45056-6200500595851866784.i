...
{
if (1281 > 721)
return float2(1.0, 721 * (1.0 / 1281));
else
return float2(1281 * (1.0 / 721), 1.0);
}
#line 26
...
texture LensATex
{
Width = 1281 / Downscale;
Height = 721 / Downscale;
Format = RGBA16F;
};
#line 175
sampler LensA
...
{
return Blur(LensA, uv, float2((1.0 / 1281), 0));
}
#line 221
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return Blur(LensB, uv, float2(0, (1.0 / 721)));
}
#line 226
