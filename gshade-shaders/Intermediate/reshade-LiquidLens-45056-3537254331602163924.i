...
{
if (1798 > 997)
return float2(1.0, 997 * (1.0 / 1798));
else
return float2(1798 * (1.0 / 997), 1.0);
}
#line 26
...
texture LensATex
{
Width = 1798 / Downscale;
Height = 997 / Downscale;
Format = RGBA16F;
};
#line 175
sampler LensA
...
{
return Blur(LensA, uv, float2((1.0 / 1798), 0));
}
#line 221
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return Blur(LensB, uv, float2(0, (1.0 / 997)));
}
#line 226
