...
texcoord.x -= iUIOffset.x * (1.0 / 792); 
texcoord.y += iUIOffset.y * (1.0 / 710); 
#line 178
...
{
float3 offset = float3( float2((1.0 / 792), (1.0 / 710)), 0.0);
...
#line 217
float grid_position = frac(dot(texcoord, ( float2(792, 710) * float2(1.0 / 16.0, 10.0 / 36.0)) + 0.25));
#line 219
...
color = normal;
if (iUIPresentType == 2)
color = lerp(normal, depth, step(792 * 0.5, position.x));
#line 233
if (bUIShowOffset)
{
