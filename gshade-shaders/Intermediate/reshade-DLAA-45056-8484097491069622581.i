...
texture SLPtex {Width = 1281; Height = 721; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 1281), (1.0 / 721)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 1281), (1.0 / 721)).xy);
}
#line 86
