...
{
return GaussianBlur1D(AtlasA, uv, PixelScale * float2((1.0 / 1799), 0.0) *  2, uSigma, BlurSamples);
}
#line 949
float4 BlurYPS(float4 p : SV_POSITION, float2 uv : TEXCOORD) : SV_TARGET
{
return GaussianBlur1D(AtlasB, uv, PixelScale * float2(0.0, (1.0 / 995)) *  2, uSigma, BlurSamples);
}
#line 956
...
#line 1055
float ar = 1799 * (1.0 / 995);
float ar_inv = 995 * (1.0 / 1799);
