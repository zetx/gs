...
> = 0;
#line 324
texture ColorCorrected {Width = 792; Height = 710; Format = RGBA16F;};
sampler sColorCorrected {Texture = ColorCorrected;};
texture fTransmission {Width = 792; Height = 710; Format = R8;};
...
texture FogRemoved {Width = 792; Height = 710; Format = RGBA16F;};
sampler sFogRemoved {Texture = FogRemoved;};
texture TruncatedPrecision {Width = 792; Height = 710; Format = RGBA16F;};
...
const int2 texturePos = int2((uint(id / 4) %  (792 /  15)) *  15, (uint(id / 4) /  (792 /  15)) *  15);
float color;
float y;
#line 346
switch (iteration)
...
{
const int fifty = abs(0.5 *  ( (710 /  15) *  (792 /  15)));
const int usedMax = abs( 0.95 *  ( (710 /  15) *  (792 /  15)));
int4 sum =  ( (710 /  15) *  (792 /  15));
output = 255.0;
int i = 255;
while((sum.r <=  ( (710 /  15) *  (792 /  15)) || sum.g <=  ( (710 /  15) *  (792 /  15)) || sum.b <=  ( (710 /  15) *  (792 /  15)) || sum.a <=  ( (710 /  15) *  (792 /  15))) && i >= 0)
{
#line 387
...
if (sum.r < usedMax)
{
sum.r = 2 *  ( (710 /  15) *  (792 /  15));
output.r = i;
}
if (sum.g < usedMax)
{
sum.g = 2 *  ( (710 /  15) *  (792 /  15));
output.g = i;
}
if (sum.b < usedMax)
{
sum.b = 2 *  ( (710 /  15) *  (792 /  15));
output.b = i;
}
#line 408
