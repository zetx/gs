...
const float2 cursor_position = trunc(( float2(1798, 997) / Ascii_block) * tex) * (Ascii_block /  float2(1798, 997));
#line 208
const float2 cp15 = cursor_position +  float2((1.0 / 1798), (1.0 / 997)) * 1.5;
const float2 cp35 = cursor_position +  float2((1.0 / 1798), (1.0 / 997)) * 3.5;
const float2 cp55 = cursor_position +  float2((1.0 / 1798), (1.0 / 997)) * 5.5;
#line 212
...
#line 249
const float2 p = trunc(frac(( float2(1798, 997) / Ascii_block) * tex) * Ascii_block); 
#line 251
