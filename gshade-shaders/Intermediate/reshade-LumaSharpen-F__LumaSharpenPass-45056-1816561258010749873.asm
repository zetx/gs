...
if_z cb0[0].z
  mad r2.xyzw, cb0[0].wwww, l(0.000185, 0.000334, -0.000185, -0.000334), v1.xyxy
...
if_nz r1.x
  mad r4.xyzw, cb0[0].wwww, l(0.000278, -0.000502, 0.000278, 0.000502), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000278, 0.000502, 0.000278, -0.000502), v1.xyxy
...
if_nz r1.y
  mad r4.xyzw, cb0[0].wwww, l(0.000222, -0.001204, 0.000667, 0.000401), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r1.xyw, r4.xyxx, t0.xywz, s0
  mad r5.xyzw, -cb0[0].wwww, l(0.000667, 0.000401, 0.000222, -0.001204), v1.xyxy
...
if_nz r1.z
  mov r1.xw, l(0.000278,0,0,-0.000502)
  mul r1.yz, cb0[0].wwww, l(0.000000, -0.001003, -0.000556, 0.000000)
  ...
  mul r4.xw, cb0[0].wwww, l(0.000556, 0.000000, 0.000000, 0.001003)
  mov r4.yz, l(0,0.000502,-0.000278,0)
