...
texture texColorHDRA { Width = 1799; Height = 995; Format = RGBA16F; };
texture texColorHDRB < pooled = true; > { Width = 1799; Height = 995; Format = RGBA16F; };
#line 185
texture texBloomA
{
Width = 1799/		4		;
...
#line 262
static const float2 pxSize = float2((1.0 / 1799),(1.0 / 995));
