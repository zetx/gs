...
#line 135
static const int BloomTex7_LowestMip =    (((768/128 >> 1) != 0) + ((768/128 >> 2) != 0) + ((768/128 >> 3) != 0) + ((768/128 >> 4) != 0) + ((768/128 >> 5) != 0) + ((768/128 >> 6) != 0) + ((768/128 >> 7) != 0) + ((768/128 >> 8) != 0) + ((768/128 >> 9) != 0) + ((768/128 >> 10) != 0) + ((768/128 >> 11) != 0) + ((768/128 >> 12) != 0) + ((768/128 >> 13) != 0) + ((768/128 >> 14) != 0) + ((768/128 >> 15) != 0) + ((768/128 >> 16) != 0));
#line 137
texture2D MXBLOOM_BloomTexSource 	{ Width = 1024/2; 	Height = 768/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex1 		{ Width = 1024/2; 	Height = 768/2;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex2			{ Width = 1024/4;  	Height = 768/4;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex3 		{ Width = 1024/8;  	Height = 768/8;    Format = RGBA16F;};
texture2D MXBLOOM_BloomTex4 		{ Width = 1024/16;  Height = 768/16;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex5 		{ Width = 1024/32;  Height = 768/32;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex6 		{ Width = 1024/64;  Height = 768/64;   Format = RGBA16F;};
texture2D MXBLOOM_BloomTex7 		{ Width = 1024/128; Height = 768/128;  Format = RGBA16F; MipLevels = BloomTex7_LowestMip;};
