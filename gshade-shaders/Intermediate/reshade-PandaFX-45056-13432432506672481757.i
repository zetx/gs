...
texture prePassLayer { Width = 5360; Height = 1440; Format = RGBA8; };
texture blurLayerHorizontal { Width = 5360 / 2; Height = 1440 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 5360 / 2; Height = 1440 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 5360 / 16; Height = 1440 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 5360 / 16; Height = 1440 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 5360 / 64; Height = 1440 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 5360 / 64; Height = 1440 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 5360 * sampling;
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 1440 * sampling;
float divisor = 0.000001;
#line 410
