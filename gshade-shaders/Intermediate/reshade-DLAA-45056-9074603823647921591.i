...
texture SLPtex {Width = 1280; Height = 720; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 1280), (1.0 / 720)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 1280), (1.0 / 720)).xy);
}
#line 86
