...
if ( (5360 * (1.0 / 1440)) < border_ratio)
border_width_variable = float2(0.0, (1440 - (5360 / border_ratio)) * 0.5);
else
border_width_variable = float2((5360 - (1440 * border_ratio)) * 0.5, 0.0);
#line 56
const float2 border = ( float2((1.0 / 5360), (1.0 / 1440)) * border_width_variable); 
#line 58
