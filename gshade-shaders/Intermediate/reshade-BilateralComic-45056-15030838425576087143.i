...
texture Luma <Pooled = true;> {Width = 1798; Height = 997; Format = R16f;};
texture Sobel <Pooled = true;> {Width = 1798; Height = 997; Format = R8;};
#line 16
...
{
float2 offset = (float2(i, j) * normals.xy) * 1 / float2(1798, 997);
