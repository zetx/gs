...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001493)
    mov x0[2].x, l(0.003483)
    mov x0[3].x, l(0.005473)
    mov x0[4].x, l(0.007463)
    mov x0[5].x, l(0.009453)
    mov x0[6].x, l(0.011444)
    mov x0[7].x, l(0.013434)
    mov x0[8].x, l(0.015425)
    mov x0[9].x, l(0.017416)
    mov x0[10].x, l(0.019407)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001498)
      mov x3[2].x, l(0.003496)
      mov x3[3].x, l(0.005494)
      mov x3[4].x, l(0.007492)
      mov x3[5].x, l(0.009490)
      mov x3[6].x, l(0.011488)
      mov x3[7].x, l(0.013485)
      mov x3[8].x, l(0.015483)
      mov x3[9].x, l(0.017481)
      mov x3[10].x, l(0.019479)
      mov x3[11].x, l(0.021477)
      mov x3[12].x, l(0.023475)
      mov x3[13].x, l(0.025473)
      mov x3[14].x, l(0.027471)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001498)
        mov x6[2].x, l(0.003496)
        mov x6[3].x, l(0.005494)
        mov x6[4].x, l(0.007492)
        mov x6[5].x, l(0.009490)
        mov x6[6].x, l(0.011488)
        mov x6[7].x, l(0.013485)
        mov x6[8].x, l(0.015483)
        mov x6[9].x, l(0.017481)
        mov x6[10].x, l(0.019505)
        mov x6[11].x, l(0.021506)
        mov x6[12].x, l(0.023506)
        mov x6[13].x, l(0.025507)
        mov x6[14].x, l(0.027507)
        mov x6[15].x, l(0.029508)
        mov x6[16].x, l(0.031509)
        mov x6[17].x, l(0.033509)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001461)
          mov x9[2].x, l(0.003411)
          mov x9[3].x, l(0.005363)
          mov x9[4].x, l(0.007318)
          mov x9[5].x, l(0.009277)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001185)
            mov x12[2].x, l(0.003035)
            mov x12[3].x, l(0.005014)
