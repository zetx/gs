...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 1281 / 2; Height = 721 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 1281 / 4; Height = 721 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 1281 / 8; Height = 721 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 1281 / 16; Height = 721 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 1281 / 32; Height = 721 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 1281 / 64; Height = 721 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 1281 / 128; Height = 721 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 1281 / 256; Height = 721 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 1281; Height = 721; };
#line 269
...
float2 ps =  float2((1.0 / 1281), (1.0 / 721)) * scale;
#line 303
