...
#line 48
texture2D currTex { Width = 1799; Height = 995; Format = RGBA8; };
texture2D prevSingleTex { Width = 1799; Height = 995; Format = RGBA8; };
texture2D prevTex { Width = 1799; Height = 995; Format = RGBA8; };
#line 52
...
const float pixelBlur2 = (mbSoftness * 11 * (diff)) * ((1.0 / 995));
#line 71
[unroll]
for (int z = 1; z < 11; z++)
{
