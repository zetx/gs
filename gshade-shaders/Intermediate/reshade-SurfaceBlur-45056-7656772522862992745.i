...
if (BlurRadius == 1)
{
static const float sampleOffsetsX[5] = {  0.0,   float2((1.0 / 1798), (1.0 / 997)).x, 		   0, 	   float2((1.0 / 1798), (1.0 / 997)).x,       float2((1.0 / 1798), (1.0 / 997)).x};
static const float sampleOffsetsY[5] = {  0.0,      	0,   float2((1.0 / 1798), (1.0 / 997)).y, 	   float2((1.0 / 1798), (1.0 / 997)).y,    -  float2((1.0 / 1798), (1.0 / 997)).y};
...
if (BlurRadius == 2)
{
static const float sampleOffsetsX[13] = {  0.0, 	     float2((1.0 / 1798), (1.0 / 997)).x, 	  0, 	   float2((1.0 / 1798), (1.0 / 997)).x,       float2((1.0 / 1798), (1.0 / 997)).x,      2.0* float2((1.0 / 1798), (1.0 / 997)).x,     0,      2.0* float2((1.0 / 1798), (1.0 / 997)).x,      2.0* float2((1.0 / 1798), (1.0 / 997)).x,       float2((1.0 / 1798), (1.0 / 997)).x,      float2((1.0 / 1798), (1.0 / 997)).x,      2.0* float2((1.0 / 1798), (1.0 / 997)).x,      2.0* float2((1.0 / 1798), (1.0 / 997)).x };
static const float sampleOffsetsY[13] = {  0.0,     0, 	    float2((1.0 / 1798), (1.0 / 997)).y, 	   float2((1.0 / 1798), (1.0 / 997)).y,    -  float2((1.0 / 1798), (1.0 / 997)).y,     0,      2.0* float2((1.0 / 1798), (1.0 / 997)).y,       float2((1.0 / 1798), (1.0 / 997)).y,    -  float2((1.0 / 1798), (1.0 / 997)).y,      2.0* float2((1.0 / 1798), (1.0 / 997)).y,     - 2.0* float2((1.0 / 1798), (1.0 / 997)).y,      2.0* float2((1.0 / 1798), (1.0 / 997)).y,    - 2.0* float2((1.0 / 1798), (1.0 / 997)).y};
...
if (BlurRadius == 3)
{
static const float sampleOffsetsX[13] = { 				  0.0, 			     1.3846153846* float2((1.0 / 1798), (1.0 / 997)).x, 			 			  0, 	 		   1.3846153846* float2((1.0 / 1798), (1.0 / 997)).x,     	   	  1.3846153846* float2((1.0 / 1798), (1.0 / 997)).x,     		     3.2307692308* float2((1.0 / 1798), (1.0 / 997)).x,     		  			  0,     		  3.2307692308* float2((1.0 / 1798), (1.0 / 997)).x,     		    3.2307692308* float2((1.0 / 1798), (1.0 / 997)).x,     		  1.3846153846* float2((1.0 / 1798), (1.0 / 997)).x,    		    1.3846153846* float2((1.0 / 1798), (1.0 / 997)).x,     		   3.2307692308* float2((1.0 / 1798), (1.0 / 997)).x,     		   3.2307692308* float2((1.0 / 1798), (1.0 / 997)).x };
static const float sampleOffsetsY[13] = {  				  0.0,   					   0, 	  		    1.3846153846* float2((1.0 / 1798), (1.0 / 997)).y, 	 		   1.3846153846* float2((1.0 / 1798), (1.0 / 997)).y,     		- 1.3846153846* float2((1.0 / 1798), (1.0 / 997)).y,     					   0,     		    3.2307692308* float2((1.0 / 1798), (1.0 / 997)).y,     		  1.3846153846* float2((1.0 / 1798), (1.0 / 997)).y,    		  - 1.3846153846* float2((1.0 / 1798), (1.0 / 997)).y,     		  3.2307692308* float2((1.0 / 1798), (1.0 / 997)).y,   		  - 3.2307692308* float2((1.0 / 1798), (1.0 / 997)).y,     		   3.2307692308* float2((1.0 / 1798), (1.0 / 997)).y,    		     - 3.2307692308* float2((1.0 / 1798), (1.0 / 997)).y };
...
if (BlurRadius >= 4)
{
static const float sampleOffsetsX[25] = {0.0,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).x, 0,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).x,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).x,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).x, 0,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).x,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).x,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).x,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).x,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).x,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).x,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).x, 0.0,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).x,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).x,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).x,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).x,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).x,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).x,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).x,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).x,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).x,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).x};
static const float sampleOffsetsY[25] = {0.0, 0,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).y,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).y, - 1.4584295168* float2((1.0 / 1798), (1.0 / 997)).y, 0,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).y,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).y, - 1.4584295168* float2((1.0 / 1798), (1.0 / 997)).y,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).y, - 3.4039848067* float2((1.0 / 1798), (1.0 / 997)).y,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).y, - 3.4039848067* float2((1.0 / 1798), (1.0 / 997)).y, 0.0,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).y,  1.4584295168* float2((1.0 / 1798), (1.0 / 997)).y, - 1.4584295168* float2((1.0 / 1798), (1.0 / 997)).y,  3.4039848067* float2((1.0 / 1798), (1.0 / 997)).y, - 3.4039848067* float2((1.0 / 1798), (1.0 / 997)).y,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).y, - 5.3518057801* float2((1.0 / 1798), (1.0 / 997)).y,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).y, - 5.3518057801* float2((1.0 / 1798), (1.0 / 997)).y,  5.3518057801* float2((1.0 / 1798), (1.0 / 997)).y, - 5.3518057801* float2((1.0 / 1798), (1.0 / 997)).y};
