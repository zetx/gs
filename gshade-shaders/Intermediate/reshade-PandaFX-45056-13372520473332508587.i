...
texture prePassLayer { Width = 1280; Height = 720; Format = RGBA8; };
texture blurLayerHorizontal { Width = 1280 / 2; Height = 720 / 2; Format = RGBA8; };
texture blurLayerVertical { Width = 1280 / 2; Height = 720 / 2; Format = RGBA8; };
texture blurLayerHorizontalMedRes { Width = 1280 / 16; Height = 720 / 16; Format = RGBA8; };
texture blurLayerVerticalMedRes { Width = 1280 / 16; Height = 720 / 16; Format = RGBA8; };
texture blurLayerHorizontalLoRes { Width = 1280 / 64; Height = 720 / 64; Format = RGBA8; };
texture blurLayerVerticalLoRes { Width = 1280 / 64; Height = 720 / 64; Format = RGBA8; };
#line 324
...
float weight = 1.0;
const float width = 1.0 / 1280 * sampling;
...
float4 C = float4(0.0, 0.0, 0.0, 1.0);
float weight = 1.0;
const float height = 1.0 / 720 * sampling;
float divisor = 0.000001;
#line 410
