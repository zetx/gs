...
texture Anisotropy {Width = 3440; Height = 1440; Format = RGBA16f;};
#line 40
...
{
if (i == 2) i++;
float3 offsets = float3((1.0 / 3440), (1.0 / 1440), 0) * GAUSSIAN_OFFSETS[i];
...
offset *= float2((1.0 / 3440), (1.0 / 1440)) * Scale;
