...
#line 76
return color + ((gold_noise(texcoord *  float2(792, 710).y * 2.0, ((luminance *  float2(792, 710).y) + ( float2(792, 710).x * texcoord.y) + texcoord.x + ReShade::GetLinearizedDepth(texcoord) *  float2(792, 710).y) * 0.0001) * amount) - sub);
}
#line 79
