...
#line 25 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\Emboss.fx"
#line 28
...
const float3 col1 = tex2D(ReShade::BackBuffer, texcoord -  float2((1.0 / 5360), (1.0 / 1440))*fEmbossOffset*offset).rgb;
const float3 col3 = tex2D(ReShade::BackBuffer, texcoord +  float2((1.0 / 5360), (1.0 / 1440))*fEmbossOffset*offset).rgb;
#line 37
