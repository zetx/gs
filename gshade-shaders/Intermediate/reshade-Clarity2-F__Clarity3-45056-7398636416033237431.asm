...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001881)
    mov x0[2].x, l(0.004389)
    mov x0[3].x, l(0.006896)
    mov x0[4].x, l(0.009404)
    mov x0[5].x, l(0.011912)
    mov x0[6].x, l(0.014420)
    mov x0[7].x, l(0.016928)
    mov x0[8].x, l(0.019437)
    mov x0[9].x, l(0.021945)
    mov x0[10].x, l(0.024454)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001888)
      mov x3[2].x, l(0.004406)
      mov x3[3].x, l(0.006923)
      mov x3[4].x, l(0.009440)
      mov x3[5].x, l(0.011958)
      mov x3[6].x, l(0.014475)
      mov x3[7].x, l(0.016993)
      mov x3[8].x, l(0.019510)
      mov x3[9].x, l(0.022028)
      mov x3[10].x, l(0.024546)
      mov x3[11].x, l(0.027063)
      mov x3[12].x, l(0.029581)
      mov x3[13].x, l(0.032098)
      mov x3[14].x, l(0.034616)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001888)
        mov x6[2].x, l(0.004406)
        mov x6[3].x, l(0.006923)
        mov x6[4].x, l(0.009440)
        mov x6[5].x, l(0.011958)
        mov x6[6].x, l(0.014475)
        mov x6[7].x, l(0.016993)
        mov x6[8].x, l(0.019510)
        mov x6[9].x, l(0.022028)
        mov x6[10].x, l(0.024579)
        mov x6[11].x, l(0.027099)
        mov x6[12].x, l(0.029620)
        mov x6[13].x, l(0.032141)
        mov x6[14].x, l(0.034662)
        mov x6[15].x, l(0.037183)
        mov x6[16].x, l(0.039704)
        mov x6[17].x, l(0.042225)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001841)
          mov x9[2].x, l(0.004298)
          mov x9[3].x, l(0.006757)
          mov x9[4].x, l(0.009221)
          mov x9[5].x, l(0.011690)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001493)
            mov x12[2].x, l(0.003825)
            mov x12[3].x, l(0.006318)
