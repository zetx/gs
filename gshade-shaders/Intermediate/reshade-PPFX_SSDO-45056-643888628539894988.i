...
> = 0;
#line 156
texture texColorLOD { Width = 1798; Height = 997; Format = RGBA8; MipLevels = 4; };
...
float3	ssdo = 0.0;
#line 299
const float	randomDir = tex2Dlod(SamplerSSDONoise,float4(frac(txCoords* float2((1798*					1.0		)/4.0,(997*					1.0		)/4.0)), 0.0, 0.0)).x;
