...
texture SLPtex {Width = 1798; Height = 997; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 1798), (1.0 / 997)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 1798), (1.0 / 997)).xy);
}
#line 86
