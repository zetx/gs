...
{
#line 225
const float Up = LI(BB(texcoord, float2( 0,- float2((1.0 / 5360), (1.0 / 1440)).y)).rgb);
const float Left = LI(BB(texcoord, float2(- float2((1.0 / 5360), (1.0 / 1440)).x, 0)).rgb);
const float Center = LI(BB(texcoord, 0).rgb);
const float Right = LI(BB(texcoord, float2(  float2((1.0 / 5360), (1.0 / 1440)).x, 0)).rgb);
const float Down = LI(BB(texcoord, float2( 0,  float2((1.0 / 5360), (1.0 / 1440)).y)).rgb);
#line 231
