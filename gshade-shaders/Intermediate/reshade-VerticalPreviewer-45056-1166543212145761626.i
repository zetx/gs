...
texture texDraw { Width = 1500; Height = 1004; };
texture texVPreOut { Width = 1500; Height = 1004; };
#line 129
...
float2 pixelsize =  float2((1.0 / 1500), (1.0 / 1004)) * p.offset;
#line 150
...
const float2 ScaleSize = (float2(1500, 1004) * cLayerVPre_Scale /  float2(1500, 1004));
