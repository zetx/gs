...
if_z cb0[0].z
  mad r2.xyzw, cb0[0].wwww, l(0.000097, 0.000231, -0.000097, -0.000231), v1.xyxy
...
if_nz r1.x
  mad r4.xyzw, cb0[0].wwww, l(0.000145, -0.000347, 0.000145, 0.000347), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000145, 0.000347, 0.000145, -0.000347), v1.xyxy
...
if_nz r1.y
  mad r4.xyzw, cb0[0].wwww, l(0.000116, -0.000833, 0.000349, 0.000278), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r1.xyw, r4.xyxx, t0.xywz, s0
  mad r5.xyzw, -cb0[0].wwww, l(0.000349, 0.000278, 0.000116, -0.000833), v1.xyxy
...
if_nz r1.z
  mov r1.xw, l(0.000145,0,0,-0.000347)
  mul r1.yz, cb0[0].wwww, l(0.000000, -0.000694, -0.000291, 0.000000)
  ...
  mul r4.xw, cb0[0].wwww, l(0.000291, 0.000000, 0.000000, 0.000694)
  mov r4.yz, l(0,0.000347,-0.000145,0)
