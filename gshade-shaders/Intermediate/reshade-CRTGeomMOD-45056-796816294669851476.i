...
> = float3(0.0, 0.0, 0.0);
#line 430
texture background_texture <source="background.png";> { Width = 1799; Height = 995; Format = RGBA8; };
sampler background_sampler { Texture = background_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 433
texture bezel_texture <source="bezel.png";> { Width = 1799; Height = 995; Format = RGBA8; };
sampler bezel_sampler { Texture = bezel_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 436
texture bezel_off_texture <source="bezel_off.png";> { Width = 1799; Height = 995; Format = RGBA8; };
sampler bezel_off_sampler { Texture = bezel_off_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 439
texture frame_texture <source="frame.png";> { Width = 1799; Height = 995; Format = RGBA8; };
sampler frame_sampler { Texture = frame_texture; AddressU = BORDER; AddressV = BORDER; AddressW = BORDER; };
#line 442
texture overlay_texture <source="overlay.png";> { Width = 1799; Height = 995; Format = RGBA8; };
...
#line 456
texture BloomBlurTex { Width = 1799 / 2; Height = 995 / 2; Format = RGBA8; };
sampler BloomBlurSampler { Texture = BloomBlurTex; };
#line 459
texture BloomBlurTex2 { Width = 1799 / 2; Height = 995 / 2; Format = RGBA8; };
