...
#line 1 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\PD80_02_Bonus_LUT_pack.fx"
...
static const float2 dither_uv = float2( 5360, 1440 ) / 512.0f;
#line 69
...
#line 20
namespace             pd80_02_Bonus_LUT_packName
{
#line 24
...
> = 1.0;
#line 93
texture               pd80_02_Bonus_LUT_packTex < source =       "pd80_example-lut.png"; >
{
Width =         64 *         64;
Height =         64 *          50;
};
sampler	              pd80_02_Bonus_LUT_packSamp { Texture =               pd80_02_Bonus_LUT_packTex; };
#line 101
...
#line 124
float3 lutcolor  = lerp( tex2D(               pd80_02_Bonus_LUT_packSamp, lutcoord.xy ).xyz, tex2D(               pd80_02_Bonus_LUT_packSamp, float2( lutcoord.x + texelsize.y, lutcoord.y )).xyz, lerpfact );
...
#line 140
technique      pd80_02_Bonus_LUT_pack
{
pass MultiLUT_Apply
{
...
#line 39 "I:\Games\SquareEnix\FINAL FANTASY XIV - A Realm Reborn\game\gshade-shaders\Shaders\PD80_02_Bonus_LUT_pack.fx"
