...
> = 1.0;
#line 112
texture texGaussianH { Width = 1309; Height = 762; };
texture texGaussian { Width = 1309; Height = 762; };
#line 116
...
float loops      = max( 1309, 762 ) / 1920.0f * 4.0f;
#line 169
float3 Sigma;
float bSigma     = BlurSigma * ( max( 1309, 762 ) / 1920.0f ); 
