...
const float2 cursor_position = trunc(( float2(3440, 1440) / Ascii_block) * tex) * (Ascii_block /  float2(3440, 1440));
#line 208
const float2 cp15 = cursor_position +  float2((1.0 / 3440), (1.0 / 1440)) * 1.5;
const float2 cp35 = cursor_position +  float2((1.0 / 3440), (1.0 / 1440)) * 3.5;
const float2 cp55 = cursor_position +  float2((1.0 / 3440), (1.0 / 1440)) * 5.5;
#line 212
...
#line 249
const float2 p = trunc(frac(( float2(3440, 1440) / Ascii_block) * tex) * Ascii_block); 
#line 251
