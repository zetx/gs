...
#line 64
if(aspectRatio <  (1280 * (1.0 / 720)))
{
borderSize = (1280 - 720 * aspectRatio) / 2.0;
fractionWidth = (1280 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (1280 - borderSize))
retVal = gridColor;
#line 72
...
#line 94
if(vpos.x <= 1 || vpos.x >= 1280-1 || vpos.y <= 1 || vpos.y >= 720-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(1280, 720, 0, 0) - vpos);
}
#line 125
