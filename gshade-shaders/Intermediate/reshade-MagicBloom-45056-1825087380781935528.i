...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 1309 / 2; Height = 762 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 1309 / 4; Height = 762 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 1309 / 8; Height = 762 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 1309 / 16; Height = 762 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 1309 / 32; Height = 762 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 1309 / 64; Height = 762 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 1309 / 128; Height = 762 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 1309 / 256; Height = 762 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 1309; Height = 762; };
#line 269
...
float2 ps =  float2((1.0 / 1309), (1.0 / 762)) * scale;
#line 303
