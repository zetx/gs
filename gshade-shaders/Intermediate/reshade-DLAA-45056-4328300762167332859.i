...
texture SLPtex {Width = 1024; Height = 768; Format = RGBA8; };
#line 46
...
{
return tex2D(BackBuffer, tc + float2(dx, dy) *  float2((1.0 / 1024), (1.0 / 768)).xy);
}
#line 65
...
{
return tex2D(SamplerLoadedPixel, tc + float2(dx, dy) *  float2((1.0 / 1024), (1.0 / 768)).xy);
}
#line 86
