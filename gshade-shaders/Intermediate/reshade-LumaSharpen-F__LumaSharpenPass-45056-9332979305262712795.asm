...
if_z cb0[0].z
  mad r2.xyzw, cb0[0].wwww, l(0.000421, 0.000469, -0.000421, -0.000469), v1.xyxy
...
if_nz r1.x
  mad r4.xyzw, cb0[0].wwww, l(0.000631, -0.000704, 0.000631, 0.000704), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000631, 0.000704, 0.000631, -0.000704), v1.xyxy
...
if_nz r1.y
  mad r4.xyzw, cb0[0].wwww, l(0.000505, -0.001690, 0.001515, 0.000563), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r1.xyw, r4.xyxx, t0.xywz, s0
  mad r5.xyzw, -cb0[0].wwww, l(0.001515, 0.000563, 0.000505, -0.001690), v1.xyxy
...
if_nz r1.z
  mov r1.xw, l(0.000631,0,0,-0.000704)
  mul r1.yz, cb0[0].wwww, l(0.000000, -0.001408, -0.001263, 0.000000)
  ...
  mul r4.xw, cb0[0].wwww, l(0.001263, 0.000000, 0.000000, 0.001408)
  mov r4.yz, l(0,0.000704,-0.000631,0)
