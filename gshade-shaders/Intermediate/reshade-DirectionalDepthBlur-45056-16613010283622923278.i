...
#line 200
texture texDownsampledBackBuffer { Width = 5360; Height = 1440; Format = RGBA16F; };
texture texBlurDestination { Width = 5360; Height = 1440; Format = RGBA16F; };
#line 203
...
{
float2 mouseCoords = MouseCoords *  float2((1.0 / 5360), (1.0 / 1440));
#line 227
return (float2(FocusPoint.x - texCoords.x, FocusPoint.y - texCoords.y)) * length( float2((1.0 / 5360), (1.0 / 1440)));
}
#line 230
...
pixelInfo.pixelDelta *= length( float2((1.0 / 5360), (1.0 / 1440)));
pixelInfo.blurLengthInPixels = length( float2(5360, 1440)) * BlurLength;
