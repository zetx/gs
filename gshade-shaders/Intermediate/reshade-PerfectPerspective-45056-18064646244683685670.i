...
#line 353
if ( (1799 * (1.0 / 998)) > 1.0) 
borderCoord.x = borderCoord.x* (1799 * (1.0 / 998))+(1.0- (1799 * (1.0 / 998)));
else if ( (1799 * (1.0 / 998)) < 1.0) 
borderCoord.y = borderCoord.y* (998*(1.0 / 1799))+(1.0- (998*(1.0 / 1799)));
#line 358
...
#line 410
case 1: FovType = sqrt( (998*(1.0 / 1799))* (998*(1.0 / 1799))+1.0); break;
#line 412
case 2: FovType =  (998*(1.0 / 1799)); break;
#line 414
case 3: FovType = (4.0/3.0) * (998*(1.0 / 1799)); break;
#line 416
case 4: FovType = (16.0/9.0) * (998*(1.0 / 1799)); break;
}
#line 420
float2 sphCoord = texCoord*2.0 -1.0;
#line 422
sphCoord.x -= Offset.y; 
sphCoord.y  = Offset.x+sphCoord.y* (998*(1.0 / 1799));
#line 425
