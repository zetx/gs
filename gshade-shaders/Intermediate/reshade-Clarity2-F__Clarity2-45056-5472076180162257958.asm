...
if_nz r0.y
  ...
  loop 
    breakc_z r1.z
    mov x0[1].x, l(0.001955)
    mov x0[2].x, l(0.004561)
    mov x0[3].x, l(0.007168)
    mov x0[4].x, l(0.009774)
    mov x0[5].x, l(0.012381)
    mov x0[6].x, l(0.014988)
    mov x0[7].x, l(0.017595)
    mov x0[8].x, l(0.020202)
    mov x0[9].x, l(0.022809)
    mov x0[10].x, l(0.025417)
  ...
  if_nz r0.y
    ...
    loop 
      breakc_z r1.z
      mov x3[1].x, l(0.001962)
      mov x3[2].x, l(0.004579)
      mov x3[3].x, l(0.007196)
      mov x3[4].x, l(0.009812)
      mov x3[5].x, l(0.012429)
      mov x3[6].x, l(0.015045)
      mov x3[7].x, l(0.017662)
      mov x3[8].x, l(0.020279)
      mov x3[9].x, l(0.022895)
      mov x3[10].x, l(0.025512)
      mov x3[11].x, l(0.028129)
      mov x3[12].x, l(0.030745)
      mov x3[13].x, l(0.033362)
      mov x3[14].x, l(0.035979)
    ...
    if_nz r0.y
      ...
      loop 
        breakc_z r1.z
        mov x6[1].x, l(0.001962)
        mov x6[2].x, l(0.004579)
        mov x6[3].x, l(0.007196)
        mov x6[4].x, l(0.009812)
        mov x6[5].x, l(0.012429)
        mov x6[6].x, l(0.015045)
        mov x6[7].x, l(0.017662)
        mov x6[8].x, l(0.020279)
        mov x6[9].x, l(0.022895)
        mov x6[10].x, l(0.025546)
        mov x6[11].x, l(0.028166)
        mov x6[12].x, l(0.030786)
        mov x6[13].x, l(0.033407)
        mov x6[14].x, l(0.036027)
        mov x6[15].x, l(0.038647)
        mov x6[16].x, l(0.041267)
        mov x6[17].x, l(0.043887)
      ...
      if_nz r0.y
        ...
        loop 
          breakc_z r1.z
          mov x9[1].x, l(0.001914)
          mov x9[2].x, l(0.004467)
          mov x9[3].x, l(0.007023)
          mov x9[4].x, l(0.009584)
          mov x9[5].x, l(0.012150)
        ...
        if_z cb0[0].x
          ...
          loop 
            breakc_z r1.z
            mov x12[1].x, l(0.001552)
            mov x12[2].x, l(0.003975)
            mov x12[3].x, l(0.006567)
