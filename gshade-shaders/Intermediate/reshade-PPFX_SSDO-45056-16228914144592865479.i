...
> = 0;
#line 156
texture texColorLOD { Width = 1024; Height = 768; Format = RGBA8; MipLevels = 4; };
...
float3	ssdo = 0.0;
#line 299
const float	randomDir = tex2Dlod(SamplerSSDONoise,float4(frac(txCoords* float2((1024*					1.0		)/4.0,(768*					1.0		)/4.0)), 0.0, 0.0)).x;
