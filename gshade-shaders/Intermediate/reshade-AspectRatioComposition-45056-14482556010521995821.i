...
#line 64
if(aspectRatio <  (1799 * (1.0 / 998)))
{
borderSize = (1799 - 998 * aspectRatio) / 2.0;
fractionWidth = (1799 - 2 * borderSize) / fraction;
#line 69
if(vpos.x < borderSize || vpos.x > (1799 - borderSize))
retVal = gridColor;
#line 72
if((vpos.y % (998 / fraction)) < 1)
retVal = gridColor;
#line 75
...
{
borderSize = (998 - 1799 / aspectRatio) / 2.0;
fractionWidth = (998 - 2 * borderSize) / fraction;
#line 83
if(vpos.y < borderSize || vpos.y > (998 - borderSize))
retVal = gridColor;
#line 86
...
#line 94
if(vpos.x <= 1 || vpos.x >= 1799-1 || vpos.y <= 1 || vpos.y >= 998-1)
retVal = gridColor;
#line 97
return retVal;
}
...
retVal = DrawGrid(retVal, UIGridColor.rgb, userAspectRatio,  1.6180339887, float4(1799, 998, 0, 0) - vpos);
}
#line 125
