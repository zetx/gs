...
if_z cb0[0].z
  mad r2.xyzw, cb0[0].wwww, l(0.000260, 0.000462, -0.000260, -0.000462), v1.xyxy
...
if_nz r1.x
  mad r4.xyzw, cb0[0].wwww, l(0.000390, -0.000693, 0.000390, 0.000693), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r5.xyz, r4.xyxx, t0.xyzw, s0
  mad r6.xyzw, -cb0[0].wwww, l(0.000390, 0.000693, 0.000390, -0.000693), v1.xyxy
...
if_nz r1.y
  mad r4.xyzw, cb0[0].wwww, l(0.000312, -0.001664, 0.000937, 0.000555), v1.xyxy
  sample_indexable(texture2d)(float,float,float,float) r1.xyw, r4.xyxx, t0.xywz, s0
  mad r5.xyzw, -cb0[0].wwww, l(0.000937, 0.000555, 0.000312, -0.001664), v1.xyxy
...
if_nz r1.z
  mov r1.xw, l(0.000390,0,0,-0.000693)
  mul r1.yz, cb0[0].wwww, l(0.000000, -0.001387, -0.000781, 0.000000)
  ...
  mul r4.xw, cb0[0].wwww, l(0.000781, 0.000000, 0.000000, 0.001387)
  mov r4.yz, l(0,0.000693,-0.000390,0)
