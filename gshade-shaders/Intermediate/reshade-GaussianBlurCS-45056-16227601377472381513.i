...
texture PlaceHolder {Width = 1799; Height = 995; Format = RGB10A2;};
texture Convolution {Width = 1799; Height = 995; Format = RGB10A2;};
#line 57
...
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1799, 995));
...
int2 sampleCoord = sampleOffset + groupCoord;
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(995, 1799));
...
DispatchSizeX =  (int(1799 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(995 +  2 - 1) / int( 2));
}
pass
{
ComputeShader = VerticalPassCS< 32,  2>;
DispatchSizeX =  (int(995 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(1799 +  2 - 1) / int( 2));
}
pass
{
