...
texture PlaceHolder {Width = 1798; Height = 997; Format = RGB10A2;};
texture Convolution {Width = 1798; Height = 997; Format = RGB10A2;};
#line 57
...
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(1798, 997));
...
int2 sampleCoord = sampleOffset + groupCoord;
sampleCoord.x += i;
sampleCoord = clamp(sampleCoord, 0, float2(997, 1798));
...
DispatchSizeX =  (int(1798 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(997 +  2 - 1) / int( 2));
}
pass
{
ComputeShader = VerticalPassCS< 32,  2>;
DispatchSizeX =  (int(997 +  32 *  4 - 1) / int( 32 *  4));
DispatchSizeY =  (int(1798 +  2 - 1) / int( 2));
}
pass
{
