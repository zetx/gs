...
mul r6.xy, r4.ywyy, l(-0.000291, 0.000291, 0.000000, 0.000000)
...
mul r7.yz, r5.wwzw, l(0.000000, 3440.000000, 1440.000000, 0.000000)
...
loop 
  ...
  mad r5.y, -r10.w, l(0.000581), r12.y
...
mad r6.x, r9.x, l(0.000145), r5.w
mad r6.w, r0.w, l(0.000436), r6.x
mad r0.w, -r0.w, l(0.000436), r6.x
movc r0.w, r7.w, r6.w, r0.w
movc r11.y, r7.z, r0.w, r5.w
mad r11.z, cb0[8].y, l(0.000347), r5.z
mad r0.w, cb0[8].y, l(0.000145), r11.y
...
if_nz r5.w
  mul r9.zw, cb0[12].yyyz, l(0.000000, 0.000000, 0.000291, 0.000694)
...
mul r5.y, r5.y, r5.y
mul r5.y, r5.y, r7.y
mul r9.zw, r1.wwwz, l(0.000000, 0.000000, 3440.000000, 1440.000000)
...
loop 
  ...
  mad r1.y, -r10.z, l(0.000581), r13.y
...
mad r5.y, r9.z, l(0.000145), r1.w
mad r5.z, r1.x, l(0.000436), r5.y
mad r1.x, -r1.x, l(0.000436), r5.y
movc r1.x, r9.y, r5.z, r1.x
movc r5.y, r7.z, r1.x, r1.w
mad r5.z, cb0[8].y, l(-0.000347), r1.z
mad r1.x, cb0[8].y, l(-0.000145), r5.y
...
if_nz r5.w
  mul r1.zw, cb0[12].yyyz, l(0.000000, 0.000000, 0.000291, 0.000694)
...
if_nz r0.z
  mul r4.xyzw, r4.xyzw, l(-0.333333, -0.000097, 0.333333, 0.000097)
  ...
  mul r5.y, r5.y, r5.y
  mul r5.y, r5.y, r6.y
  mul r12.xy, r2.wyww, l(3440.000000, 1440.000000, 0.000000, 0.000000)
  ...
  loop 
    ...
    mad r2.z, -r10.w, l(0.000581), r13.x
  ...
  mad r5.y, r9.x, l(0.000145), r4.y
  mad r5.z, r4.x, l(0.000436), r5.y
  mad r4.x, -r4.x, l(0.000436), r5.y
  ...
  if_nz r5.w
    mul r2.zw, cb0[12].yyyz, l(0.000000, 0.000000, 0.000291, 0.000694)
  ...
  mul r4.x, r4.x, r4.x
  mul r2.w, r2.w, r4.x
  mul r5.yz, r3.wwyw, l(0.000000, 3440.000000, 1440.000000, 0.000000)
  ...
  loop 
    ...
    mad r3.z, -r10.z, l(0.000581), r7.w
  ...
  mad r4.y, r9.z, l(0.000145), r4.x
  mad r4.z, r2.w, l(0.000436), r4.y
  mad r2.w, -r2.w, l(0.000436), r4.y
  ...
  if_nz r5.w
    mul r3.zw, cb0[12].yyyz, l(0.000000, 0.000000, 0.000291, 0.000694)
...
mul r7.xyzw, r4.xzxz, l(3440.000000, 1440.000000, 3840.000000, 2160.000000)
