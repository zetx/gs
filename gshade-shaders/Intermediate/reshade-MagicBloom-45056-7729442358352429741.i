...
> = 0;
#line 250
texture tMagicBloom_1 < pooled = true; > { Width = 1024 / 2; Height = 768 / 2; Format = RGBA16F; };
texture tMagicBloom_2 < pooled = true; > { Width = 1024 / 4; Height = 768 / 4; Format = RGBA16F; };
texture tMagicBloom_3 < pooled = true; > { Width = 1024 / 8; Height = 768 / 8; Format = RGBA16F; };
texture tMagicBloom_4 < pooled = true; > { Width = 1024 / 16; Height = 768 / 16; Format = RGBA16F; };
texture tMagicBloom_5 < pooled = true; > { Width = 1024 / 32; Height = 768 / 32; Format = RGBA16F; };
texture tMagicBloom_6 < pooled = true; > { Width = 1024 / 64; Height = 768 / 64; Format = RGBA16F; };
texture tMagicBloom_7 < pooled = true; > { Width = 1024 / 128; Height = 768 / 128; Format = RGBA16F; };
texture tMagicBloom_8 < pooled = true; > { Width = 1024 / 256; Height = 768 / 256; Format = RGBA16F; };
#line 259
...
#line 264
texture tMagicBloom_Dirt <source="MagicBloom_Dirt.png";> { Width = 1024; Height = 768; };
#line 269
...
float2 ps =  float2((1.0 / 1024), (1.0 / 768)) * scale;
#line 303
